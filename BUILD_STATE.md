...
1. **AUDIT-080 Zod validation coverage (~12-20h)** — phased rollout; production-readiness gate item. Advanced to top-3 #1 post-AUDIT-078 Phase C SHIPPED (2026-05-08).
2. **AUDIT-011 Phase d strict-mode flip** (~0.5h env-var; soak-window operator-side) — gated on 14-day audit-mode soak window 2026-05-07T22:51:23Z → 2026-05-21T22:51:23Z; advanced to top-3 #2.
3. *(slot open — AUDIT-078 operator-side restore-test execute + sign-off ledger PR sister-cadence; AUDIT-081 + AUDIT-082 deferred per "Other production-readiness gate items" below)*
...
**Recently resolved (Day 8 PR arc 2026-05-07/08, removed from OPEN):**
