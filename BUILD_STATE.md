...
1. **AUDIT-078 Aurora backup IaC + restore-test (~6-10h)** — production-readiness gate item; operator-side ops PR. Advanced to top-3 #1 post-AUDIT-075 merge (PR #263, 2026-05-08).
2. **AUDIT-080 Zod validation coverage (~12-20h)** — phased rollout; production-readiness gate item. Advanced to top-3 #2 post-AUDIT-075 merge.
3. *(slot open — no other top-3 candidate at current capacity calibration; AUDIT-011 Phase d soak-window flip + AUDIT-081 deferred per "Other production-readiness gate items" below)*
...
|---|---|---|---|
| AUDIT-078 | MEDIUM (P2) | OPEN — PRODUCTION-READINESS GATE (top-3 #1) | Production Aurora backup config not in IaC; restore procedure untested. Advanced to top-3 #1 post-AUDIT-075 merge (PR #263, 2026-05-08). |
| AUDIT-080 | MEDIUM (P2) | OPEN — PRODUCTION-READINESS GATE (top-3 #2) | Zod validation coverage gap (21 of 26 mutating-route files lack Zod). Advanced to top-3 #2 post-AUDIT-075 merge. |
