...
- **Last known working task def:** `tailrd-backend:391` (LIVE-RECONCILED 2026-07-27; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior read `:373`; the deploy track advanced past both surfaces (see the section 9 reconciliation note for the live-verification evidence). Retained per supersede-not-overwrite.
