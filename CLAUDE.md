...
- **Last known working task def:** `tailrd-backend:393` (2026-07-27, companion bump for deploy-bearing merge PR #493; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:391` (LIVE-RECONCILED 2026-07-27), prior read `:373`; see the section 9 note for live-verification evidence. Retained per supersede-not-overwrite.
