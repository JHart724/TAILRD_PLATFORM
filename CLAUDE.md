...
- **Last known working task def:** `tailrd-backend:395` (2026-07-28, deploy-bearing merge PR #499 AUDIT-219 SHA-emit fidelity fix; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:393` (PR #493 companion), `:391`, read `:373`; see the section 9 note for live + runtime-emit-proof evidence. Retained per supersede-not-overwrite.
