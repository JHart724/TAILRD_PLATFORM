...
- **Last known working task def:** `tailrd-backend:399` (2026-07-29, deploy-bearing merge PR #503 AUDIT-221 registry-artifact gate, DIGEST-PINNED to verified `cb25223`; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:396` (AUDIT-218 closeout), `:395`, `:393`, `:391`, read `:373`; see the section 9 note for evidence. Retained per supersede-not-overwrite.
