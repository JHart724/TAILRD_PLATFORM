...
- **Last known working task def:** `tailrd-backend:407` (2026-07-30, deploy-bearing merge PR #511 AUDIT-223 partial unique index, DIGEST-PINNED to verified `1bbc686`; the AUDIT-223 arc completed across `:406`/`:407` - dedupe + index + first resolve-enabled run resolving 464 == prediction exactly; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:404` (PR #508 AUDIT-222), `:402` (PR #506 AUDIT-225), `:399` (PR #503 AUDIT-221), `:396` (AUDIT-218 closeout), `:395`, `:393`, `:391`, read `:373`; see the section 9 note for evidence. Retained per supersede-not-overwrite.
