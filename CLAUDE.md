...
- **Last known working task def:** `tailrd-backend:415` (2026-08-03, deploy-bearing merge PR #519 AUDIT-227 trials pagination + summary/referrals endpoints, DIGEST-PINNED to verified `4a8f953`; the live proof showed the paged endpoint completing where the old shape OOM'd, 0 duplicates and no skips across page boundaries; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:413` (PR #517 AUDIT-226), `:409` (PR #513 Tranche 3 Slice 1), `:407` (PR #511 AUDIT-223 index), `:404` (PR #508 AUDIT-222), `:402` (PR #506 AUDIT-225), `:399` (PR #503 AUDIT-221), `:396` (AUDIT-218 closeout), `:395`, `:393`, `:391`, read `:373`; see the section 9 note for evidence. Retained per supersede-not-overwrite.
