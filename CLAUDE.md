...
- **Last known working task def:** `tailrd-backend:404` (2026-07-29, deploy-bearing merge PR #508 AUDIT-222 orphan retirement, DIGEST-PINNED to verified `7dbab59`; the AUDIT-222 arc completed on it - retirement + G2; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:402` (PR #506 AUDIT-225), `:399` (PR #503 AUDIT-221), `:396` (AUDIT-218 closeout), `:395`, `:393`, `:391`, read `:373`; see the section 9 note for evidence. Retained per supersede-not-overwrite.
