...
**Last known working task definition:** `tailrd-backend:311` (2026-06-18, health + 6/6-module-smoke-verified on Aurora at main HEAD `2c6f32d`, VHD module-complete deploy). Prior: `:305` (2026-06-16, `8fdaff9`), `:282` (merge SHA `2ae35c5`, 2026-06-11). Update after every deploy.
...
- **Last known working task def:** `tailrd-backend:311` (kept in sync with section 9 / `PRODUCTION_READINESS.md`).
