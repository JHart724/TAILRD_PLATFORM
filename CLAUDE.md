...
- **Last known working task def:** `tailrd-backend:422` (2026-08-04, deploy-bearing merge PR #526 trials PR 3 endpoint pivot to persisted verdicts, DIGEST-PINNED to verified `49d0bae`; the live proof returned the persisted distribution exactly in 915ms with the sample banner retired, `staleReasons ["build"]` firing unprompted, AUDIT-227 ordering preserved across the pivot, and the referral path still evaluating live from the deployed artifact; kept in sync with section 9 / `PRODUCTION_READINESS.md`). Prior `:421` (PR #525 AUDIT-229, in arrears), `:420` (PR #524 AUDIT-228 closeout, in arrears), `:419` (PR #523 AUDIT-228), `:418` (PR #522 identity implementation, in arrears), `:417` (PR #521 identity design docs, in arrears), `:416` (PR #520 AUDIT-227 closeout docs, in arrears), `:415` (PR #519 AUDIT-227), `:413` (PR #517 AUDIT-226), `:409` (PR #513 Tranche 3 Slice 1), `:407` (PR #511 AUDIT-223 index), `:404` (PR #508 AUDIT-222), `:402` (PR #506 AUDIT-225), `:399` (PR #503 AUDIT-221), `:396` (AUDIT-218 closeout), `:395`, `:393`, `:391`, read `:373`; see the section 9 note for evidence. Retained per supersede-not-overwrite.
