...
|---|---:|---|---|---|
| GAP-PV-011 | 942 | DET_OK | `gap-pv-rivaroxaban` (PV-RIVAROXABAN @16033-16061) | auto-verify: preserved-from-addendum |
| GAP-PV-017 | 955 | PARTIAL_DETECTION | `gap-pv-bypass-eval` (PV-BYPASS-EVAL @16098-16124) | auto-verify: preserved-from-addendum |
| GAP-PV-018 | 956 | PARTIAL_DETECTION | `gap-pv-bypass-eval` (PV-BYPASS-EVAL @16098-16124) | auto-verify: preserved-from-addendum |
