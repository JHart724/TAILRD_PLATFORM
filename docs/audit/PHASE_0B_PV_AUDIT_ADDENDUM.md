...
|---|---:|---|---|---|
| GAP-PV-011 | 942 | DET_OK | `gap-pv-rivaroxaban` (PV-RIVAROXABAN @16293-16321) | auto-verify: preserved-from-addendum |
| GAP-PV-017 | 955 | PARTIAL_DETECTION | `gap-pv-bypass-eval` (PV-BYPASS-EVAL @16358-16384) | auto-verify: preserved-from-addendum |
| GAP-PV-018 | 956 | PARTIAL_DETECTION | `gap-pv-bypass-eval` (PV-BYPASS-EVAL @16358-16384) | auto-verify: preserved-from-addendum |
