...
|---|---:|---|---|---|
| GAP-VHD-001 | 753 | PARTIAL_DETECTION | `gap-vd-3-inr-monitoring` (VD-3 @5404-5428) | line 4638+ checks no-warfarin (different scenario);  line 5219+ checks no-INR-data (different scenar |
| GAP-VHD-005 | 754 | DET_OK | `gap-vd-6-doac-mechanical-valve` (VD-6 @5494-5518) | line 5312+ (explicit RE-ALIGN trial citation, Class 3 Harm) \| auto-verify: preserved-from-addendum |
...
| GAP-VHD-068 | 860 | PARTIAL_DETECTION | `gap-vd-prosthetic-pannus` (VD-PANNUS @10676-10698) | MANUAL OVERRIDE: VD-PANNUS evaluator at line 10414+ (pattern ID_NAME) was missed by prior 2026-05-04 |
| GAP-VHD-099 | 914 | PARTIAL_DETECTION | `gap-vd-10-pregnancy-risk` (VD-10 @5615-5636) | line 5428+ broad pregnancy + valve risk rule; no LMWH dose-protocol logic \| auto-verify: preserved-f |
