...
- `gap-vd-5-aortic-regurgitation` (registry line 1385): No evaluator body matched via similarity scoring

**Naming convention mismatches (17):** registry IDs not following `gap-vd-` convention.

- `gap-vhd-103-severe-ar-surgical` (line 3882): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-102-ar-surveillance` (line 3889): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-104-mixed-valve-staging` (line 3896): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-105-mr-quant-triangulation` (line 3903): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-068-mech-pvt-gradient` (line 3911): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-011-bio-svd-gradient` (line 3918): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-001-subtherapeutic-inr` (line 3926): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-006-mech-asa-adjunct` (line 3933): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-057-ie-hf-surgery` (line 3941): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-059-ie-embolic-surgery` (line 3948): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-064-prior-ie-dental-prophylaxis` (line 3955): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-079-rheumatic-prophylaxis` (line 3962): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-083-rheumatic-af-warfarin` (line 3969): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-098-mech-valve-preconception` (line 3977): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-099-mech-valve-pregnancy-anticoag` (line 3984): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-091-dopamine-agonist-valve-surveillance` (line 3991): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-092-ergot-alkaloid-valve-surveillance` (line 3998): expected prefix `gap-vd-`, got `gap-vhd-`
...
|---|---:|---|---|---|
| GAP-VHD-001 | 753 | DET_OK | `gap-vhd-001-subtherapeutic-inr` (VHD-001 @8097-8120) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 3 close, AUDIT-133 RESOLVED): SPEC_ONLY -> DET_OK. The 20 |
| GAP-VHD-005 | 754 | PARTIAL_DETECTION | `gap-vd-6-doac-mechanical-valve` (VD-6 @8450-8474) | MANUAL OVERRIDE 2026-06-10 (VHD audit): DET_OK -> PARTIAL per §16.6(i) concept-match / AUDIT-123 + § |
| GAP-VHD-050 | 830 | SPEC_ONLY | — | No S. aureus + TEE rule in evaluator. \| auto-verify: No candidate evaluator block above PARTIAL_MATC |
| GAP-VHD-057 | 841 | DET_OK | `gap-vhd-057-ie-hf-surgery` (VHD-057 @8170-8192) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 4 close): newly DET_OK. Purpose-built gap-vhd-057-ie-hf-s |
...
| GAP-VHD-068 | 860 | PARTIAL_DETECTION | `gap-vhd-068-mech-pvt-gradient` (VHD-068 @8031-8053) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 2 close): RE-CITED from the broad VD-PANNUS to the purpos |
| GAP-VHD-099 | 914 | PARTIAL_DETECTION | `gap-vhd-099-mech-valve-pregnancy-anticoag` (VHD-099 @8364-8390) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 5 close): SPEC_ONLY -> PARTIAL. RE-CITED to the purpose-b |
