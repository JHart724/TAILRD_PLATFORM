...
**Code source:** `backend/src/ingestion/gaps/gapRuleEngine.ts` (registry=49, evaluator=48, gapsPush=48)
**Crosswalk:** `docs/audit/canonical/VHD.crosswalk.json` (auditMethod: rule-body-citation-AUDIT-030D)
**Audit date:** 2026-06-10

## 1. Summary

Valvular Heart Disease has **105 spec gaps** across 18 subcategories. Implementation: **12 DET_OK + 13 PARTIAL + 80 SPEC_ONLY** (any-coverage: 25/105 = 23.8%).
...
| IE Surgical (6) | 3/3/0 | 1 | 1 | 4 | 33.3% |
...
| Pregnancy (4) | 1/3/0 | 1 | 1 | 2 | 50.0% |
| Valve Progression (4) | 0/1/3 | 3 | 1 | 0 | 100.0% |
...
- `gap-vd-5-aortic-regurgitation` (registry line 1373): No evaluator body matched via similarity scoring

**Naming convention mismatches (17):** registry IDs not following `gap-vd-` convention.

- `gap-vhd-103-severe-ar-surgical` (line 3894): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-102-ar-surveillance` (line 3901): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-104-mixed-valve-staging` (line 3908): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-105-mr-quant-triangulation` (line 3915): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-068-mech-pvt-gradient` (line 3923): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-011-bio-svd-gradient` (line 3930): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-001-subtherapeutic-inr` (line 3938): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-006-mech-asa-adjunct` (line 3945): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-057-ie-hf-surgery` (line 3953): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-059-ie-embolic-surgery` (line 3960): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-064-prior-ie-dental-prophylaxis` (line 3967): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-079-rheumatic-prophylaxis` (line 3974): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-083-rheumatic-af-warfarin` (line 3981): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-098-mech-valve-preconception` (line 3989): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-099-mech-valve-pregnancy-anticoag` (line 3996): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-091-dopamine-agonist-valve-surveillance` (line 4003): expected prefix `gap-vd-`, got `gap-vhd-`
- `gap-vhd-092-ergot-alkaloid-valve-surveillance` (line 4010): expected prefix `gap-vd-`, got `gap-vhd-`
...
|---|---:|---|---|---|
| GAP-VHD-001 | 753 | DET_OK | `gap-vhd-001-subtherapeutic-inr` (VHD-001 @8079-8102) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 3 close, AUDIT-133 RESOLVED): SPEC_ONLY -> DET_OK. The 20 |
| GAP-VHD-005 | 754 | PARTIAL_DETECTION | `gap-vd-6-doac-mechanical-valve` (VD-6 @8432-8456) | MANUAL OVERRIDE 2026-06-10 (VHD audit): DET_OK -> PARTIAL per §16.6(i) concept-match / AUDIT-123 + § |
| GAP-VHD-050 | 830 | SPEC_ONLY | — | No S. aureus + TEE rule in evaluator. \| auto-verify: No candidate evaluator block above PARTIAL_MATC |
| GAP-VHD-057 | 841 | DET_OK | `gap-vhd-057-ie-hf-surgery` (VHD-057 @8152-8174) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 4 close): newly DET_OK. Purpose-built gap-vhd-057-ie-hf-s |
...
| GAP-VHD-068 | 860 | PARTIAL_DETECTION | `gap-vhd-068-mech-pvt-gradient` (VHD-068 @8013-8035) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 2 close): RE-CITED from the broad VD-PANNUS to the purpos |
| GAP-VHD-099 | 914 | PARTIAL_DETECTION | `gap-vhd-099-mech-valve-pregnancy-anticoag` (VHD-099 @8346-8372) | MANUAL OVERRIDE 2026-06-17 (v3.0 VHD chunk 5 close): SPEC_ONLY -> PARTIAL. RE-CITED to the purpose-b |
...
Coverage data: 25/105 any-coverage (23.8%); 12/105 DET_OK only (11.4%); 13 PARTIAL via broad-rule consolidation or partial-trigger match; 80 SPEC_ONLY.

Rules-per-DET_OK efficiency: 49 registry rules / 12 DET_OK = 4.08.
...
### Manual classification overrides (31)
...
- 12 DET_OK (11.4%), 13 PARTIAL (12.4%), 80 SPEC_ONLY (76.2%)
