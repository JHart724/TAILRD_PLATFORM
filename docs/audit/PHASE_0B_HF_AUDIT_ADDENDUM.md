...
- `gap-hf-vaccine-covid` (registry line 2099): No evaluator body matched via similarity scoring

**Naming convention mismatches (4):** registry IDs not following `gap-hf-` convention.

- `gap-1-attr-cm` (line 131): expected prefix `gap-hf-`, got `gap-1-`
- `gap-2-iron-deficiency` (line 143): expected prefix `gap-hf-`, got `gap-2-`
- `gap-6-finerenone` (line 155): expected prefix `gap-hf-`, got `gap-6-`
- `gap-44-digoxin-toxicity` (line 179): expected prefix `gap-hf-`, got `gap-44-`
...
|---|---:|---|---|---|
| GAP-HF-001 | 124 | DET_OK | `gap-hf-35-beta-blocker` (HF-35 @3438-3462) | + \| auto-verify: preserved-from-addendum |
| GAP-HF-002 | 125 | PARTIAL_DETECTION | `gap-hf-35-beta-blocker` (HF-35 @3438-3462) | auto-verify: preserved-from-addendum |
| GAP-HF-003 | 126 | PARTIAL_DETECTION | `gap-hf-35-beta-blocker` (HF-35 @3438-3462) | auto-verify: preserved-from-addendum |
| GAP-HF-004 | 127 | DET_OK | `gap-hf-37-raas` (HF-37 @4929-4955) | + \| auto-verify: preserved-from-addendum |
| GAP-HF-005 | 128 | DET_OK | `gap-hf-arni-switch` (HF-ARNI-SWITCH @10106-10130) | auto-verify: preserved-from-addendum |
| GAP-HF-007 | 129 | DET_OK | `gap-hf-36-mra` (HF-36 @3472-3494) | + \| auto-verify: preserved-from-addendum |
| GAP-HF-010 | 130 | DET_OK | `gap-hf-34-sglt2i` (HF-34 @3408-3433) | + \| auto-verify: preserved-from-addendum |
| GAP-HF-014 | 131 | DET_OK | `gap-hf-18-vericiguat` (HF-18 @3589-3605) | auto-verify: preserved-from-addendum |
| GAP-HF-016 | 143 | DET_OK | `gap-hf-79-sglt2i-hfpef` (HF-79 @3916-3936) | auto-verify: preserved-from-addendum |
| GAP-HF-017 | 144 | SPEC_ONLY | — | — \| auto-verify: No candidate evaluator block above PARTIAL_MATCH |
| GAP-HF-018 | 145 | DET_OK | `gap-hf-7-glp1ra` (HF-7 @3510-3526) | auto-verify: preserved-from-addendum |
| GAP-HF-021 | 152 | PARTIAL_DETECTION | `gap-ep-device-crt` (EP-DEVICE-CRT @4303-4325) **[cross-module: EP]** | — \| auto-verify: broad-rule consolidation: EP-DEVICE-CRT top-matches 3 spec gaps in subcategory "Dev |
| GAP-HF-024 | 153 | PARTIAL_DETECTION | `gap-ep-device-icd` (EP-DEVICE-ICD @4266-4292) **[cross-module: EP]** | — \| auto-verify: broad-rule consolidation: EP-DEVICE-ICD top-matches 2 spec gaps in subcategory "Dev |
| GAP-HF-025 | 154 | PARTIAL_DETECTION | `gap-ep-device-icd` (EP-DEVICE-ICD @4266-4292) **[cross-module: EP]** | — \| auto-verify: broad-rule consolidation: EP-DEVICE-ICD top-matches 2 spec gaps in subcategory "Dev |
| GAP-HF-026 | 155 | PARTIAL_DETECTION | `gap-ep-secondary-icd` (EP-SECONDARY-ICD @7250-7272) **[cross-module: EP]** | — \| auto-verify: Top candidate score=0.404 between PARTIAL and HIGH thresholds; tokenJaccard=0.07; n |
| GAP-HF-028 | 168 | PARTIAL_DETECTION | `gap-hf-84-transplant-eval` (HF-84 @5981-6000) | + \| Multiple registry ids cited: gap-hf-84-transplant-eval, gap-hf-85-lvad-referral \| auto-verify: p |
...
| GAP-HF-132 | 171 | PARTIAL_DETECTION | `gap-hf-73-hyponatremia` (HF-73 @3796-3811) | auto-verify: preserved-from-addendum |
| GAP-HF-133 | 172 | SPEC_ONLY | — | — \| auto-verify: No candidate evaluator block above PARTIAL_MATCH |
| GAP-HF-033 | 185 | PARTIAL_DETECTION | `gap-hf-iron-iv-monitoring` (HF-IRON-IV-MONITORING @10383-10406) | auto-verify: preserved-from-addendum |
| GAP-HF-034 | 186 | PARTIAL_DETECTION | `gap-hf-iron-iv-monitoring` (HF-IRON-IV-MONITORING @10383-10406) | auto-verify: preserved-from-addendum |
| GAP-HF-036 | 192 | SPEC_ONLY | — | — \| auto-verify: No candidate evaluator block above PARTIAL_MATCH |
| GAP-HF-051 | 206 | PARTIAL_DETECTION | `gap-hf-90-amyloid-biomarker` (HF-90 @6159-6177) | auto-verify: preserved-from-addendum |
| GAP-HF-053 | 207 | PARTIAL_DETECTION | `gap-hf-90-amyloid-biomarker` (HF-90 @6159-6177) | auto-verify: preserved-from-addendum |
| GAP-HF-054 | 208 | PARTIAL_DETECTION | `gap-hf-90-amyloid-biomarker` (HF-90 @6159-6177) | auto-verify: preserved-from-addendum |
| GAP-HF-057 | 217 | PARTIAL_DETECTION | `gap-hf-12-hcm-screening` (HF-12 @3534-3549) | auto-verify: preserved-from-addendum |
