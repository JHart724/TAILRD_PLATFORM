...
- `gap-sh-003-lflg-classical` (registry line 2824): No evaluator body matched via similarity scoring
- `gap-sh-004-lflg-paradoxical` (registry line 2831): No evaluator body matched via similarity scoring
- `gap-sh-006-asymptomatic-as` (registry line 2838): No evaluator body matched via similarity scoring
- `gap-sh-050-moderate-as-grading` (registry line 2845): No evaluator body matched via similarity scoring
- `gap-sh-017-primary-mr-pasp` (registry line 2859): No evaluator body matched via similarity scoring
