...
| GAP-SH-061 | 472 | DET_OK | `gap-sh-valve-in-valve` (SH-VALVE-IN-VALVE @10610-10632) | line 10214+ \| auto-verify: preserved-from-addendum |
...
| GAP-SH-022 | 507 | DET_OK | `gap-sh-4-tricuspid-assessment` (SH-4 @5341-5367) | line 5022+ +  line 6116+ \| Multiple registry ids cited: gap-sh-4-tricuspid-assessment, gap-sh-12-ttv |
