...
- **Severity:** HIGH (P1)
- **Status:** IN_PROGRESS (correction authored 2026-06-01 on branch `fix/audit-102-104-rxnorm-wrong-drug`, shared with AUDIT-104; awaiting operator merge)
...
- **Severity:** HIGH (P1)
- **Status:** IN_PROGRESS (correction authored 2026-06-01 on branch `fix/audit-102-104-rxnorm-wrong-drug`, shared with the AUDIT-102 correction; awaiting operator merge - see Resolution + Status note)
