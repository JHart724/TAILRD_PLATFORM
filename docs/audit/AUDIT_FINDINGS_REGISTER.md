...
- **Status:** OPEN 2026-06-22. Backend-track fix (the mock lives in the backend endpoint). Sibling to AUDIT-187 (same `modules.ts` sweep); lineage AUDIT-099 (silent-mock) + AUDIT-300 (fabricated-patient pure-removal precedent).
