...
- **AUDIT-173** - CAD-REHAB over-detector: cardiac-rehab gaps GAP-CAD-029 (post-CABG) + GAP-CAD-046 (post-MI) fired on `hasCAD` alone. (CAD legacy-coverage audit, **RESOLVED 2026-06-18** - CAD chunk 0 split CAD-REHAB into gap-cad-rehab-cabg (Z95.1-gated) + gap-cad-rehab-mi (I21/I22/I25.2-gated), each with a rehab-engagement guard (CPT 93797/93798); regression + no-over-narrowing tests in cadChunk0.test.ts. Both re-cited DET_OK.) See register AUDIT-173.
...
- **Status:** RESOLVED 2026-06-18 (CAD chunk 0). Split into gap-cad-rehab-cabg (Z95.1) + gap-cad-rehab-mi (I21/I22/I25.2), each with a rehab-engagement guard (procedureCodes CPT 93797/93798); regression + no-over-narrowing tests in cadChunk0.test.ts. Both re-cited DET_OK.
