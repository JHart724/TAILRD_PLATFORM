...
**Code source:** `backend/src/ingestion/gaps/gapRuleEngine.ts` (registry=83, evaluator=82, gapsPush=82)
**Crosswalk:** `docs/audit/canonical/CAD.crosswalk.json` (auditMethod: rule-body-citation-AUDIT-030D)
**Audit date:** 2026-05-04

## 1. Summary

Coronary Artery Disease has **90 spec gaps** across 18 subcategories. Implementation: **31 DET_OK + 28 PARTIAL + 31 SPEC_ONLY** (any-coverage: 59/90 = 65.6%).
...
|---|---|---:|---:|---:|---:|
| Lipid Management (13) | 7/4/2 | 8 | 2 | 3 | 76.9% |
...
| Intracoronary Imaging (3) | 0/3/0 | 0 | 1 | 2 | 33.3% |
...
- `gap-cad-ivus` (registry line 1757): No evaluator body matched via similarity scoring
...
|---|---:|---|---|---|
| GAP-CAD-001 | 590 | DET_OK | `gap-cad-statin` (CAD-STATIN @6646-6677) | auto-verify: preserved-from-addendum |
| GAP-CAD-002 | 591 | DET_OK | `gap-cad-statin` (CAD-STATIN @6646-6677) | auto-verify: preserved-from-addendum |
| GAP-CAD-003 | 592 | DET_OK | `gap-cad-ezetimibe` (CAD-EZETIMIBE @6822-6852) | auto-verify: preserved-from-addendum |
| GAP-CAD-004 | 593 | DET_OK | `gap-cad-pcsk9` (CAD-PCSK9 @11174-11205) | auto-verify: preserved-from-addendum |
| GAP-CAD-005 | 594 | PARTIAL_DETECTION | `gap-cad-pcsk9` (CAD-PCSK9 @11174-11205) | auto-verify: preserved-from-addendum |
...
| GAP-CAD-011 | 607 | PARTIAL_DETECTION | `gap-cad-statin` (CAD-STATIN @6646-6677) | auto-verify: preserved-from-addendum |
| GAP-CAD-012 | 608 | PARTIAL_DETECTION | `gap-cad-statin` (CAD-STATIN @6646-6677) | auto-verify: preserved-from-addendum |
| GAP-CAD-014 | 609 | DET_OK | `gap-cad-omega3` (CAD-OMEGA3 @11284-11317) | auto-verify: preserved-from-addendum |
| GAP-CAD-015 | 617 | DET_OK | `gap-cad-ticagrelor-acs` (CAD-TICAGRELOR-ACS @11883-11910) | + \| Multiple registry ids cited: gap-cad-ticagrelor-acs, gap-cad-prasugrel \| auto-verify: preserved- |
| GAP-CAD-016 | 618 | DET_OK | `gap-cad-016-prasugrel-stroke-safety` (CAD-016 @12527-12551) | MANUAL OVERRIDE: AUDIT-034 RESOLVED 2026-05-05 — new SAFETY evaluator block added (this PR) covering |
| GAP-CAD-063 | 638 | SPEC_ONLY | — | — \| auto-verify: No candidate evaluator block above PARTIAL_MATCH |
| GAP-CAD-065 | 639 | PARTIAL_DETECTION | `gap-cad-catheterization` (CAD-CATHETERIZATION @12872-12899) | auto-verify: preserved-from-addendum |
...
| GAP-CAD-081 | 717 | DET_OK | `gap-cad-scad` (CAD-SCAD @12993-13021) | +  + \| Multiple registry ids cited: gap-cad-scad, gap-cad-women-specific, gap-cad-young-mi \| auto-ve |
...
Coverage data: 59/90 any-coverage (65.6%); 31/90 DET_OK only (34.4%); 28 PARTIAL via broad-rule consolidation or partial-trigger match; 31 SPEC_ONLY.

Rules-per-DET_OK efficiency: 83 registry rules / 31 DET_OK = 2.68.
...
- 31 DET_OK (34.4%), 28 PARTIAL (31.1%), 31 SPEC_ONLY (34.4%)
