...
Supporting: **AUDIT-191** all-module canonical refresh (merged #433) corrected the coverage synthesis to the honest figure below; task-def at `:332`. **[CORRECTION 2026-08-05: `:332` was the AUDIT-191 milestone and is retained as that. The current last-known-good pointer is `tailrd-backend:<!--@checked deploy.lastKnownGoodTaskDef-->425<!--/@checked-->` - the canonical source is CLAUDE.md section 9, NOT this line, which is a historical marker.]**
...
**4. Open findings.** <!--@checked register.open2-->93<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->20<!--/@checked--> HIGH / <!--@checked register.medium2-->40<!--/@checked--> MEDIUM / <!--@checked register.low2-->30<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
