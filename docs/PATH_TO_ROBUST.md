...
**4. Open findings.** <!--@checked register.open2-->95<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->20<!--/@checked--> HIGH / <!--@checked register.medium2-->41<!--/@checked--> MEDIUM / <!--@checked register.low2-->31<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
