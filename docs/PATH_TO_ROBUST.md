...
**4. Open findings.** <!--@checked register.open2-->92<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->19<!--/@checked--> HIGH / <!--@checked register.medium2-->40<!--/@checked--> MEDIUM / <!--@checked register.low2-->30<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
