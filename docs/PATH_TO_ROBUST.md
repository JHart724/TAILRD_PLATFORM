...
**2. Clinical gap coverage.** <!--@checked coverage.any2-->313/603<!--/@checked--> = <!--@checked coverage.pct2-->51.9%<!--/@checked--> buildable
...
**4. Open findings.** <!--@checked register.open2-->108<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->21<!--/@checked--> HIGH / <!--@checked register.medium2-->47<!--/@checked--> MEDIUM / <!--@checked register.low2-->37<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
