...
**4. Open findings.** <!--@checked register.open2-->98<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->19<!--/@checked--> HIGH / <!--@checked register.medium2-->42<!--/@checked--> MEDIUM / <!--@checked register.low2-->34<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
