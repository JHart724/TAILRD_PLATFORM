...
**4. Open findings.** <!--@checked register.open2-->101<!--/@checked--> open (0 CRITICAL / <!--@checked register.high2-->20<!--/@checked--> HIGH / <!--@checked register.medium2-->44<!--/@checked--> MEDIUM / <!--@checked register.low2-->34<!--/@checked--> LOW / <!--@checked register.info2-->3<!--/@checked--> INFO), script-derived.
