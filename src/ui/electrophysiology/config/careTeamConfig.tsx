...
const EPPatients: React.FC = () => (
 ...
 <div className="flex items-center gap-3">
 <button 
 className="px-4 py-2 bg-green-50 text-green-600 rounded-lg hover:bg-titanium-300 transition-colors text-sm"
 onClick={() => {
 ...
 patient.rhythm === 'VTach' ? 'bg-amber-50 text-amber-600' :
 ...
 parseInt(patient.chads) >= 2 ? 'bg-amber-50 text-amber-600' :
 ...
 patient.status === 'Recovery' ? 'bg-amber-50 text-amber-600' :
...
const EPClinicalCollaboration: React.FC = () => (
 ...
 <div className="text-xs text-teal-700 mt-1 font-medium">{member.expertise}</div>
 <div className="mt-2">
 ...
 pathway.indication === 'Anticoagulation Contraindication' ? 'bg-chrome-50 border-titanium-300' :
 ...
 pathway.indication === 'Anticoagulation Contraindication' ? 'text-gray-500' :
 ...
 pathway.indication === 'Anticoagulation Contraindication' ? 'bg-amber-50 text-amber-600' :
 ...
 <div className="text-xs text-teal-700">Multidisciplinary Consensus</div>
 </div>
 </div>
 </div>
 ...
 <div className="text-xs text-teal-700">Evidence-based recommendations</div>
 </button>
 <button 
...
const EPDocumentation: React.FC = () => (
 ...
 <span className="font-medium text-gray-500">LAAC Registry Due</span>
 <span className="text-xs bg-amber-50 text-amber-600 px-2 py-1 rounded-full">DUE TODAY</span>
 </div>
 <div className="text-sm text-gray-500">2 LAAC procedures require registry data entry</div>
 <div className="text-xs text-gray-500 mt-1">Required within 24h of procedure</div>
 </div>
 
 <div className="bg-white p-4 rounded-lg border border-titanium-300">
 <div className="flex items-center justify-between mb-2">
 <span className="font-medium text-gray-500">Ablation Reports Pending</span>
 <span className="text-xs bg-amber-50 text-amber-600 px-2 py-1 rounded-full">PENDING</span>
 </div>
 <div className="text-sm text-gray-500">3 ablation procedures missing operative notes</div>
 <div className="text-xs text-gray-500 mt-1">Complete within 48h</div>
 </div>
 
 <div className="bg-white p-4 rounded-lg border border-teal-700">
 <div className="flex items-center justify-between mb-2">
 <span className="font-medium text-teal-700">Device Follow-up Notes</span>
 <span className="text-xs bg-green-50 text-green-600 px-2 py-1 rounded-full">COMPLETE</span>
 </div>
 <div className="text-sm text-teal-700">All device clinic notes up to date</div>
 <div className="text-xs text-teal-700 mt-1">Next batch due tomorrow</div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="font-medium text-teal-700">EP Registry Completeness</div>
 <div className="text-sm text-teal-700">LAAC, Ablation data quality</div>
 </div>
 <div className="text-2xl font-bold text-teal-700">94.6%</div>
 </div>
 ...
 >
 <div className="font-medium text-teal-700">Complete LAAC Registry</div>
 <div className="text-xs text-teal-700">2 cases due today</div>
 </button>
 <button 
 className="w-full p-3 text-left bg-chrome-50 hover:bg-chrome-100 rounded-lg transition-colors"
 onClick={() => {
