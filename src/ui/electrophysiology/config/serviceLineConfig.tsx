...
import { Zap, Users, Network, Brain, DollarSign, Target, Grid3X3, Activity, Shield, Award, BarChart3, FileText, Heart, ChevronDown, ChevronUp, AlertTriangle, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      {/*
        ...
        "14 months to clear pipeline", "5 months with TAILRD protocol", and "Revenue Acceleration
        $5.4M in 12 months" behind a "Forward-looking" chip. The first two are a PRODUCT EFFICACY claim -
