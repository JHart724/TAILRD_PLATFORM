...
const EPCareTeamView: React.FC = () => {
 ...
 { id: 'hospital-alerts', label: 'Hospital Alerts', icon: Heart, description: 'EP hospital alerts' },
 ...
 <div className="text-3xl font-bold text-gray-500 mb-2">23</div>
 ...
 <div className="w-3 h-3 rounded-full bg-titanium-300"></div>
 ...
 <span className="font-medium text-gray-500">EP Lab Team</span>
 </div>
 <div className="text-sm text-gray-500">2 procedures in progress</div>
 </div>
 <div className="p-4 bg-titanium-300 rounded-lg border border-teal-700">
 <div className="flex items-center gap-2 mb-2">
 <div className="w-3 h-3 rounded-full bg-titanium-300"></div>
 <span className="font-medium text-teal-700">Device Clinic</span>
 </div>
 <div className="text-sm text-teal-700">Available for urgent checks</div>
 </div>
 </div>
 </div>
 </>
 ...
 <td className="py-3"><span className={`text-xs px-2 py-0.5 rounded-full font-medium ${p.risk === 'HIGH' ? 'bg-red-100 text-red-800' : p.risk === 'MODERATE' ? 'bg-amber-50 text-amber-600' : 'bg-green-50 text-green-600'}`}>{p.risk}</span></td>
 ...
 <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${w.priority === 'HIGH' ? 'bg-red-100 text-red-800' : w.priority === 'MODERATE' ? 'bg-amber-50 text-amber-600' : 'bg-green-50 text-green-600'}`}>{w.priority}</span>
 </div>
 ...
 <div className="p-4 bg-chrome-50 rounded-xl border border-titanium-300">
 <div className="text-2xl font-bold text-gray-500">7</div>
 <div className="text-sm text-gray-500">Drug Interactions</div>
 </div>
 <div className="p-4 bg-titanium-300 rounded-xl border border-teal-700">
 <div className="text-2xl font-bold text-teal-700">89%</div>
 <div className="text-sm text-teal-700">Monitoring Compliant</div>
 </div>
 </div>
 ...
 <div key={`${a.patient}-${a.alert}`} className={`p-4 rounded-xl border ${a.color === 'red' ? 'bg-red-50 border-red-200' : 'bg-chrome-50 border-titanium-300'}`}>
 <div className="flex items-center justify-between mb-1">
 <span className="font-semibold text-titanium-900 text-sm">{a.patient}</span>
 <span className={`text-xs px-2 py-0.5 rounded-full font-bold ${a.color === 'red' ? 'bg-red-200 text-red-900' : 'bg-amber-50 text-amber-600'}`}>{a.severity}</span>
 </div>
 <div className={`text-sm ${a.color === 'red' ? 'text-red-800' : 'text-gray-500'}`}>{a.alert}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${m.sc === 'green' ? 'bg-green-50 text-green-600' : m.sc === 'amber' ? 'bg-amber-50 text-amber-600' : 'bg-blue-100 text-blue-800'}`}>{m.status}</span>
 </div>
 ...
 <span className={`text-xs font-medium ${m.up ? 'text-teal-700' : 'text-blue-600'}`}>{m.trend}</span>
 </div>
 </div>
 ))}
 </div>
 ...
 {[
 { name: 'AF Ablation Report', desc: 'PVI, linear lesions, mapping data', bg: 'bg-green-50 border-green-100 hover:bg-titanium-300', text: 'text-teal-700', sub: 'text-teal-700' },
 ...
 { name: 'LAAC Procedure Note', desc: 'Watchman implant documentation', bg: 'bg-chrome-50 border-titanium-300 hover:bg-chrome-50', text: 'text-gray-500', sub: 'text-gray-500' },
