...
const DEVICE_INTERVENTIONS: EPDeviceData[] = [
  {
 id: 'iv-iron',
 ...
 citation: 'Yeo et al., ESC arrhythmia 2020',
 ...
 citation: 'SCD-arrhythmia, NEJM 2005',
 ...
 citation: 'BeAT-arrhythmia Trial, JCF 2020; EJHF 2022',
 eligiblePatients: 12,
 utilizedPatients: 0,
 revenueGap: 300000,
 category: 'device'
 ...
 citation: 'AHA arrhythmia Guidelines 2022; Curr Cardiol Rev 2023',
 eligiblePatients: 37,
 utilizedPatients: 6,
 revenueGap: 263500,
 category: 'diagnostic'
 ...
 citation: 'JACC arrhythmia Imaging 2021; AHA Guidelines 2022',
 eligiblePatients: 187,
 utilizedPatients: 41,
 revenueGap: 511000,
 category: 'diagnostic'
...
const EPAdvancedDeviceTracker: React.FC = () => {
 ...
 <div>
 <h2 className="text-3xl font-bold text-titanium-900 font-sf">Advanced Device & Intervention Tracker</h2>
 ...
 <div key={device.id} className="metal-card p-6 hover:shadow-chrome-elevated transition-all duration-300">
 <div className="flex items-start justify-between mb-4">
 <div className="flex-1">
 <h3 className="text-lg font-bold text-titanium-900 mb-2">{device.name}</h3>
 ...
 <div className="text-xs text-titanium-600">{device.eligiblePercent}</div>
 </div>
 <div>
 <div className="text-xs font-semibold text-titanium-700">Reimbursement</div>
 <div className="text-xs text-titanium-600">{device.avgReimbursement}</div>
 </div>
 <div>
 <div className="text-xs font-semibold text-titanium-700">Strategic Value</div>
 <div className="text-xs text-titanium-600">{device.strategicValue}</div>
 </div>
 </div>
 ...
 <div className="text-lg font-bold text-deep-red-600">Pacemaker Implants</div>
 ...
 <div className="text-xs text-medical-green-600">Pacemaker program expansion</div>
 </div>
...
export default EPAdvancedDeviceTracker;