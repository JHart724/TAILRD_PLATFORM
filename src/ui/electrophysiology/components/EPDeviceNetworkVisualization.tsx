...
const EPDeviceNetworkVisualization: React.FC = () => {
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.devicePerformanceScore * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.avgAlertResponseTime.toFixed(1)}h</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.anticoagulationCompliance * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.emergencyUtilizationReduction * 100).toFixed(0)}%</div>
 ...
 <span className="font-bold text-chrome-600">{(metrics.remoteMonitoringAdherence * 100).toFixed(1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Avg Alert Response</span>
 <span className="font-bold text-amber-600">{metrics.avgAlertResponseTime.toFixed(1)} hrs</span>
 </div>
 <div className="flex justify-between items-center">
