...
const EPROICalculator: React.FC = () => {
 ...
 <div className="text-3xl font-bold text-chrome-800">${(calculateEPROI.netBenefit / 1000000).toFixed(1)}M</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-xl border border-chrome-200">
 <div className="flex items-center gap-3 mb-2">
 <Shield className="w-6 h-6 text-chrome-600" />
 <div>
 <div className="text-sm text-chrome-700 font-medium">LAAC Revenue Impact</div>
 <div className="text-2xl font-bold text-chrome-800">${(calculateEPROI.laacImpact / 1000).toFixed(0)}K</div>
 </div>
 </div>
