...
const EPFinancialWaterfall: React.FC = () => {
  const [selectedCategory, setSelectedCategory] = useState<string | null>(null);

  // Mock data - will be replaced with real API data
  const waterfallData: WaterfallItem[] = [
 {
 category: 'Anticoagulation Optimization',
 value: 7200000,
 description: 'DOAC initiation and optimization for AF patients',
 opportunities: 342,
 avgPerPatient: 21000,
 },
 {
 category: 'Ablation Therapy',
 value: 8900000,
 description: 'PVI, complex ablations for AF/AFL patients',
 opportunities: 156,
 avgPerPatient: 57000,
 },
 {
 ...
 value: 12400000,
 description: 'Pacemaker, ICD, CRT for bradycardia/VT',
 opportunities: 198,
 avgPerPatient: 62600,
 },
 {
 ...
 value: 5600000,
 description: 'Watchman/Amulet for high-risk AF patients',
 opportunities: 89,
 avgPerPatient: 62900,
 },
 {
 category: 'VT Management',
 value: 3800000,
 description: 'Advanced VT mapping and ablation',
 opportunities: 42,
 avgPerPatient: 90500,
 },
  ];
 ...
 EP Revenue Opportunity Waterfall
 </h2>
 <p className="text-titanium-600">
 Annual revenue opportunity by electrophysiology intervention
 </p>
 </div>
...
export default EPFinancialWaterfall;