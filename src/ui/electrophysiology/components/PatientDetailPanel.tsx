...
const PatientDetailPanel: React.FC<PatientDetailPanelProps> = ({ patient, onClose }) => {
 ...
 <span className="px-2 py-1 bg-arterial-100 text-arterial-700 rounded text-sm font-medium">
 AFib Patient
 </span>
 )}
 </div>
 ...
 <Waves className="w-5 h-5 text-chrome-600" />
 ...
 <span className="text-lg font-bold text-arterial-600">{patient.device}</span>
 </div>
 ...
 <span key={symptom} className="px-2 py-1 bg-arterial-100 text-arterial-700 rounded text-sm">
 {symptom}
 </span>
 ))}
 </div>
 ...
 <li key={reason} className="text-sm text-gray-700 flex items-start gap-2">
 ...
 <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
 <Battery className="w-5 h-5 text-chrome-600" />
 ...
 <div>
 <div className="text-lg font-bold text-chrome-600">{patient.deviceMonitoring.therapyDelivery.atpEpisodes}</div>
 ...
 <div key={lead.lead} className="bg-white rounded p-3 border">
 <div className="flex items-center justify-between mb-2">
 ...
 <div key={`${proc.procedure}-${proc.date}`} className="bg-white p-3 rounded border">
