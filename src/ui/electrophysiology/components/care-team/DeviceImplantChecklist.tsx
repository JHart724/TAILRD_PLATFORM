...
const DeviceImplantChecklist: React.FC = () => {
 ...
 <Cpu className="w-8 h-8 text-porsche-600" />
 Device Implant Planning
 </h2>
 <p className="text-titanium-600">Patient: {implantPlan.patientId} • Indication: {implantPlan.indication}</p>
 </div>
 <button
 onClick={generateImplantPlan}
 className="flex items-center gap-2 px-6 py-3 bg-porsche-600 text-white rounded-lg hover:bg-porsche-700 transition-colors"
 >
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Primary Indication</label>
 <select
 ...
 className="w-full mt-1 px-3 py-2 border border-titanium-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-porsche-500"
 >
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Ejection Fraction (%)</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">QRS Duration (ms)</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">NYHA Class</label>
 <select
 ...
 <div className="text-titanium-600">Ejection Fraction</div>
 <div className="font-semibold text-titanium-800">{implantPlan.eligibility.ef}%</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-titanium-600">QRS Duration</div>
 <div className="font-semibold text-titanium-800">{implantPlan.eligibility.qrs}ms</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-titanium-600">NYHA Class</div>
 <div className="font-semibold text-titanium-800">{implantPlan.eligibility.nyhaClass}</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-titanium-600">Indication</div>
 <div className="font-semibold text-titanium-800">{implantPlan.indication}</div>
 </div>
 </div>
 </div>
 </div>
 ...
 ? 'bg-porsche-50 border-porsche-300 text-porsche-800'
 ...
 <div className="text-xs text-titanium-500">{strategy.indication}</div>
 </button>
 ))}
 </div>
 </div>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Settings className="w-5 h-5 text-chrome-500" />
 Device Selection
 </h3>
 
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-titanium-600">Device Model</label>
 <select
 ...
 />
 <label className="text-sm font-medium text-titanium-700">MRI Compatibility Required</label>
 </div>

 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Lead Configuration</div>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Battery className="w-5 h-5 text-teal-700" />
 Battery Life
 </h3>
 ...
 <div className="text-sm text-titanium-500 mt-4">
 ...
 <div key={risk.factor || `risk-${index}`} className="flex items-center justify-between p-2 bg-titanium-50 rounded">
 ...
 className="rounded border-titanium-300"
 />
 <span className="text-sm text-titanium-700">{risk.factor}</span>
 </div>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Pre-operative</label>
 <textarea
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Intra-operative</label>
 <textarea
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Post-operative</label>
 <textarea
 ...
 className="rounded border-titanium-300"
 />
 <label className="text-sm font-medium text-titanium-700">Bridging anticoagulation required</label>
 </div>
 </div>

 {/* Summary and Actions */}
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4">Implant Plan Summary</h3>
 
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Device Strategy</div>
 <div className="font-semibold text-titanium-800">{implantPlan.selectedStrategy.type}</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Device Model</div>
 <div className="font-semibold text-titanium-800">{implantPlan.deviceModel}</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Battery Life</div>
 <div className="font-semibold text-titanium-800">{implantPlan.expectedBatteryLife} years</div>
 </div>
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Infection Risk</div>
 <div className={`font-semibold ${
 overallInfectionRisk === 'High' ? 'text-red-600' :
 overallInfectionRisk === 'Medium' ? 'text-gray-500' : 'text-teal-700'
 }`}>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-titanium-600">Plan Status</div>
 <div className="font-medium text-titanium-800 capitalize">{implantPlan.status}</div>
 </div>
 ...
 className="px-4 py-2 bg-porsche-600 text-white rounded-lg hover:bg-porsche-700 transition-colors text-sm"
 >
 Schedule Implant
 </button>
 </div>
