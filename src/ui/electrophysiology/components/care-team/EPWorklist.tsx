...
const EPWorklist: React.FC = () => {
 ...
 <div key={index} className="p-2 bg-white rounded border border-titanium-200">
 ...
 className="flex-1 px-3 py-2 border border-titanium-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-medical-purple-500"
 />
 </div>
 ...
 className="px-3 py-2 border border-titanium-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-medical-purple-500"
 >
