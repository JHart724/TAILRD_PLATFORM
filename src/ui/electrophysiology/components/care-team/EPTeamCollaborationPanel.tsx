...
const EPTeamCollaborationPanel: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'messages' | 'team' | 'alerts'>('messages');
  const [selectedMessage, setSelectedMessage] = useState<EPMessage | null>(null);
  ...
  const teamMembers: EPTeamMember[] = [
 {
 id: 'TM001',
 ...
 content: 'Yes, please start IV furosemide 40mg BID. Also check echo for interval change and consider Ablation evaluation.',
 ...
 mrn: '123456789',
 message: 'Upcoming Ablation-D evaluation appointment tomorrow at 2 PM - patient has transportation concerns',
...
export default EPTeamCollaborationPanel;