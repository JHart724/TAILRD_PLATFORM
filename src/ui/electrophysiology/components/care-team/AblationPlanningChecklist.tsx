...
const AblationPlanningChecklist: React.FC = () => {
 ...
 <p className="text-titanium-600">Patient: {ablationPlan.patientId} • AF Type: {ablationPlan.afType}</p>
 </div>
 <div className="flex items-center gap-4">
 <div className="text-center">
 <div className="text-2xl font-bold text-porsche-600">{completionPercentage}%</div>
 <div className="text-sm text-titanium-500">Complete</div>
 </div>
 <button
 onClick={exportAblationPlan}
 className="p-2 text-titanium-600 hover:text-titanium-800 hover:bg-titanium-100 rounded-lg transition-colors"
 >
 ...
 <div 
 className="bg-porsche-600 h-2 rounded-full transition-all duration-300"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">AF Type</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">LA Size (mm)</label>
 <input
 type="number"
 ...
 <div className="text-sm text-titanium-600 mb-4">Single procedure success</div>
 <div className="space-y-2 text-xs text-titanium-500">
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <CircuitBoard className="w-5 h-5 text-chrome-500" />
 Ablation Strategy
 </h3>
 ...
 <span className="font-medium text-titanium-800">{assessment.label}</span>
 {assessment.required && (
 ...
 {assessment.notes && (
 <div className="text-sm text-titanium-500 mt-1">{assessment.notes}</div>
 )}
 </div>
 </div>
 ...
 <div key={drug.name} className="p-4 bg-titanium-50 rounded-lg border border-titanium-200">
 <div className="flex items-center justify-between">
 <div>
 <div className="font-medium text-titanium-800">{drug.name}</div>
 ...
 <div className="text-sm text-titanium-500">{drug.reason}</div>
 </div>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Medication</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Start Date</label>
 <input
 type="date"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">End Date (optional)</label>
 <input
 type="date"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Efficacy</label>
 <select
 ...
 <label className="text-sm font-medium text-titanium-600">Reason for discontinuation</label>
 <input
 type="text"
 ...
 className="px-4 py-2 bg-titanium-600 text-white rounded-lg hover:bg-titanium-700 transition-colors text-sm"
 >
 Cancel
 </button>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <h3 className="text-lg font-semibold text-titanium-800 mb-2">Schedule Ablation</h3>
 ...
 <div className="text-titanium-500">Complete all required assessments to schedule</div>
 )}
 </div>
 <div className="flex gap-3">
 <button
 ...
 className="px-6 py-3 bg-porsche-600 text-white rounded-lg hover:bg-porsche-700 disabled:bg-titanium-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
 >
