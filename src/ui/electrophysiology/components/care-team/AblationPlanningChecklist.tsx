...
const AblationPlanningChecklist: React.FC = () => {
 ...
 className="w-full mt-1 px-3 py-2 border border-titanium-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-medical-purple-500"
 >
 ...
 className="px-6 py-3 bg-medical-purple-600 text-white rounded-lg hover:bg-medical-purple-700 disabled:bg-titanium-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
 >
