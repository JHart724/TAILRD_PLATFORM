...
const OACManagementPanel: React.FC = () => {
 ...
 <p className="text-titanium-600">CHA₂DS₂-VASc & HAS-BLED Integration</p>
 </div>
 ...
 <h3 className="text-lg font-semibold text-titanium-800">Perioperative Bridging Guide</h3>
 <button
 ...
 <div
 key={patient.id}
 className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200 hover:shadow-lg transition-shadow"
 >
 {/* Patient Header */}
 <div className="flex items-center justify-between mb-4">
 <div>
 <h3 className="font-semibold text-titanium-800">{patient.name}</h3>
 ...
 <span className="font-medium text-titanium-800">Current Anticoagulation</span>
 </div>
 ...
 <div className="text-sm text-titanium-600">{patient.currentOAC.frequency}</div>
 </div>
 ...
 <div className="mb-4">
 <div className="flex items-center gap-2 mb-2">
 <Target className="w-4 h-4 text-chrome-500" />
 <span className="font-medium text-titanium-800">INR Monitoring</span>
 </div>
 
 <div className="grid grid-cols-2 gap-2 mb-2">
 <div className="p-2 bg-titanium-50 rounded">
 <div className="text-xs text-titanium-600">Latest INR</div>
 ...
 <span className="font-medium text-titanium-800">Recent Bleeding Events</span>
 </div>
 
 <div className="space-y-2">
 {patient.bleedingEvents.slice(0, 2).map((event, index) => (
 <div key={`${event.type}-${event.date}`} className="p-2 bg-red-50 border border-red-200 rounded text-xs">
 ...
 className="px-3 py-2 bg-titanium-600 text-white rounded-lg hover:bg-titanium-700 transition-colors text-sm"
 >
 ...
 <div className="mt-4 space-y-3 border-t border-titanium-200 pt-4">
 {/* INR Trend for Warfarin patients */}
 {patient.inr && (
 <div>
 <div className="font-medium text-titanium-800 mb-2">INR Trend</div>
 ...
 {/* Risk Factors Detail */}
 <div>
 <div className="font-medium text-titanium-800 mb-2">Risk Assessment</div>
 <div className="text-sm text-titanium-600">
 ...
 {/* Summary Statistics */}
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4">OAC Management Summary</h3>
 ...
 <div className="text-sm text-titanium-600">High Stroke Risk</div>
 </div>
 ...
 <div className="text-sm text-titanium-600">Poor INR Control</div>
 </div>
 ...
 <div className="text-sm text-titanium-600">Need Bridging</div>
 </div>
 </div>
 </div>
 </div>
