...
const EPPatientWorklist: React.FC = () => {
 ...
 actionItems: [
 { category: 'Anticoagulation', description: 'Start Ablation Referral', dueDate: '2024-01-20', urgent: true },
 { category: 'Device', description: 'Pacemaker evaluation', dueDate: '2024-01-25', urgent: false }
 ]
 },
 {
 id: 'P002',
 ...
 riskCategory: 'II',
 riskScore: 6.2,
 treatmentGaps: ['OAC Therapy optimization'],
 ablationEligible: true,
 phenotype: 'AF/AFL',
 ...
 actionItems: [
 { category: 'Anticoagulation', description: 'Optimize OAC Therapy dose', dueDate: '2024-01-22', urgent: false }
 ]
 },
 {
 id: 'P003',
 ...
 recentAdmission: false,
 actionItems: [
 { category: 'Ablation', description: 'Follow-up BNP', dueDate: '2024-02-05', urgent: false }
 ]
 }
  ];
 ...
 if (filterAnticoagulation && p.treatmentGaps.length === 0) return false;
 if (filterDevice && !p.ablationEligible) return false;
 return true;
  });
 ...
 <div className="text-sm text-titanium-600">MRN: {patient.mrn} • Age {patient.age} • Stroke Risk Score {patient.cha2ds2vascScore}%</div>
 </div>
 </div>
 ...
 <div>
 <div className="text-xs text-titanium-600 mb-1">CHA₂DS₂-VASc Class</div>
 <div className="font-medium text-titanium-800">{patient.riskCategory}</div>
 </div>
 <div>
 <div className="text-xs text-titanium-600 mb-1">Anticoagulation Gaps</div>
 <div className="font-medium text-amber-800">{patient.treatmentGaps.length} medications</div>
 </div>
 <div>
...
export default EPPatientWorklist;