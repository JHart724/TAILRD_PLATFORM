...
const EPPhenotypeDetectionChart: React.FC = () => {
  const phenotypes: PhenotypeData[] = [
 {
 name: 'Cardiac Atrial Fibrillation',
 prevalenceEst: 160,
 detected: 35,
 detectionRate: 22,
 actionable: 28,
 ...
 {
 name: 'Ventricular Tachycardia CM',
 prevalenceEst: 80,
 detected: 32,
 detectionRate: 40,
 actionable: 18,
 ...
 <div>
 <h3 className="text-lg font-semibold text-titanium-900">Beyond-Anticoagulation Phenotype Detection</h3>
 <p className="text-sm text-titanium-600 mt-1">12 Targetable Phenotypes in arrhythmia Population</p>
 </div>
...
export default EPPhenotypeDetectionChart;