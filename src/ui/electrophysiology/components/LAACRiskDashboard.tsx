...
const LAACRiskDashboard: React.FC = () => {
 ...
 <div key={patient.patientId} className="metal-card p-6">
 ...
 <div className="text-sm text-titanium-600">CHA₂DS₂-VASc</div>
 ...
 <div className="text-center">
 <div className="text-sm text-titanium-600">HAS-BLED</div>
 ...
 <div className="text-center">
 <div className="text-sm text-titanium-600">Stroke Risk</div>
 <div className="text-lg font-bold text-titanium-900">{patient.assessment.strokeRisk}%</div>
 </div>
 <div className="text-center">
 ...
 <div className="text-center">
 <div className="text-sm text-titanium-600">Reimbursement</div>
 ...
 {/* Clinical Data */}
 <div className="p-4 bg-white rounded-lg border border-titanium-200">
 <h4 className="text-sm font-medium text-titanium-900 mb-3">Clinical History</h4>
 <div className="grid grid-cols-2 gap-2 text-sm">
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.chf ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 Heart Failure
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.hypertension ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 Hypertension
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.diabetes ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 Diabetes
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.stroke ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 Stroke/TIA
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.bleedingHistory ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 Bleeding History
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-2 h-2 rounded-full ${patient.clinicalHistory.anticoagContraindicated ? 'bg-medical-red-500' : 'bg-titanium-300'}`}></div>
 ...
 {/* Lab Values */}
 <div className="p-4 bg-white rounded-lg border border-titanium-200">
 <h4 className="text-sm font-medium text-titanium-900 mb-3">Lab Values & Imaging</h4>
 <div className="grid grid-cols-2 gap-2 text-sm">
 ...
 <div className="p-4 bg-medical-red-50 rounded-lg border border-medical-red-200">
 <div className="text-sm font-medium text-titanium-900 mb-2">Contraindications</div>
 <div className="space-y-1">
 {patient.assessment.contraindications.map((contraindication, index) => (
 <div key={contraindication} className="flex items-center gap-2 text-sm text-medical-red-700">
