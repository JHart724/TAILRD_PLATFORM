...
const AnticoagulationSafetyChecker: React.FC = () => {
  // Demo patient defaults — a 72 y/o with AFib, moderate CKD, and peptic ulcer history
 ...
 <Droplets className="w-8 h-8 text-porsche-500" />
 <div>
 <h2 className="text-2xl font-bold text-titanium-900 font-sf">Anticoagulation Safety Checker</h2>
 <p className="text-titanium-600">Comprehensive bleeding and stroke risk assessment</p>
 </div>
 </div>
 ...
 <h3 className="font-semibold text-porsche-800 mb-3">Patient Demographics & Labs</h3>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Hemoglobin</label>
 <input
 type="number"
 step="0.1"
 ...
 <div className="space-y-3">
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">CHA₂DS₂-VASc Score</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">HAS-BLED Score</label>
 <input
 type="number"
 ...
 <h3 className="text-lg font-semibold text-titanium-900 mb-4">Risk-Benefit Assessment</h3>
