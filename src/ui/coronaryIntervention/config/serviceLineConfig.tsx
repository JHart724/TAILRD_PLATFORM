...
import { Activity, Network, Target, Users, Calculator, Shield, BarChart3, Award, Grid3X3, FileText, Heart, Zap, AlertTriangle, ChevronDown, ChevronUp, TrendingUp } from 'lucide-react';
...
const CoronaryInterventionAnalytics: React.FC = () => (
 ...
 <div className="text-sm text-teal-700">+8.4% vs last quarter</div>
 </div>
 <div className="metal-card p-6">
 ...
 <div className="text-sm text-teal-700">+3.2% vs last quarter</div>
 </div>
 <div className="metal-card p-6">
 ...
 <div className="text-sm text-teal-700">+12.1% vs last quarter</div>
 </div>
 <div className="metal-card p-6">
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Avg Success Rate</p><p className="text-3xl font-bold text-teal-700">97.7%</p><p className="text-xs text-titanium-500 mt-1">Across all coronary procedures</p></div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {providers.map((p, i) => (
                <tr key={i} className="hover:bg-titanium-50 transition-colors">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-600">{p.successRate}</span></td>
                  <td className="px-4 py-3"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">{p.complications}</span></td>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-porsche-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Total PCI Volume</p><p className="text-3xl font-bold text-titanium-900">2,847</p><p className="text-xs text-teal-700 mt-1">+8.4% vs last quarter</p></div>
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Overall Success Rate</p><p className="text-3xl font-bold text-teal-700">97.8%</p><p className="text-xs text-titanium-500 mt-1">Technical procedural success</p></div>
        <div className="metal-card p-5 border-l-4 border-l-slate-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">IVUS/OCT Use Rate</p><p className="text-3xl font-bold text-slate-700">42.1%</p><p className="text-xs text-teal-700 mt-1">+6.2% vs last quarter</p></div>
      </div>
      <div className="metal-card bg-white rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-titanium-100 flex items-center gap-2">
            ...
            <tbody className="divide-y divide-titanium-100">
              {procedures.map((p, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-600">{p.success}</span></td>
                  <td className="px-4 py-3"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">{p.complications}</span></td>
...
const CABGAnalytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-porsche-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Total CABG Volume</p><p className="text-3xl font-bold text-titanium-900">456</p><p className="text-xs text-teal-700 mt-1">+3.2% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-red-400"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Risk-Adj. Mortality</p><p className="text-3xl font-bold text-red-700">1.8%</p><p className="text-xs text-teal-700 mt-1">Below STS benchmark (2.4%)</p></div>
        <div className="metal-card p-5 border-l-4 border-l-blue-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Arterial Graft Rate</p><p className="text-3xl font-bold text-blue-700">84.2%</p><p className="text-xs text-teal-700 mt-1">+3.1% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-slate-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Bilateral IMA Rate</p><p className="text-3xl font-bold text-slate-700">41.3%</p><p className="text-xs text-teal-700 mt-1">+8.7% vs last quarter</p></div>
      </div>
      <div className="metal-card bg-white rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-titanium-100 flex items-center gap-2">
            ...
            <tbody className="divide-y divide-titanium-100">
              {data.map((d, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">{d.stroke}</span></td>
...
const STEMIPathways: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-red-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Primary PCI Volume</p><p className="text-3xl font-bold text-titanium-900">387</p><p className="text-xs text-teal-700 mt-1">+12.1% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Median D2B Time</p><p className="text-3xl font-bold text-teal-700">52 min</p><p className="text-xs text-titanium-500 mt-1">ACC/AHA target: ≤90 min</p></div>
        <div className="metal-card p-5 border-l-4 border-l-blue-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">D2B ≤90 Min Rate</p><p className="text-3xl font-bold text-blue-700">94.6%</p><p className="text-xs text-teal-700 mt-1">Above ACC benchmark (75%)</p></div>
      </div>
      <div className="metal-card bg-white rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {metrics.map((m, i) => (
            <div key={i} className="rounded-xl border bg-green-50 border-green-100 px-4 py-3 flex items-start justify-between">
              <div>
              ...
              <p className="text-xs text-teal-700 font-medium text-right ml-2">{m.trend}</p>
            </div>
          ))}
        </div>
      </div>
      <div className="metal-card bg-white rounded-2xl overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-titanium-100">
            {sites.map((s, i) => <tr key={i} className="hover:bg-titanium-50"><td className="px-4 py-3 font-medium text-titanium-900">{s.name}</td><td className="px-4 py-3 font-mono font-semibold">{s.vol}</td><td className="px-4 py-3">{s.d2b}</td><td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-600">{s.rate}</span></td></tr>)}
          </tbody>
        </table>
      </div>
    </div>
...
const CoronaryQualityMetrics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Above Benchmark</p><p className="text-3xl font-bold text-teal-700">8 / 10</p><p className="text-xs text-titanium-500 mt-1">CathPCI + STS registry measures</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Below Benchmark</p><p className="text-3xl font-bold text-gray-500">2 / 10</p><p className="text-xs text-titanium-500 mt-1">Cardiac rehab + PCSK9i gap</p></div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {measures.map((m, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${m.above ? 'bg-green-50 text-green-600' : 'bg-red-100 text-red-800'}`}>{m.above ? 'Above Benchmark' : 'Below / Gap'}</span></td>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Complete Revasc Needed</p>
          <p className="text-3xl font-bold text-gray-500">{totalRevasc}</p>
      ...
      {/*
        ...
        "18 months to clear pipeline", "6 months with TAILRD protocol", and "Revenue Acceleration
        $4.7M in 12 months" behind a "Forward-looking" chip. The first two are a PRODUCT EFFICACY claim -
