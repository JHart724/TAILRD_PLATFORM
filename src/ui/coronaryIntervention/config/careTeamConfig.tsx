...
const CoronaryPatients: React.FC = () => (
 ...
 patient.procedure.includes('Complex') ? 'bg-amber-100 text-amber-700' :
 ...
 patient.urgency === 'Urgent' ? 'bg-amber-100 text-amber-700' :
 ...
 patient.status === 'Planning' ? 'bg-amber-100 text-amber-700' :
...
const CoronaryWorkflow: React.FC = () => (
 ...
 <div className="ml-auto text-sm text-amber-600 font-medium">&lt;20 min</div>
 </div>
 ...
 <div key={index} className="grid grid-cols-3 gap-4 p-3 bg-titanium-50 rounded-lg">
 ...
 decision.pci === 'Acceptable*' ? 'bg-amber-100 text-amber-700' :
...
const CoronaryClinicalCollaboration: React.FC = () => (
 ...
 pathway.indication === 'High SYNTAX Score' ? 'bg-amber-50 border-amber-200' :
 ...
 pathway.indication === 'High SYNTAX Score' ? 'text-amber-900' :
 ...
 pathway.indication === 'High SYNTAX Score' ? 'bg-amber-100 text-amber-700' :
 ...
 <div className="text-xs text-amber-700">Clinical Complications</div>
 </div>
 </div>
 </div>
 ...
 <div className="font-medium text-amber-900">CTO Assessment</div>
 <div className="text-sm text-amber-700">Patient evaluation for chronic total occlusion</div>
 <div className="text-xs text-amber-600">Specialist consultation pending</div>
 </div>
 ...
 >
 <div className="font-medium text-amber-900">Risk Assessment Tools</div>
 <div className="text-xs text-amber-600">Clinical risk stratification</div>
 </button>
...
const CoronaryDocumentation: React.FC = () => (
 ...
 <div className="bg-white p-4 rounded-lg border border-amber-200">
 <div className="flex items-center justify-between mb-2">
 <span className="font-medium text-amber-900">Quality Metrics Review</span>
 <span className="text-xs bg-amber-100 text-amber-700 px-2 py-1 rounded-full">PENDING</span>
 </div>
 <div className="text-sm text-amber-700">Door-to-balloon times require monthly review and analysis</div>
 <div className="text-xs text-amber-600 mt-1">Quality committee meeting: Friday 2 PM</div>
 </div>
 </div>
 </div>
 ...
 <span className="text-xs bg-amber-100 text-amber-700 px-2 py-1 rounded-full">HIGH</span>
 )}
 </div>
