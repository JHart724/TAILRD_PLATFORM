...
const CoronaryExecutiveView: React.FC = () => {
 ...
 { label: 'FFR/iFR Guidance', value: 12400000, color: 'bg-violet-500' },
 ...
 lastUpdated: '2024-01-15T10:30:00Z'
  ...
  return (
 <div className="min-h-screen bg-gradient-to-br from-porsche-50 via-titanium-50 to-crimson-50/10 p-6 relative overflow-hidden">
 {/* Porsche Liquid Metal Background */}
 ...
 <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-crimson-400/8 to-porsche-400 rounded-full blur-3xl" />
 ...
 Financial performance and population health insights for Coronary Intervention
 </p>
 <p className="text-sm text-titanium-400 mt-1">
 PCI Analytics &bull; STEMI/NSTEMI Outcomes &bull; Stent Optimization &bull; Cath Lab Efficiency
 </p>
 </div>
 <ExportButton
 ...
 <div className="px-6 py-4 border-b border-titanium-200 bg-gradient-to-r from-white to-porsche-50 rounded-t-2xl">
 ...
 summaryMetrics={[
 { label: 'Projected', value: `$${(selectedMonth.projected / 1000000).toFixed(1)}M`, colorScheme: 'porsche' },
 { label: 'Realized', value: `$${(selectedMonth.realized / 1000000).toFixed(1)}M`, colorScheme: 'green' },
 {
 label: 'Variance',
 value: `$${(Math.abs(selectedMonth.projected - selectedMonth.realized) / 1000000).toFixed(1)}M`,
 ...
 { label: 'Percentile', value: `${selectedBenchmark.percentile}th`, colorScheme: selectedBenchmark.percentile >= 75 ? 'green' : 'amber' },
 ]}
 ...
 summaryMetrics={[
 { label: 'Total Revenue', value: `$${(selectedDRG.totalRevenue / 1000000).toFixed(1)}M`, colorScheme: 'green', icon: <DollarSign className="w-8 h-8" /> },
 { label: 'Average LOS', value: `${selectedDRG.avgLos} days`, colorScheme: 'porsche' },
 { label: 'Average Cost', value: `$${(selectedDRG.avgCost / 1000).toFixed(1)}K`, colorScheme: 'violet' },
 ...
 { label: 'Share of Total', value: cat ? `${((cat.value / 70900000) * 100).toFixed(1)}%` : 'N/A' },
