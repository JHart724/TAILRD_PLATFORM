...
• Risk Factors: ${casePlan.complications.factors.join(', ')}
 ...
 switch (complexity) {
 case 'low':
 return 'text-green-600 bg-green-50 border-teal-700';
 case 'intermediate':
 return 'text-amber-600 bg-amber-50 border-titanium-300';
 case 'high':
 ...
 <h2 className="text-xl font-bold text-titanium-900">Case Planning Tool</h2>
 <div className="flex items-center space-x-3">
 <select 
 value={casePlan.procedureType}
 onChange={(e) => handleProcedureTypeChange(e.target.value as 'PCI' | 'CABG')}
 className="px-3 py-2 border border-titanium-300 rounded-lg text-sm"
 >
 ...
 {/* SYNTAX Score */}
 <div>
 <h3 className="text-lg font-semibold text-titanium-800 mb-3">SYNTAX Score Assessment</h3>
 ...
 <span className="px-2 py-1 text-xs rounded-full bg-white font-medium">
 ...
 <div>
 <span className="font-medium text-teal-700">LIMA to LAD</span>
 <div className="text-sm text-teal-700">Gold standard graft</div>
 </div>
 <span className="text-teal-700">✓ Auto-selected</span>
 </div>
 </div>
 ...
 <div key={conduit.key} className="flex items-center justify-between p-3 bg-titanium-50 rounded-lg">
 <div>
 <span className="font-medium text-titanium-900">{conduit.label}</span>
 <div className="text-sm text-titanium-600">{conduit.description}</div>
 </div>
 ...
 {/* Patency Rates */}
 <div className="mt-4">
 <h4 className="font-medium text-titanium-800 mb-2">Expected Patency Rates</h4>
 ...
 return (
 <div key={key} className="bg-porsche-50 rounded p-2 text-sm">
 ...
 {/* Hemodynamics Planning */}
 <div>
 <h3 className="text-lg font-semibold text-titanium-800 mb-3">Hemodynamics Planning</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Access Site</label>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Heparin Dose (units/kg)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Target ACT (sec)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Physiology & Imaging</label>
 <div className="grid grid-cols-2 gap-4">
 {[
 ...
 className="mr-2 rounded border-titanium-300"
 />
 ...
 <div>
 <h3 className="text-lg font-semibold text-titanium-800 mb-3">Mechanical Circulatory Support</h3>
 <div className="space-y-3">
 <label className="flex items-center">
 <input
 type="checkbox"
 ...
 className="mr-3 rounded border-titanium-300"
 />
 ...
 <div className="space-y-3">
 <div>
 <label className="block text-sm font-medium text-gray-500 mb-2">Device Selection</label>
 <select
 ...
 className="w-full px-3 py-2 border border-titanium-300 rounded-lg bg-white"
 >
 ...
 <div>
 <label className="block text-sm font-medium text-gray-500 mb-1">Indication</label>
 <input
 type="text"
 ...
 casePlan.complications.riskLevel === 'medium' ? 'bg-chrome-50 border-titanium-300' :
 ...
 {casePlan.complications.factors.map((factor) => (
 <div key={factor} className="text-sm bg-white rounded p-2">
 • {factor}
 </div>
 ))}
 </div>
 ...
 {/* Case Summary */}
 <div>
 <h3 className="text-lg font-semibold text-titanium-800 mb-3">Case Summary</h3>
 ...
 <div className="flex justify-between items-center mt-6 pt-4 border-t border-titanium-200">
 ...
 className="px-4 py-2 bg-porsche-100 text-porsche-700 rounded-lg hover:bg-porsche-200 transition-colors text-sm"
 >
 Review Plan
 </button>
 <button
 ...
 <h3 className="text-lg font-bold text-titanium-900">Case Plan Summary</h3>
 <button
 onClick={() => setShowCasePlan(false)}
 className="text-titanium-500 hover:text-titanium-700"
 >
 ✕
 </button>
 </div>
