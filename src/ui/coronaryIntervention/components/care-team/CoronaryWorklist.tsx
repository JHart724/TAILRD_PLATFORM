...
const CoronaryWorklist: React.FC = () => {
 ...
 const searchable = [
   p.name, p.mrn, p.priority, p.status,
   p.procedureType, p.lesionComplexity,
   p.recommendation
 ].join(' ').toLowerCase();
 ...
 return filtered;
  }, [mockPatients, activeTab, debouncedSearch, filterStatus, filterPriority, sortField, sortDirection]);
 ...
 <div className={`p-2 rounded ${patient.angiogramSummary.lm ? 'bg-red-100 text-red-700' : 'bg-green-50 text-green-600'}`}>
 LM: {patient.angiogramSummary.lm ? 'Disease' : 'Normal'}
 </div>
 <div className={`p-2 rounded ${patient.angiogramSummary.lad ? 'bg-red-100 text-red-700' : 'bg-green-50 text-green-600'}`}>
 LAD: {patient.angiogramSummary.lad ? 'Disease' : 'Normal'}
 </div>
 <div className={`p-2 rounded ${patient.angiogramSummary.lcx ? 'bg-red-100 text-red-700' : 'bg-green-50 text-green-600'}`}>
 LCX: {patient.angiogramSummary.lcx ? 'Disease' : 'Normal'}
 </div>
 <div className={`p-2 rounded ${patient.angiogramSummary.rca ? 'bg-red-100 text-red-700' : 'bg-green-50 text-green-600'}`}>
 RCA: {patient.angiogramSummary.rca ? 'Disease' : 'Normal'}
 </div>
 </div>
 <p className="text-sm text-titanium-600 mt-2">{patient.angiogramSummary.severity}</p>
 </div>
 </div>
 ...
 <div className="text-lg font-semibold text-titanium-800">{patient.recommendation}</div>
 </div>
 </div>
 </div>
 ...
 value === 'Low' ? 'bg-green-50 text-green-600' :
 value === 'Intermediate' ? 'bg-amber-50 text-amber-600' :
 ...
 <h4 className="font-semibold text-titanium-800 mb-3 flex items-center gap-2">
 <Pill className="w-4 h-4 text-chrome-500" />
 DAPT Plan
 </h4>
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-sm text-titanium-600">Medication</div>
 <div className="text-sm font-medium text-titanium-800">{patient.daptPlan.medication}</div>
 </div>
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-sm text-titanium-600">Duration</div>
 <div className="text-sm font-medium text-titanium-800">{patient.daptPlan.duration}</div>
 </div>
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-sm text-titanium-600">End Date</div>
 <div className="text-sm font-medium text-titanium-800">{new Date(patient.daptPlan.endDate).toLocaleDateString()}</div>
 </div>
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 ...
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-sm text-titanium-600">Start Date</div>
 <div className="text-sm font-medium text-titanium-800">
 ...
 <div className="p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-sm text-titanium-600">Completion</div>
 <div className="text-sm font-medium text-titanium-800">{patient.cardiacRehab.completion}%</div>
 </div>
 )}
 </div>
 </div>
 ...
 patient.lesionComplexity === 'Intermediate' ? 'bg-amber-50 text-amber-600' :
