...
const PCINetworkVisualization: React.FC = () => {
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.doorToBalloonCompliance * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.cathLabUtilization * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.complexPciSuccessRate * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.averageSyntaxScore.toFixed(1)}</div>
 ...
 <span className="font-bold text-chrome-600">{(metrics.complexPciSuccessRate * 100).toFixed(1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Average SYNTAX Score</span>
 <span className="font-bold text-amber-600">{metrics.averageSyntaxScore.toFixed(1)}</span>
 </div>
 </div>
 </div>
 ...
 <span className="font-bold text-chrome-600">{(metrics.cathLabUtilization * 100).toFixed(1)}%</span>
 </div>
 <div className="flex justify-between items-center">
