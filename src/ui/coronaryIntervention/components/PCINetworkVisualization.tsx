...
const PCINetworkVisualization: React.FC = () => {
 ...
 <div>
 <h3 className="text-2xl font-bold text-titanium-900">PCI Network Visualization</h3>
 <p className="text-titanium-600">Real-time coronary intervention pathways and door-to-balloon optimization</p>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.stemiFmiTime}min</div>
 <div className="text-xs text-titanium-600">STEMI FMC-I</div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white p-4 rounded-xl border border-titanium-200">
 <div className="flex items-center gap-3">
 <Activity className="w-6 h-6 text-chrome-600" />
 <div>
 <div className="text-lg font-bold text-titanium-900">{toFixed(metrics.cathLabUtilization * 100, 0)}%</div>
 <div className="text-xs text-titanium-600">Lab Utilization</div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white p-4 rounded-xl border border-titanium-200">
 <div className="flex items-center gap-3">
 <Target className="w-6 h-6 text-arterial-600" />
 <div>
 <div className="text-lg font-bold text-titanium-900">{toFixed(metrics.complexPciSuccessRate * 100, 0)}%</div>
 <div className="text-xs text-titanium-600">Complex PCI</div>
 </div>
 </div>
 </div>
 ...
 width="600"
 height="450"
 className="border border-titanium-100 rounded-lg bg-gradient-to-br from-titanium-50 to-white"
 >
 {/* Render connections */}
 ...
 <div className="text-lg font-bold text-chrome-600">{selectedNode.pciVolume}</div>
 <div className="text-xs text-chrome-700">PCI Volume</div>
 </div>
 )}
 ...
 <div className="text-lg font-bold text-emerald-600">{toFixed(selectedNode.successRate * 100, 0)}%</div>
 <div className="text-xs text-emerald-700">Success Rate</div>
 </div>
 )}
 {selectedNode.syntaxScore && (
 <div className="bg-amber-50 p-3 rounded-lg">
 <div className="text-lg font-bold text-amber-600">{selectedNode.syntaxScore}</div>
 <div className="text-xs text-amber-700">SYNTAX Score</div>
 </div>
 )}
 </div>
 ...
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Complex PCI Success</span>
 <span className="font-bold text-chrome-600">{toFixed(metrics.complexPciSuccessRate * 100, 1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Average SYNTAX Score</span>
 <span className="font-bold text-amber-600">{toFixed(metrics.averageSyntaxScore, 1)}</span>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-3">
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Current Utilization</span>
 <span className="font-bold text-chrome-600">{toFixed(metrics.cathLabUtilization * 100, 1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">STEMI FMC-to-Device</span>
 <span className="font-bold text-red-600">{metrics.stemiFmiTime} min</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Daily Volume</span>
 <span className="font-bold text-arterial-600">{Math.floor(metrics.totalPciVolume / 30)}</span>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-3">
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Active Interventionalists</span>
 <span className="font-bold text-arterial-600">{nodes.filter(n => n.type === 'provider').length}</span>
 </div>
 <div className="flex justify-between items-center">
