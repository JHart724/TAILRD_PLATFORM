...
const CADInterventionPathwayFunnel: React.FC = () => {
 ...
 <div className="text-sm text-green-700 font-medium">Avg SYNTAX</div>
 ...
 patient.status === 'treated' ? 'bg-green-500' :
 ...
 <button 
 onClick={() => {
 console.log('Generating CAD intervention report:', selectedIntervention, selectedMetric);
 {}
 }}
 ...
 <button 
 onClick={() => {
 console.log('Scheduling CAD intervention reviews:', selectedIntervention, getFilteredPatients().length);
 {}
 }}
