...
const CADFinancialWaterfall: React.FC = () => {
  const [selectedCategory, setSelectedCategory] = useState<string | null>(null);

  // Mock data - will be replaced with real API data
  const waterfallData: WaterfallItem[] = [
 {
 category: 'PCI Optimization',
 value: 12400000,
 description: 'Stent selection, complex lesion intervention',
 opportunities: 412,
 avgPerPatient: 30100,
 },
 {
 category: 'CABG Evaluation',
 value: 18900000,
 description: 'Surgical revascularization for complex CAD',
 opportunities: 156,
 avgPerPatient: 121200,
 },
 {
 category: 'GDMT Enhancement',
 value: 6800000,
 description: 'Statin, antiplatelet, ACEi optimization',
 opportunities: 834,
 avgPerPatient: 8200,
 },
 {
 ...
 value: 8600000,
 description: 'TAVR, MitraClip, complex valve procedures',
 opportunities: 89,
 avgPerPatient: 96600,
 },
 {
 category: 'Chronic CAD Management',
 value: 4200000,
 description: 'Long-term risk stratification & management',
 opportunities: 567,
 avgPerPatient: 7400,
 },
  ];
 ...
 CAD Revenue Opportunity Waterfall
 </h2>
 <p className="text-titanium-600">
 Annual revenue opportunity by coronary intervention category
 </p>
 </div>
 ...
 <div className="text-xs text-porsche-700 mt-1">PCI Optimization</div>
 </div>
...
export default CADFinancialWaterfall;