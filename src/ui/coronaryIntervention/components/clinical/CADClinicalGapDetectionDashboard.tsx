                          ...
                          <div key={pt.id} className="border border-titanium-200 rounded-xl overflow-hidden">
                            ...
                            >
                              <div>
                                ...
                                {gap.category === 'Discovery' && (
                                  <span className="ml-2 text-xs px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 font-semibold inline-flex items-center gap-1">
                            ...
                            {ptOpen && (
                              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                {gap.whyTailrd && (
                                  <div className="col-span-1 md:col-span-2 bg-indigo-50 border border-indigo-200 rounded-xl p-3">
