...
const CoronarySpecialtyPhenotypesDashboard: React.FC = () => {
 ...
 <div className="flex flex-wrap gap-1">
 {phenotype.interventions.slice(0, 2).map((intervention, index) => (
 ...
 ${phenotype.revenueGap >= 1000000 ? `${(phenotype.revenueGap / 1000000).toFixed(2)}M` : `${(phenotype.revenueGap / 1000).toFixed(0)}K`}
 </div>
