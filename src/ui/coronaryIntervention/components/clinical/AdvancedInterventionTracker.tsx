...
const AdvancedInterventionTracker: React.FC = () => {
 ...
 case 'diagnostic': return 'text-amber-600 bg-amber-50 border-titanium-300';
 case 'imaging': return 'text-green-600 bg-green-50 border-teal-700';
 ...
 <div className="text-2xl font-bold text-teal-700 font-sf">{totalUtilized.toLocaleString()}</div>
 <div className="text-sm text-teal-700">Currently Receiving</div>
 </div>
 <div className="p-4 bg-chrome-50 border border-titanium-300 rounded-lg">
 <div className="text-2xl font-bold text-gray-500 font-sf">{Math.round((totalUtilized / totalEligible) * 100)}%</div>
 ...
 item.currentUtilization < 30 ? 'bg-chrome-50' :
 item.currentUtilization < 50 ? 'bg-porsche-500' : 'bg-titanium-300'
 }`}
 ...
 <div className="text-center p-2 bg-titanium-300 rounded">
 <div className="font-bold text-teal-700">{item.utilizedPatients}</div>
 <div className="text-xs text-teal-700">Current</div>
 </div>
 ...
 {/* Revenue Impact */}
 <div className="flex items-center justify-between p-3 bg-green-50 border border-green-100 rounded-lg mb-4">
 <div>
 <div className="text-sm font-semibold text-teal-700">Revenue Gap</div>
 <div className="text-xs text-teal-700">{item.citation}</div>
 </div>
 ...
 <div className="p-4 border-2 border-teal-700 rounded-lg">
 <DollarSign className="w-6 h-6 text-teal-700 mb-2" />
 <div className="text-sm font-semibold text-teal-700">Revenue Leader</div>
 <div className="text-lg font-bold text-teal-700">$6.1M</div>
 <div className="text-xs text-teal-700">DES program expansion</div>
 </div>
 ...
 <div className="text-sm font-semibold text-gray-500">Population Impact</div>
 <div className="text-lg font-bold text-gray-500">{(totalEligible - totalUtilized).toLocaleString()}</div>
 <div className="text-xs text-gray-500">Total underserved patients</div>
 </div>
 </div>
 </div>
 </div>
