...
const AdvancedInterventionTracker: React.FC = () => {
 ...
 ${item.revenueGap >= 1000000 ? `${(item.revenueGap / 1000000).toFixed(1)}M` : `${(item.revenueGap / 1000).toFixed(0)}K`}
 </div>
 </div>
 </div>
 ...
 onClick={() => {
 console.log('Opening patient screening for intervention candidacy');
 ...
 onClick={() => {
 console.log('Opening intervention guidelines');
