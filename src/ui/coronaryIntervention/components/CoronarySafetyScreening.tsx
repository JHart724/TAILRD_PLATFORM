...
const CoronarySafetyScreening: React.FC = () => {
  // Demo patient defaults — a 68 y/o with HTN, DM2 on metformin, moderate CKD pre-PCI
  const demoDefaults: PatientData = {
 age: 68,
 weight: 84,
 creatinine: 1.4,
 egfr: 55,
 ...
 heartFailure: false
  ...
  const [patientData, setPatientData] = useState<PatientData>({ ...demoDefaults });

  const resetToDemo = () => setPatientData({ ...demoDefaults });
 ...
 case 'high': return <AlertTriangle className="w-5 h-5 text-amber-600" />;
 ...
 <p className="text-titanium-600">DAPT & Contrast Safety Assessment for PCI</p>
 </div>
 </div>

 <div className="mt-4 p-3 bg-chrome-50 border border-chrome-200 rounded-lg flex items-center justify-between">
 <p className="text-sm text-chrome-800">
 <strong>Clinical Decision Support Tool</strong> — Pre-filled with demo patient data. Modify values to screen for contraindications.
 </p>
 <button
 onClick={resetToDemo}
 className="ml-4 px-4 py-1.5 text-sm font-medium text-chrome-700 bg-white border border-chrome-300 rounded-lg hover:bg-chrome-50 transition-colors whitespace-nowrap"
 >
 ...
 {/* Patient Data Input */}
 <div className="bg-white rounded-xl border border-titanium-200 p-6 shadow-chrome-card-hover">
 <h3 className="text-lg font-semibold text-titanium-900 mb-4 font-sf">Patient Assessment</h3>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Weight (kg)</label>
 <input
 type="number"
 ...
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Creatinine (mg/dL)</label>
 <input
 type="number"
 step="0.1"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">eGFR (mL/min/1.73m²)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Platelet Count (×10³/μL)</label>
 <input
 type="number"
 ...
 <h4 className="font-medium text-titanium-900">Risk Factors</h4>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Prior Contrast Reaction</label>
 <select
 ...
 <h3 className="text-lg font-semibold text-titanium-900 font-sf">DAPT Safety Assessment</h3>
 ...
 <p className="text-sm text-titanium-700 bg-titanium-50 p-3 rounded-lg">
 ...
 <div>
 <h4 className="font-medium text-titanium-900 mb-2">Monitoring Required</h4>
 <ul className="space-y-1">
 {daptAssessment.monitoring.map((item, index) => (
 <li key={index} className="text-sm text-titanium-700 flex items-center gap-2">
 ...
 <div>
 <h4 className="font-medium text-titanium-900 mb-2">Alternative Strategies</h4>
 <ul className="space-y-1">
 ...
 <div className="bg-white rounded-xl border border-titanium-200 p-6 shadow-chrome-card-hover">
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-lg font-semibold text-titanium-900 font-sf">Contrast Safety Assessment</h3>
