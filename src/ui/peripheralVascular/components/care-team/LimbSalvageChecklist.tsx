...
const LimbSalvageChecklist: React.FC = () => {
 ...
 switch (stage) {
 case 1: return 'text-[#2C4A60] bg-[#C8D4DC]';
 case 2: return 'text-[#6B7280] bg-[#F0F5FA]';
 ...
 if (risk <= 20) return 'text-[#2C4A60] bg-[#C8D4DC]';
 if (risk <= 40) return 'text-[#6B7280] bg-[#F0F5FA]';
 ...
 case 'Urgent': return 'text-[#6B7280] bg-[#F0F5FA]';
 case 'Elective': return 'text-[#2C4A60] bg-[#C8D4DC]';
 default: return 'text-titanium-600 bg-titanium-100';
 }
  };
 ...
 <p className="text-titanium-600">Patient: {salvagePlan.patientId} • WIfI Stage {salvagePlan.wifi.stage}</p>
 </div>
 <button
 ...
 <Calculator className="w-5 h-5 text-chrome-500" />
 WIfI Assessment
 </h3>
 ...
 {/* Wound */}
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-3 block">Wound (W)</label>
 ...
 {/* Ischemia */}
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-3 block">Ischemia (I)</label>
 <div className="space-y-2">
 {[
 ...
 {/* Infection */}
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-3 block">Infection (fI)</label>
 <div className="space-y-2">
 {[
 ...
 {/* WIfI Stage Result */}
 <div className="flex items-center justify-center p-4 bg-titanium-50 rounded-lg">
 <div className="text-center">
 <div className="text-sm text-titanium-600 mb-1">WIfI Stage</div>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <MapPin className="w-5 h-5 text-arterial-500" />
 TASC Classification
 </h3>
 
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-titanium-600">Location</label>
 <select
 value={salvagePlan.tasc.location}
 onChange={(e) => updateTASC('location', e.target.value)}
 className="w-full mt-1 px-3 py-2 border border-titanium-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-medical-red-500"
 >
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">TASC Grade</label>
 ...
 <div className="text-xs text-titanium-600">Description</div>
 <div className="text-sm text-titanium-800">{salvagePlan.tasc.description}</div>
 <div className="text-xs text-titanium-500 mt-1">
 ...
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-titanium-600">Run-off Vessels</label>
 ...
 ? 'bg-[#C8D4DC] border-[#2C4A60] text-[#2C4A60]'
 : 'bg-white border-titanium-200 text-titanium-700 hover:bg-titanium-50'
 }`}
 >
 {vessels}
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Vessel Quality</label>
 <div className="grid grid-cols-3 gap-2 mt-1">
 ...
 ? 'bg-chrome-50 border-chrome-300 text-chrome-800'
 : 'bg-white border-titanium-200 text-titanium-700 hover:bg-titanium-50'
 }`}
 >
 {quality}
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600">Target Vessels</label>
 <textarea
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Great Saphenous Vein</label>
 <div className="space-y-2">
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Arm Vein</label>
 <div className="space-y-2">
 {(['Available', 'Used', 'Inadequate', 'Unknown'] as const).map(status => (
 <button
 key={status}
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Options</label>
 ...
 />
 <span className="text-sm text-titanium-700">Prosthetic conduit acceptable</span>
 </label>
 </div>
 </div>
 </div>
 ...
 <label key={key} className="flex items-center gap-2 p-3 bg-titanium-50 rounded-lg">
 <input
 type="checkbox"
 checked={value}
 ...
 className="rounded border-titanium-300"
 />
 <span className="text-sm text-titanium-700 capitalize">
 ...
 <div className="mt-4">
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Infection Control Status</label>
 ...
 ? status === 'Adequate' ? 'bg-[#C8D4DC] border-[#2C4A60] text-[#2C4A60]' :
 ...
 <div className="text-sm text-titanium-600">Amputation Risk</div>
 </div>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200 text-center">
 <div className="mb-2">
 <Target className="w-8 h-8 text-chrome-500 mx-auto mb-2" />
 <div className="text-sm text-titanium-600">Timeline</div>
 </div>
 <div className="text-lg font-medium text-titanium-800">
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <TrendingUp className="w-5 h-5 text-chrome-500" />
 Clinical Recommendations
 </h3>
 
 <div className="space-y-2">
 {getRecommendations().map((recommendation, index) => (
 <div key={recommendation} className="flex items-start gap-3 p-3 bg-chrome-50 border border-chrome-200 rounded-lg">
 <Check className="w-5 h-5 text-chrome-600 mt-0.5 flex-shrink-0" />
 <span className="text-sm text-chrome-800">{recommendation}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-lg font-semibold text-titanium-800">Plan Status</div>
 <div className="text-titanium-600">Current: {salvagePlan.status}</div>
 </div>
