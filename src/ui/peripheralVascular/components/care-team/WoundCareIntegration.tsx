...
const WoundCareIntegration: React.FC = () => {
 ...
 switch (depth) {
 case 'Superficial': return 'text-green-600 bg-green-50';
 case 'Partial thickness': return 'text-amber-600 bg-amber-50';
 ...
 case 'Cellulitis': return 'text-amber-600 bg-amber-50';
 ...
 case 'Surveillance': return 'text-green-600 bg-green-50';
 ...
 case 'Wound care': return 'text-green-600 bg-green-50';
 case 'Infectious disease': return 'text-arterial-600 bg-arterial-100';
 case 'Endocrine': return 'text-amber-600 bg-amber-50';
 ...
 <Bandage className="w-8 h-8 text-teal-700" />
 ...
 className="flex items-center gap-2 px-6 py-3 bg-teal-700 text-white rounded-lg hover:bg-teal-700 transition-colors"
 >
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Location</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Size (cm²)</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Depth</label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Tissue Type</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Drainage</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Pain Level (0-10)</label>
 <input
 type="range"
 min="0"
 max="10"
 ...
 className="w-full"
 />
 <div className="text-center text-sm text-titanium-700 font-medium">{patient.wound.pain}/10</div>
 </div>
 </div>
 ...
 className="flex items-center gap-2 px-4 py-2 bg-chrome-600 text-white rounded-lg hover:bg-chrome-700 transition-colors text-sm"
 >
 ...
 {showPhotoUpload && (
 <div className="mt-3 p-4 bg-chrome-50 border border-chrome-200 rounded-lg">
 <div className="text-sm text-chrome-700 mb-2">Photo Upload Placeholder</div>
 <div className="h-32 bg-chrome-100 border-2 border-dashed border-chrome-300 rounded-lg flex items-center justify-center">
 <div className="text-chrome-600 text-center">
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Infection Level</label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Culture Result</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Current Antibiotics</label>
 <input
 type="text"
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <MapPin className="w-5 h-5 text-chrome-500" />
 Offloading Strategy
 </h3>
 
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Method</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Compliance</label>
 <div className="grid grid-cols-2 gap-2">
 ...
 ? level === 'Excellent' || level === 'Good' ? 'text-green-600 bg-green-50' :
 level === 'Fair' ? 'text-amber-600 bg-amber-50' : 'text-red-600 bg-red-100'
 : 'bg-white border-titanium-200 text-titanium-700 hover:bg-titanium-50'
 }`}
 >
 {level}
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Notes</label>
 <textarea
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Current Phase</label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">ABI</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">TcPO₂ (mmHg)</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Next Surveillance</label>
 <input
 type="date"
 ...
 <div key={milestone.date} className="flex items-center gap-4 p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm font-medium text-titanium-700 min-w-24">
 {new Date(milestone.date).toLocaleDateString()}
 </div>
 <div className="flex items-center gap-2">
 <div className="text-sm text-titanium-600">Size:</div>
 <div className="font-medium text-titanium-800">{milestone.size} cm²</div>
 </div>
 <div className="flex items-center gap-2">
 <div className="text-sm text-titanium-600">Tissue:</div>
 <div className="font-medium text-titanium-800">{milestone.tissueType}</div>
 </div>
 <div className="flex-1 text-sm text-titanium-600">{milestone.notes}</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="text-sm text-teal-700 mb-1">Healing Rate</div>
 <div className="text-2xl font-bold text-teal-700">
 {toFixed(calculateHealingRate(), 2)} cm²/week
 </div>
 </div>

 <div className="p-4 bg-chrome-50 border border-chrome-200 rounded-lg text-center">
 <div className="text-sm text-chrome-600 mb-1">Expected Healing</div>
 <div className="text-lg font-bold text-chrome-700">
 {getExpectedHealingDate()}
 </div>
 </div>

 <div className="p-4 bg-chrome-50 border border-titanium-300 rounded-lg text-center">
 <div className="text-sm text-gray-500 mb-1">Goal Timeline</div>
 ...
 <Users className="w-5 h-5 text-arterial-500" />
 ...
 <div key={member.name} className="p-4 border border-titanium-200 rounded-lg">
 <div className="flex items-center justify-between mb-3">
 <div>
 <div className="font-medium text-titanium-800">{member.name}</div>
 ...
 <div>
 <div className="text-sm font-medium text-titanium-700 mb-1">Recommendations:</div>
 <ul className="text-sm text-titanium-600 space-y-1">
 {member.recommendations.map((rec, recIndex) => (
 <li key={recIndex} className="flex items-start gap-2">
 <div className="w-1 h-1 bg-titanium-400 rounded-full mt-2 flex-shrink-0" />
 {rec}
 </li>
 ))}
 </ul>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Calendar className="w-5 h-5 text-chrome-500" />
 Debridement Schedule
 </h3>
 
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Frequency</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Next Date</label>
 <input
 type="date"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Provider</label>
 <input
 type="text"
