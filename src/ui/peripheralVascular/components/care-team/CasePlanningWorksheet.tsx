...
const CasePlanningWorksheet: React.FC = () => {
 ...
 case 'Medical': return 'text-green-600 bg-green-50';
 default: return 'text-titanium-600 bg-titanium-100';
 }
  };
 ...
 <p className="text-titanium-600">Patient: {casePlan.patientId} • {casePlan.lesion.location} TASC {casePlan.lesion.tascGrade}</p>
 </div>
 ...
 className="px-6 py-3 bg-porsche-600 text-white rounded-lg hover:bg-porsche-700 transition-colors flex items-center gap-2"
 >
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">TASC Grade</label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Length (cm)</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Calcification</label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Characteristics</label>
 ...
 />
 <span className="text-sm text-titanium-700">{label}</span>
 </label>
 ))}
 </div>
 </div>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Primary Strategy</label>
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Route className="w-5 h-5 text-chrome-500" />
 Endovascular Approach
 </h3>
 
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Access Approach</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Stent Type</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Atherectomy</label>
 <div className="space-y-2">
 ...
 className="rounded border-titanium-300"
 />
 <span className="text-sm text-titanium-700">Atherectomy planned</span>
 </label>
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Additional Options</label>
 <div className="space-y-2">
 <label className="flex items-center gap-2">
 <input
 type="checkbox"
 ...
 className="rounded border-titanium-300"
 />
 <span className="text-sm text-titanium-700">Balloon angioplasty</span>
 </label>
 <label className="flex items-center gap-2">
 <input
 type="checkbox"
 ...
 className="rounded border-titanium-300"
 />
 <span className="text-sm text-titanium-700">Embolic protection</span>
 </label>
 </div>
 </div>
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Bypass Type</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Conduit</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Configuration</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Inflow Target</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Outflow Target</label>
 <input
 type="text"
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Wrench className="w-5 h-5 text-arterial-500" />
 Hybrid Procedure Planning
 </h3>
 
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Sequence</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Endovascular Component</label>
 <input
 type="text"
 ...
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Surgical Component</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Pre-operative</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Intra-operative</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Post-operative</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Duration</label>
 <select
 ...
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4 flex items-center gap-2">
 <Settings className="w-5 h-5 text-titanium-600" />
 Procedure Details
 </h3>
 
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Anesthesia Type</label>
 <select
 ...
 <div>
 <label className="text-sm font-medium text-titanium-600 mb-2 block">Expected Duration (minutes)</label>
 <input
 type="number"
 ...
 <div>
 <div className="text-sm font-medium text-titanium-600 mb-2">Potential Complications</div>
 <textarea
 ...
 <div>
 <div className="text-sm font-medium text-titanium-600 mb-2">Alternative Strategies</div>
 <textarea
 ...
 {/* Plan Summary */}
 <div className="bg-white rounded-2xl p-6 shadow-chrome-card border border-titanium-200">
 <h3 className="text-lg font-semibold text-titanium-800 mb-4">Case Plan Summary</h3>
 
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Lesion</div>
 <div className="font-semibold text-titanium-800">
 {casePlan.lesion.location} TASC {casePlan.lesion.tascGrade}
 </div>
 <div className="text-xs text-titanium-500">{casePlan.lesion.length}cm length</div>
 </div>

 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Strategy</div>
 <div className="font-semibold text-titanium-800">{casePlan.primaryStrategy}</div>
 {casePlan.primaryStrategy === 'Endovascular' && (
 <div className="text-xs text-titanium-500">{casePlan.endovascular.approach}</div>
 )}
 </div>

 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Duration</div>
 <div className="font-semibold text-titanium-800">{casePlan.expectedDuration} min</div>
 <div className="text-xs text-titanium-500">{casePlan.anesthesia}</div>
 </div>

 <div className="p-3 bg-titanium-50 rounded-lg">
 <div className="text-sm text-titanium-600">Status</div>
 <div className="font-semibold text-titanium-800 capitalize">{casePlan.status}</div>
 <div className="text-xs text-titanium-500">Ready for review</div>
 </div>
 </div>

 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-titanium-600">Plan Completion</div>
 <div className="text-titanium-800">All sections completed</div>
 </div>
