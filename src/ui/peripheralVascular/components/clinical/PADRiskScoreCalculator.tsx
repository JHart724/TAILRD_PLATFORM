...
const PADRiskScoreCalculator: React.FC<{ patientData?: PatientContext }> = ({ patientData }) => {
 ...
 else if (inputs.ankleIndex >= 1.0) { abiCat = 'Normal'; abiSev = 'Normal'; abiInterp = 'Normal arterial perfusion. No hemodynamically significant PAD.'; abiColor = 'text-[#2D6147] bg-[#F0F7F4] border-[#D8EDE6]'; }
 else if (inputs.ankleIndex >= 0.9) { abiCat = 'Borderline'; abiSev = 'Borderline'; abiInterp = 'Borderline result. Consider exercise ABI for unmasking.'; abiColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else if (inputs.ankleIndex >= 0.7) { abiCat = 'Mild PAD'; abiSev = 'Mild'; abiInterp = 'Mild PAD. Symptom-directed management with risk factor optimization.'; abiColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 ...
 else if (inputs.claudication && inputs.walkingDistance < 200) { fStage = 'IIb'; fDesc = 'Moderate-severe claudication (< 200m)'; fMgmt = 'Supervised exercise therapy, cilostazol, consider revascularization'; fColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else if (inputs.claudication) { fStage = 'IIa'; fDesc = 'Mild claudication (> 200m)'; fMgmt = 'Risk factor modification, supervised exercise, medical therapy'; fColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else { fStage = 'I'; fDesc = 'Asymptomatic PAD'; fMgmt = 'Risk factor optimization, annual ABI monitoring, exercise'; fColor = 'text-[#2D6147] bg-[#F0F7F4] border-[#D8EDE6]'; }
 ...
 else if (inputs.claudication && inputs.walkingDistance < 100) { rCat = 3; rGrade = 1; rDesc = 'Severe claudication'; rMgmt = 'Supervised exercise + revascularization consideration'; rColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else if (inputs.claudication && inputs.walkingDistance < 200) { rCat = 2; rGrade = 1; rDesc = 'Moderate claudication'; rMgmt = 'Supervised exercise therapy, medical optimization'; rColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else if (inputs.claudication) { rCat = 1; rGrade = 1; rDesc = 'Mild claudication'; rMgmt = 'Exercise therapy, risk factor management'; rColor = 'text-[#8B6914] bg-[#FAF6E8] border-[#F4ECC0]'; }
 else { rCat = 0; rGrade = 0; rDesc = 'Asymptomatic'; rMgmt = 'Risk factor modification, monitoring'; rColor = 'text-[#2D6147] bg-[#F0F7F4] border-[#D8EDE6]'; }
 ...
 <p className="text-sm text-[#636D80]">
