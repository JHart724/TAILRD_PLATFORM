...
const PADRiskScoreCalculator: React.FC<{ patientData?: PatientContext }> = ({ patientData }) => {
 ...
 else if (inputs.ankleIndex >= 1.0) { abiCat = 'Normal'; abiSev = 'Normal'; abiInterp = 'Normal arterial perfusion. No hemodynamically significant PAD.'; abiColor = 'text-green-600 bg-green-50 border-green-100'; }
 else if (inputs.ankleIndex >= 0.9) { abiCat = 'Borderline'; abiSev = 'Borderline'; abiInterp = 'Borderline result. Consider exercise ABI for unmasking.'; abiColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else if (inputs.ankleIndex >= 0.7) { abiCat = 'Mild PAD'; abiSev = 'Mild'; abiInterp = 'Mild PAD. Symptom-directed management with risk factor optimization.'; abiColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 ...
 else if (inputs.claudication && inputs.walkingDistance < 200) { fStage = 'IIb'; fDesc = 'Moderate-severe claudication (< 200m)'; fMgmt = 'Supervised exercise therapy, cilostazol, consider revascularization'; fColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else if (inputs.claudication) { fStage = 'IIa'; fDesc = 'Mild claudication (> 200m)'; fMgmt = 'Risk factor modification, supervised exercise, medical therapy'; fColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else { fStage = 'I'; fDesc = 'Asymptomatic PAD'; fMgmt = 'Risk factor optimization, annual ABI monitoring, exercise'; fColor = 'text-green-600 bg-green-50 border-green-100'; }
 ...
 else if (inputs.claudication && inputs.walkingDistance < 100) { rCat = 3; rGrade = 1; rDesc = 'Severe claudication'; rMgmt = 'Supervised exercise + revascularization consideration'; rColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else if (inputs.claudication && inputs.walkingDistance < 200) { rCat = 2; rGrade = 1; rDesc = 'Moderate claudication'; rMgmt = 'Supervised exercise therapy, medical optimization'; rColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else if (inputs.claudication) { rCat = 1; rGrade = 1; rDesc = 'Mild claudication'; rMgmt = 'Exercise therapy, risk factor management'; rColor = 'text-amber-600 bg-amber-50 border-amber-100'; }
 else { rCat = 0; rGrade = 0; rDesc = 'Asymptomatic'; rMgmt = 'Risk factor modification, monitoring'; rColor = 'text-green-600 bg-green-50 border-green-100'; }
