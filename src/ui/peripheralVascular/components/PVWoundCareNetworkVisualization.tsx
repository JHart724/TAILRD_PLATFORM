...
const PVWoundCareNetworkVisualization: React.FC = () => {
 ...
 <span className="font-bold text-green-600">{toFixed(metrics.limbSalvageRate * 100, 1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 ...
 <span className="font-bold text-green-600">{toFixed(metrics.amputationPreventionRate * 100, 1)}%</span>
 </div>
 <div className="flex justify-between items-center">
