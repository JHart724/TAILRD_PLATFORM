...
const PVWoundCareNetworkVisualization: React.FC = () => {
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.overallHealingRate * 100).toFixed(1)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.limbSalvageRate * 100).toFixed(1)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.amputationPreventionRate * 100).toFixed(1)}%</div>
 ...
 <span className="font-bold text-chrome-600">{(metrics.careCoordinationScore * 100).toFixed(0)}%</span>
 </div>
 <div className="flex justify-between items-center">
