...
const WIfIClassification: React.FC = () => {
 ...
 className="w-full px-3 py-2 border border-titanium-300 rounded-lg focus:ring-2 focus:ring-medical-teal-500 focus:border-medical-teal-500"
 >
 ...
 <div className="grid grid-cols-3 gap-4 p-4 bg-titanium-50 rounded-lg">
 <div className="text-center">
 <div className="text-sm text-titanium-600 mb-1">Wound Score</div>
 <div className="text-3xl font-bold text-titanium-900">{result.woundScore}</div>
 </div>
 <div className="text-center">
 <div className="text-sm text-titanium-600 mb-1">Ischemia Score</div>
 <div className="text-3xl font-bold text-titanium-900">{result.ischemiaScore}</div>
 </div>
 <div className="text-center">
 <div className="text-sm text-titanium-600 mb-1">Infection Score</div>
 <div className="text-3xl font-bold text-titanium-900">{result.footInfectionScore}</div>
 </div>
 </div>
 </div>
 ...
 <div className="flex items-start gap-2">
 <Target className="w-5 h-5 text-porsche-600 mt-0.5 flex-shrink-0" />
 ...
 <div className="w-1 h-1 bg-porsche-600 rounded-full mt-2 flex-shrink-0"></div>
 {rec}
 </li>
 ))}
 </ul>
