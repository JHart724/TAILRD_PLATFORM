...
import { Activity, FileText, Network, Target, Users, Calculator, Shield, BarChart3, Award, Grid3X3, MapPin, Heart, ChevronDown, ChevronUp, AlertTriangle, Zap, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Avg Limb Salvage Rate</p><p className="text-3xl font-bold text-teal-700">88.6%</p><p className="text-xs text-titanium-500 mt-1">CLI patients at 12 months</p></div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {providers.map((p, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-600">{p.limbSalvage}</span></td>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-arterial-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Total Interventions</p><p className="text-3xl font-bold text-titanium-900">1,456</p><p className="text-xs text-teal-700 mt-1">+11.2% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Technical Success</p><p className="text-3xl font-bold text-teal-700">96.8%</p><p className="text-xs text-titanium-500 mt-1">Across all interventions</p></div>
        <div className="metal-card p-5 border-l-4 border-l-blue-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">DCB Use (Fem-Pop)</p><p className="text-3xl font-bold text-blue-700">78.4%</p><p className="text-xs text-teal-700 mt-1">+9.3% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">CLI Limb Salvage</p><p className="text-3xl font-bold text-gray-500">86.4%</p><p className="text-xs text-teal-700 mt-1">+2.1% vs last quarter</p></div>
      </div>
      <div className="metal-card bg-white rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-titanium-100 flex items-center gap-2">
            ...
            <tbody className="divide-y divide-titanium-100">
              {procedures.map((p, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-600">{p.technical}</span></td>
                  <td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">{p.patency1yr}</span></td>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">WIfI High-Risk</p><p className="text-3xl font-bold text-gray-500">123</p><p className="text-xs text-titanium-500 mt-1">WIfI Stage 3-4 (major amp. risk)</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Limb Salvage Rate</p><p className="text-3xl font-bold text-teal-700">86.4%</p><p className="text-xs text-titanium-500 mt-1">12-month amputation-free survival</p></div>
          ...
          <tbody className="divide-y divide-titanium-100">
            {stages.map((s, i) => (
              <tr key={i} className="hover:bg-titanium-50">
                ...
                <td className="px-4 py-3"><span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${s.urgency === 'red' ? 'bg-red-100 text-red-800' : s.urgency === 'amber' ? 'bg-amber-50 text-amber-600' : 'bg-green-50 text-green-600'}`}>{s.urgency === 'red' ? 'Urgent' : s.urgency === 'amber' ? 'Active' : 'Monitoring'}</span></td>
              </tr>
            ))}
          </tbody>
        </table>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Moderate Alerts</p><p className="text-3xl font-bold text-gray-500">246</p><p className="text-xs text-titanium-500 mt-1">Requiring protocol review</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Screened This Month</p><p className="text-3xl font-bold text-teal-700">487</p><p className="text-xs text-titanium-500 mt-1">Pre-procedural safety checks</p></div>
      </div>
      <div className="metal-card bg-white rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-titanium-100 flex items-center gap-2">
          ...
          <tbody className="divide-y divide-titanium-100">
            {alerts.map((a, i) => (
              <tr key={i} className="hover:bg-titanium-50">
                ...
                <td className="px-4 py-3"><span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${a.severity === 'red' ? 'bg-red-100 text-red-800' : 'bg-amber-50 text-amber-600'}`}>{a.severity === 'red' ? 'High' : 'Moderate'}</span></td>
              </tr>
            ))}
          </tbody>
        </table>
...
const PADQualityMetrics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Above Benchmark</p><p className="text-3xl font-bold text-teal-700">4 / 8</p><p className="text-xs text-titanium-500 mt-1">SVS-VQI quality measures</p></div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {measures.map((m, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${m.above ? 'bg-green-50 text-green-600' : 'bg-red-100 text-red-800'}`}>{m.above ? 'Above Benchmark' : 'Below Benchmark'}</span></td>
      ...
      {gap?.subcategories && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          {gap.subcategories.map((sub, i) => (
            <div key={i} className={`rounded-lg px-4 py-3 border ${i === 0 ? 'bg-red-50 border-red-200' : 'bg-chrome-50 border-titanium-300'}`}>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">ABI Screening Needed</p>
          <p className="text-3xl font-bold text-gray-500">{abiCount}</p>
          <p className="text-xs text-titanium-500 mt-1">PAD patients without documented ABI</p>
        </div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">AAA Screening Needed</p>
          <p className="text-3xl font-bold text-gray-500">{aaaCount}</p>
          <p className="text-xs text-titanium-500 mt-1">Eligible men 65-75 without AAA US</p>
        </div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Post-EVAR Surveillance Overdue</p>
          <p className="text-3xl font-bold text-gray-500">{postEvarCount}</p>
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Unprovoked VTE Extended Anticoag</p>
          <p className="text-3xl font-bold text-gray-500">{vteCount}</p>
      ...
      {/*
        ...
        "20 months to clear pipeline", "7 months with TAILRD protocol", and "Revenue Acceleration
        $3.6M in 12 months" behind a "Forward-looking" chip. The first two are a PRODUCT EFFICACY claim -
