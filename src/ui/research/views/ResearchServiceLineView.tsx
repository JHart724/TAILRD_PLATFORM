...
const curatedTrials: CuratedTrial[] = [
  ...
  { id: 'T11', name: 'ATTR-AS Registry -- Co-existing Amyloidosis and AS', nct: 'Investigator-initiated', phase: 'Registry', status: 'Enrolling', sponsor: 'Mount Sinai Fuster Heart Hospital', sponsorType: 'investigator', eligiblePatients: 18, gapRef: 'Gap 42', gapName: 'ATTR-CM + AS Co-Detection', inclusion: ['Severe AS confirmed', 'Age >=75', 'LV wall >=14mm'], exclusion: ['Prior ATTR-CM diagnosis', 'Prior TAVR'] },
  ...
  { id: 'T13', name: 'GUIDE-IT 2 -- NT-proBNP Guided Therapy', nct: 'Investigator-initiated', phase: '3', status: 'Screening', sponsor: 'NHLBI / Mount Sinai', sponsorType: 'nih', eligiblePatients: 234, gapRef: 'Gap 74', gapName: 'NT-proBNP Not Monitored', inclusion: ['HF NYHA II-III', 'NT-proBNP >500', 'On GDMT'], exclusion: ['Recent hospitalization <2 weeks', 'CKD stage 5'] },
        ...
        {([
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-all ${
              activeTab === tab.id
                ? 'bg-[#2E3440] text-white shadow-sm'
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-5 bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <div className="max-h-[580px] overflow-y-auto px-4 py-3 space-y-4">
                {sections.map((sec) => (
                  <div key={sec.title}>
                    <h4 className="text-xs font-bold text-[#2E3440] uppercase tracking-wider mb-2 flex items-center gap-1.5">
                      <div className="w-1 h-3.5 bg-[#2E3440] rounded-full" />
                      {sec.title}
                    </h4>
            ...
            <div className="col-span-4 space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <button className="w-full py-2 bg-[#2E3440] text-white text-sm font-semibold rounded-lg hover:bg-[#3B4252] transition-colors flex items-center justify-center gap-2">
                  <CheckCircle className="w-4 h-4" />
                  Approve & Submit
                </button>
              ...
              {!selectedTrialData ? (
                ...
                <div className="overflow-y-auto max-h-[600px]">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="bg-[#2E3440]/5 border border-[#2E3440]/10 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-xs text-slate-500">Eligible patients in your population</span>
                          <div className="text-2xl font-bold text-[#2E3440]">{selectedTrialData.eligiblePatients}</div>
                        </div>
                        <Users className="w-8 h-8 text-[#2E3440]/30" />
                      </div>
