...
const StructuralInterventionPathwayFunnel: React.FC = () => {
 ...
 <div className="text-sm text-green-700 font-medium">Avg STS Score</div>
 <div className="text-2xl font-bold text-green-800">
 {getFilteredPatients().length ? 
 (getFilteredPatients().reduce((sum, p) => sum + p.stsScore, 0) / getFilteredPatients().length).toFixed(1) : '0.0'
 }
 </div>
 </div>
 </div>
