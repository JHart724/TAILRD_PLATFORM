...
const SHProviderScorecard: React.FC = () => {
 ...
 selectedProviderData.caseComplexity === 'medium' ? 'text-crimson-600' :
 'text-teal-700'
 }`}>
 ...
 panelProviderData.valveTherapyRate >= 70 ? 'text-teal-700' : 'text-gray-500'
 ...
 patient.fourPillarRate === 4 ? 'bg-green-50 text-green-600' :
 patient.fourPillarRate >= 2 ? 'bg-amber-50 text-amber-600' : 'bg-red-100 text-red-700'
 }`}>
