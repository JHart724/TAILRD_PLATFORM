...
interface ProviderData {
  ...
  title: string;
  patients: number;
  valveTherapyOptimal: number;
  valveTherapyRate: number;
  readmissionRate: number;
  diseaseStageImprovement: number;
  qualityScore: number;
...
const SHProviderScorecard: React.FC = () => {
 ...
 patients: 374,
 valveTherapyOptimal: 284,
 valveTherapyRate: 75.9,
 readmissionRate: 8.2,
 diseaseStageImprovement: 12.4,
 qualityScore: 94.2,
 trend: 'up',
 trendValue: 5.2,
 ...
 title: 'Valve Disease Specialist',
 patients: 468,
 valveTherapyOptimal: 334,
 valveTherapyRate: 71.4,
 readmissionRate: 9.1,
 diseaseStageImprovement: 14.7,
 qualityScore: 91.8,
 trend: 'up',
 trendValue: 3.1,
 specialtyFocus: ['Advanced Valve Disease', 'LVAD'],
 caseComplexity: 'high',
 },
 {
 id: 'DR003',
 ...
 patients: 312,
 valveTherapyOptimal: 196,
 valveTherapyRate: 62.8,
 readmissionRate: 11.7,
 diseaseStageImprovement: 8.9,
 qualityScore: 82.4,
 trend: 'down',
 trendValue: -2.8,
 ...
 patients: 196,
 valveTherapyOptimal: 142,
 valveTherapyRate: 72.4,
 readmissionRate: 7.8,
 diseaseStageImprovement: 11.2,
 qualityScore: 88.9,
 trend: 'up',
 trendValue: 4.7,
 specialtyFocus: ['Device Therapy', 'Rhythm Management'],
 caseComplexity: 'high',
 },
 {
 id: 'DR005',
 ...
 title: 'Valve Disease Specialist',
 patients: 406,
 valveTherapyOptimal: 308,
 valveTherapyRate: 75.9,
 readmissionRate: 8.9,
 diseaseStageImprovement: 13.1,
 qualityScore: 92.7,
 trend: 'stable',
 trendValue: 0.2,
 specialtyFocus: ['Transplant', 'Advanced Valve Disease'],
 caseComplexity: 'high',
 },
  ];
 ...
 'DR001': [
 { id: 'P001', name: 'Johnson, Mary', age: 67, diseaseStage: 25, fourPillarRate: 4, riskScore: 85, lastVisit: new Date('2024-10-20'), diagnoses: ['Aortic', 'Diabetes', 'CKD'], nextSteps: ['Continue current therapy', 'Monitor labs'] },
 { id: 'P002', name: 'Smith, Robert', age: 72, diseaseStage: 30, fourPillarRate: 3, riskScore: 78, lastVisit: new Date('2024-10-18'), diagnoses: ['Aortic', 'AFib'], nextSteps: ['Add SGLT2 inhibitor', 'Cardiology follow-up'] },
 { id: 'P003', name: 'Davis, Patricia', age: 59, diseaseStage: 35, fourPillarRate: 2, riskScore: 65, lastVisit: new Date('2024-10-22'), diagnoses: ['Aortic', 'HTN'], nextSteps: ['Optimize MRA dosing', 'Add beta-blocker'] }
 ],
 'DR002': [
 { id: 'P004', name: 'Wilson, James', age: 70, diseaseStage: 28, fourPillarRate: 4, riskScore: 82, lastVisit: new Date('2024-10-19'), diagnoses: ['Aortic', 'CAD', 'Diabetes'], nextSteps: ['Continue optimal therapy', 'Device evaluation'] },
 { id: 'P005', name: 'Brown, Linda', age: 65, diseaseStage: 32, fourPillarRate: 3, riskScore: 75, lastVisit: new Date('2024-10-21'), diagnoses: ['Aortic', 'COPD'], nextSteps: ['Add fourth pillar', 'Pulmonary consultation'] },
 { id: 'P006', name: 'Miller, David', age: 68, diseaseStage: 26, fourPillarRate: 4, riskScore: 88, lastVisit: new Date('2024-10-23'), diagnoses: ['Aortic', 'CKD', 'AFib'], nextSteps: ['ICD evaluation', 'Continue therapy'] }
 ],
 'DR003': [
 { id: 'P007', name: 'Garcia, Maria', age: 63, diseaseStage: 40, fourPillarRate: 2, riskScore: 58, lastVisit: new Date('2024-10-17'), diagnoses: ['Mitral', 'Diabetes'], nextSteps: ['Optimize Valve Therapy', 'Diabetes management'] },
 { id: 'P008', name: 'Taylor, John', age: 71, diseaseStage: 38, fourPillarRate: 1, riskScore: 72, lastVisit: new Date('2024-10-16'), diagnoses: ['Aortic', 'HTN'], nextSteps: ['Initiate Valve Therapy therapy', 'Cardiology referral'] }
 ],
 'DR004': [
 { id: 'P009', name: 'Anderson, Susan', age: 66, diseaseStage: 29, fourPillarRate: 3, riskScore: 79, lastVisit: new Date('2024-10-24'), diagnoses: ['Aortic', 'AFib'], nextSteps: ['Device therapy assessment', 'Rhythm management'] },
 { id: 'P010', name: 'Thomas, Michael', age: 69, diseaseStage: 33, fourPillarRate: 4, riskScore: 76, lastVisit: new Date('2024-10-22'), diagnoses: ['Aortic', 'VT'], nextSteps: ['ICD follow-up', 'Continue therapy'] }
 ],
 'DR005': [
 { id: 'P011', name: 'Martinez, Carlos', age: 58, diseaseStage: 22, fourPillarRate: 4, riskScore: 92, lastVisit: new Date('2024-10-25'), diagnoses: ['Aortic', 'LVAD candidate'], nextSteps: ['LVAD evaluation', 'Transplant assessment'] },
 { id: 'P012', name: 'Lee, Jennifer', age: 64, diseaseStage: 27, fourPillarRate: 4, riskScore: 86, lastVisit: new Date('2024-10-20'), diagnoses: ['Aortic', 'CKD'], nextSteps: ['Continue therapy', 'Monitor renal function'] }
 ]
  };
 ...
 Valve Therapy adoption and quality metrics by physician • Click provider cards for patient details
 </p>
 </div>
 ...
 <option value="valveTherapyRate">Valve Therapy Rate</option>
 ...
 ? 'border-porsche-400 shadow-chrome-elevated bg-porsche-50/30'
 ...
 <User className="w-5 h-5 text-porsche-600" />
 </div>
 <div>
 <div className="font-semibold text-titanium-900">{provider.name}</div>
 <div className="text-sm text-titanium-600">{provider.title}</div>
 </div>
 </div>
 <div className="flex items-center gap-2">
 ...
 <div className="text-2xl font-bold text-titanium-900">{provider.patients}</div>
 <div className="text-xs text-titanium-600">Patients</div>
 </div>
 <div className={`text-center p-2 rounded-lg ${getPerformanceColor(provider.valveTherapyRate, 'rate')}`}>
 <div className="text-2xl font-bold">{toFixed(provider.valveTherapyRate, 1)}%</div>
 <div className="text-xs">Valve Therapy Rate</div>
 </div>
 <div className={`text-center p-2 rounded-lg ${getPerformanceColor(provider.readmissionRate, 'readmission')}`}>
 <div className="text-2xl font-bold">{toFixed(provider.readmissionRate, 1)}%</div>
 ...
 <div className="text-2xl font-bold">{toFixed(provider.qualityScore, 0)}</div>
 ...
 {provider.specialtyFocus.map((specialty) => (
 <span
 key={specialty}
 className="px-2 py-1 text-xs bg-titanium-100 text-titanium-700 rounded-full"
 >
 {specialty}
 </span>
 ))}
 ...
 className="w-full flex items-center justify-center gap-2 py-2 px-3 bg-porsche-500 text-white rounded-lg hover:bg-porsche-600 transition-colors text-sm font-medium"
 >
 ...
 <div>
 <h3 className="text-xl font-bold text-titanium-900 font-sf">
 {selectedProviderData.name}
 </h3>
 <p className="text-titanium-600">{selectedProviderData.title}</p>
 </div>
 <div className="flex items-center gap-2">
 ...
 <div className="text-3xl font-bold text-titanium-900">{selectedProviderData.patients}</div>
 <div className="text-sm text-titanium-600 mt-1">
 {selectedProviderData.valveTherapyOptimal} on optimal Valve Therapy
 </div>
 </div>

 <div className="p-4 bg-white rounded-lg">
 <div className="text-sm text-titanium-600 mb-1">Valve Therapy Adoption</div>
 <div className="text-3xl font-bold text-porsche-600">
 {toFixed(selectedProviderData.valveTherapyRate, 1)}%
 </div>
 <div className="text-sm text-titanium-600 mt-1">
 vs {toFixed(sortedProviders.reduce((sum, p) => sum + p.valveTherapyRate, 0) / sortedProviders.length, 1)}% avg
 </div>
 </div>

 <div className="p-4 bg-white rounded-lg">
 <div className="text-sm text-titanium-600 mb-1">Disease Stage Improvement</div>
 <div className="text-3xl font-bold text-medical-green-600">
 +{toFixed(selectedProviderData.diseaseStageImprovement, 1)}%
 </div>
 <div className="text-sm text-titanium-600 mt-1">
 Average increase
 </div>
 ...
 {toFixed(sortedProviders[0].qualityScore, 1)} Quality Score
 </div>
 </div>

 <div>
 <div className="text-sm text-titanium-600 mb-1">Average Valve Therapy Rate</div>
 <div className="text-lg font-bold text-titanium-900">
 {toFixed(sortedProviders.reduce((sum, p) => sum + p.valveTherapyRate, 0) / sortedProviders.length, 1)}%
 </div>
 <div className="text-sm text-titanium-600">
 ...
 <div>
 <h3 className="text-2xl font-bold text-titanium-900">{panelProviderData.name}</h3>
 ...
 panelProviderData.valveTherapyRate >= 70 ? 'text-green-700' : 'text-amber-700'
 }`}>Valve Therapy Rate</div>
 <div className={`text-2xl font-bold ${
 panelProviderData.valveTherapyRate >= 70 ? 'text-green-800' : 'text-amber-800'
 }`}>{toFixed(panelProviderData.valveTherapyRate, 1)}%</div>
 </div>
 <div className="bg-gradient-to-br from-arterial-50 to-arterial-100 p-4 rounded-xl">
 <div className="text-sm text-arterial-700 font-medium">Quality Score</div>
 ...
 <div className="text-sm text-titanium-600">
 Age {patient.age} • Valve Stage {patient.diseaseStage}% • Risk Score: {patient.riskScore}
 </div>
 </div>
 </div>
 ...
 patient.fourPillarRate === 4 ? 'bg-green-100 text-green-700' :
 patient.fourPillarRate >= 2 ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-700'
 }`}>
 ...
 <div>
 <div className="text-sm font-medium text-titanium-700 mb-2">Diagnoses</div>
 <div className="flex flex-wrap gap-1">
 {patient.diagnoses.slice(0, 2).map((diagnosis) => (
 <span key={diagnosis} className="px-2 py-1 bg-porsche-100 text-porsche-700 text-xs rounded-full">
 {diagnosis}
 </span>
 ))}
 {patient.diagnoses.length > 2 && (
 <span className="px-2 py-1 bg-titanium-100 text-titanium-600 text-xs rounded-full">
...
export default SHProviderScorecard;