...
const SHProviderScorecard: React.FC = () => {
 ...
 <div className="text-2xl font-bold">{provider.valveTherapyRate.toFixed(1)}%</div>
 ...
 {selectedProviderData.valveTherapyRate.toFixed(1)}%
 </div>
 <div className="text-sm text-titanium-600 mt-1">
 vs {(sortedProviders.reduce((sum, p) => sum + p.valveTherapyRate, 0) / sortedProviders.length).toFixed(1)}% avg
 </div>
 </div>
 ...
 +{selectedProviderData.diseaseStageImprovement.toFixed(1)}%
 </div>
 <div className="text-sm text-titanium-600 mt-1">
 Average increase
 </div>
 ...
 {(sortedProviders.reduce((sum, p) => sum + p.valveTherapyRate, 0) / sortedProviders.length).toFixed(1)}%
 </div>
 <div className="text-sm text-titanium-600">
 ...
 }`}>{panelProviderData.valveTherapyRate.toFixed(1)}%</div>
 </div>
 ...
 <span key={idx} className="px-2 py-1 bg-porsche-100 text-porsche-700 text-xs rounded-full">
 {diagnosis}
 </span>
 ))}
