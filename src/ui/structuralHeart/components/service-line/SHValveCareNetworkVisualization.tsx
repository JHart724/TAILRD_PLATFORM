...
const SHValveCareNetworkVisualization: React.FC = () => {
 ...
 case 'valve-therapy-pathway': return '#dc2626';
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.valveTherapyOptimizationRate * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.readmissionRateReduction * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.careCoordinationScore * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.remoteMonitoringAdherence * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.avgResponseTime.toFixed(1)}h</div>
 ...
 style={{ fontSize: '8px' }}
 >
 {node.valveTherapyOptimizationRate ? `${(node.valveTherapyOptimizationRate * 100).toFixed(0)}%` : `${node.responseTime}h`}
 </text>
 )}
 </g>
 );
 ...
 {(selectedNode.valveTherapyOptimizationRate * 100).toFixed(0)}%
 </div>
 ...
 return (
 <div key={index} className="text-xs bg-titanium-50 p-2 rounded flex justify-between">
 ...
 {(metrics.valveTherapyOptimizationRate * 100).toFixed(1)}%
 </span>
 </div>
 <div className="flex justify-between items-center">
 ...
 <span className="font-bold text-chrome-600">{(metrics.careCoordinationScore * 100).toFixed(1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Avg Response Time</span>
 <span className="font-bold text-amber-600">{metrics.avgResponseTime.toFixed(1)} hrs</span>
 </div>
 <div className="flex justify-between items-center">
