...
const SHPatientWorklist: React.FC = () => {
 ...
 actionItems: [
 { category: 'Valve Therapy', description: 'Start TAVR Referral', dueDate: '2024-01-20', urgent: true },
 { category: 'Procedure', description: 'MitraClip evaluation', dueDate: '2024-01-25', urgent: false }
 ]
 },
 {
 id: 'P002',
 ...
 valveStage: 'II',
 riskScore: 6.2,
 therapyGaps: ['Anticoagulation optimization'],
 procedureEligible: true,
 phenotype: 'Severe AS',
 ...
 actionItems: [
 { category: 'Valve Therapy', description: 'Optimize Anticoagulation dose', dueDate: '2024-01-22', urgent: false }
 ]
 },
 {
 id: 'P003',
 ...
 if (filterValveTherapy && p.therapyGaps.length === 0) return false;
 if (filterProcedure && !p.procedureEligible) return false;
 return true;
  });
 ...
 className="rounded"
 />
 <span className="text-sm text-titanium-800">Procedure Eligible Only</span>
 </label>
 </div>
 </div>
 ...
 <div className="text-sm text-titanium-600">MRN: {patient.mrn} • Age {patient.age} • Disease Stage {patient.diseaseStage}%</div>
 </div>
 </div>
 ...
 <div>
 <div className="text-xs text-titanium-600 mb-1">Valve Stage</div>
 <div className="font-medium text-titanium-800">{patient.valveStage}</div>
 </div>
 <div>
 <div className="text-xs text-titanium-600 mb-1">Valve Therapy Gaps</div>
 <div className="font-medium text-amber-800">{patient.therapyGaps.length} medications</div>
 </div>
 <div>
 ...
 <div className="mb-3">
 <div className="text-xs text-titanium-600 mb-1">Procedure Eligibility</div>
...
export default SHPatientWorklist;