...
const SHRealTimeHospitalAlerts: React.FC = () => {
 ...
 alert.currentValveTherapy.medicalManagement ? 'bg-[#C8D4DC]' : 'bg-red-500'
 }`}></div>
 <span className="text-sm">Medical Management</span>
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-3 h-3 rounded-full ${
 alert.currentValveTherapy.anticoagulation ? 'bg-[#C8D4DC]' : 'bg-red-500'
 }`}></div>
 <span className="text-sm">Anticoagulation</span>
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-3 h-3 rounded-full ${
 alert.currentValveTherapy.diuretics ? 'bg-[#C8D4DC]' : 'bg-red-500'
 }`}></div>
 <span className="text-sm">Diuretics</span>
 </div>
 <div className="flex items-center gap-2">
 <div className={`w-3 h-3 rounded-full ${
 alert.currentValveTherapy.tavrReferral ? 'bg-[#C8D4DC]' : 'bg-red-500'
 }`}></div>
