...
const SHPatientDetailPanel: React.FC<SHPatientDetailPanelProps> = ({ patient, onClose }) => {
 ...
 <div className="text-2xl font-bold text-[#6B7280] mb-2">{patient.therapyGaps.length}</div>
 ...
 patient.fullChart.valveTherapy.overallScore >= 80 ? 'bg-[#C8D4DC]' :
 patient.fullChart.valveTherapy.overallScore >= 60 ? 'bg-[#F0F5FA]' : 'bg-red-500'
 }`}
