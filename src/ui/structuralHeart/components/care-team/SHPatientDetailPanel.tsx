...
const SHPatientDetailPanel: React.FC<SHPatientDetailPanelProps> = ({ patient, onClose }) => {
 ...
 <div className="bg-chrome-50 rounded-lg p-4 text-center">
 <div className="text-2xl font-bold text-gray-500 mb-2">{patient.therapyGaps.length}</div>
 ...
 patient.fullChart.valveTherapy.overallScore >= 80 ? 'bg-titanium-300' :
 patient.fullChart.valveTherapy.overallScore >= 60 ? 'bg-chrome-50' : 'bg-red-500'
 }`}
