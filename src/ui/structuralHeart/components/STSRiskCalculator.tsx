...
const STSRiskCalculator: React.FC<{ patientData?: PatientContext }> = ({ patientData: ctx }) => {
 ...
 lastCreatinine: ctx?.creatinine ?? 1.1,
 ...
 cvd: false,
 chf: ctx?.chf ?? false,
 nyhaClass: ctx?.nyhaClass ?? 2,
 cardiogenicShock: false,
 resuscitation: false,
 rhythmDisorder: ctx?.atrialFibrillation ?? false,
 ef: ctx?.lvef ?? 55,
 ...
 <div>
 <h2 className="text-2xl font-bold text-titanium-900 font-sf">STS Risk Calculator</h2>
 <p className="text-titanium-600">Society of Thoracic Surgeons Predicted Risk of Mortality</p>
 </div>
 </div>
 ...
 className="w-full px-3 py-2 border border-titanium-300 rounded-lg focus:ring-2 focus:ring-medical-red-500 focus:border-medical-red-500"
 min="18"
 max="120"
 />
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Ejection Fraction (%)</label>
 <input
 type="number"
 value={inputs.ef}
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Procedure Type</label>
 <select
 ...
 />
 <span className="text-sm font-medium text-titanium-700">Diabetes</span>
 </label>
 ...
 className="rounded text-medical-red-600"
 />
 <span className="text-sm font-medium text-titanium-700">Hypertension</span>
 </label>
 ...
 className="rounded text-medical-red-600"
 />
 <span className="text-sm font-medium text-titanium-700">Valve Disease</span>
 </label>
 ...
 className="rounded text-medical-red-600"
 />
 <span className="text-sm font-medium text-titanium-700">Peripheral Vascular Disease</span>
 </label>
 ...
 className="rounded text-medical-red-600"
 />
 <span className="text-sm font-medium text-titanium-700">Cardiogenic Shock</span>
 </label>
 ...
 className="rounded text-medical-red-600"
 />
 <span className="text-sm font-medium text-titanium-700">Resuscitation</span>
 </label>
 </div>
 </div>
 ...
 <div className="flex items-start gap-2">
 <Shield className="w-5 h-5 text-arterial-600 mt-0.5 flex-shrink-0" />
 <div className="text-sm text-arterial-800">
