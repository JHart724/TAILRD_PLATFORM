...
interface SHRevenueWaterfallModalProps {
  category: 'Valve Therapy' | 'Procedures' | 'Phenotypes' | '340B';
  totalRevenue: number;
  patientCount: number;
  onClose: () => void;
}
...
const getSubcategoryData = (category: string): SubcategoryData[] => {
 ...
 Procedures: [
 { name: 'Transcatheter Valve Devices', revenue: 15000000, patientCount: 320, color: '#8B5CF6' },
 { name: 'Imaging & Navigation', revenue: 3200000, patientCount: 280, color: '#7C3AED' },
 { name: 'Closure Devices', revenue: 1800000, patientCount: 95, color: '#6D28D9' }
 ],
 Phenotypes: [
...
const getCategoryTitle = (category: string): string => {
 ...
 'Valve Therapy': 'Valve Therapy Interventions',
 'Procedures': 'Device & Technology Revenue',
...
const getCategoryDescription = (category: string): string => {
 ...
 'Valve Therapy': 'Revenue from transcatheter valve interventions including TAVR, MitraClip, and TMVR',
 'Procedures': 'Revenue from structural heart devices, imaging technology, and procedural equipment',
 Phenotypes: 'Revenue from identifying and treating specific structural heart disease phenotypes',
 '340B': 'Cost savings from 340B drug pricing program for eligible medications'
  };
  return descriptions[category] || '';
};

const SHRevenueWaterfallModal: React.FC<SHRevenueWaterfallModalProps> = ({
  category,
  totalRevenue,
  patientCount,
  onClose
...
export default SHRevenueWaterfallModal;