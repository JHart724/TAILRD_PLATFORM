...
const StructuralReferralNetworkVisualization: React.FC = () => {
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.referralConversionRate * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.overallSuccessRate * 100).toFixed(0)}%</div>
 ...
 <span className="font-bold text-amber-600">{(metrics.heartTeamUtilization * 100).toFixed(1)}%</span>
 </div>
 <div className="flex justify-between items-center">
