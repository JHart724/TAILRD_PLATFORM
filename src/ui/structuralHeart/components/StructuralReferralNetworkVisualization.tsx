...
const StructuralReferralNetworkVisualization: React.FC = () => {
 ...
 <div>
 <h3 className="text-2xl font-bold text-titanium-900">Structural Heart Referral Network</h3>
 <p className="text-titanium-600">Comprehensive referral pathways and Heart Team coordination</p>
 ...
 <UserPlus className={`w-6 h-6 ${metrics.referralConversionRate >= 0.75 ? 'text-teal-700' : 'text-red-600'}`} />
 <div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.avgTimeToEvaluation}d</div>
 <div className="text-xs text-titanium-600">Time to Eval</div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white p-4 rounded-xl border border-titanium-200">
 <div className="flex items-center gap-3">
 <Calendar className="w-6 h-6 text-arterial-600" />
 <div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.totalPatients.toLocaleString()}</div>
 ...
 width="600"
 height="450"
 className="border border-titanium-100 rounded-lg bg-gradient-to-br from-red-50 to-white"
 >
 {/* Render connections */}
 ...
 style={{ fontSize: '8px' }}
 >
 {node.patientVolume ? node.patientVolume : `${toFixed(node.referralConversionRate! * 100, 0)}%`}
 </text>
 )}
 </g>
 );
 ...
 <div className="space-y-2">
 <div className="flex items-center gap-2">
 <div className="w-4 h-1 bg-chrome-50"></div>
 ...
 <div className={`p-3 rounded-lg ${selectedNode.referralConversionRate >= 0.8 ? 'bg-titanium-300' : 'bg-chrome-50'}`}>
 <div className={`text-lg font-bold ${selectedNode.referralConversionRate >= 0.8 ? 'text-teal-700' : 'text-gray-500'}`}>
 {toFixed(selectedNode.referralConversionRate * 100, 0)}%
 </div>
 <div className={`text-xs ${selectedNode.referralConversionRate >= 0.8 ? 'text-teal-700' : 'text-gray-500'}`}>
 Conversion Rate
 </div>
 </div>
 )}
 ...
 <div className="text-lg font-bold text-arterial-600">{selectedNode.timeToIntervention}d</div>
 <div className="text-xs text-arterial-700">Time to Procedure</div>
 </div>
 )}
 ...
 <span className={`font-bold ${metrics.referralConversionRate >= 0.75 ? 'text-teal-700' : 'text-red-600'}`}>
 {toFixed(metrics.referralConversionRate * 100, 1)}%
 </span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Avg Time to Evaluation</span>
 <span className="font-bold text-chrome-600">{metrics.avgTimeToEvaluation} days</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Avg Time to Procedure</span>
 <span className="font-bold text-arterial-600">{metrics.avgTimeToIntervention} days</span>
 </div>
 </div>
 </div>
 ...
 <span className="font-bold text-gray-500">{toFixed(metrics.heartTeamUtilization * 100, 1)}%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Weekly Conferences</span>
 <span className="font-bold text-chrome-600">3</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Cases Reviewed</span>
 <span className="font-bold text-teal-700">{nodes.find(n => n.id === 'heart-team')?.patientVolume}</span>
 </div>
 </div>
 </div>
 ...
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">TEER Procedures</span>
 <span className="font-bold text-chrome-600">{metrics.teerVolume}</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-titanium-600">Overall Success Rate</span>
 <span className="font-bold text-teal-700">{toFixed(metrics.overallSuccessRate * 100, 1)}%</span>
 </div>
 </div>
 </div>
 </div>
