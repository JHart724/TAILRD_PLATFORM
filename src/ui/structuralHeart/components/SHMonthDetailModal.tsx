...
interface SHMonthDetailModalProps {
  month: string;
  projected: number;
  realized: number;
...
const SHMonthDetailModal: React.FC<SHMonthDetailModalProps> = ({
  month,
  projected,
  realized,
  breakdown,
 ...
 <p className="text-gray-600 mt-1">Structural Heart Revenue Analysis</p>
 </div>
 </div>
 <button
 onClick={onClose}
...
export default SHMonthDetailModal;