...
const TAVRAnalyticsDashboard: React.FC = () => {
 ...
 <div className="text-2xl font-bold text-chrome-800">{tavrMetrics[2]?.value.toFixed(1)} days</div>
 </div>
 ...
 <div className="text-lg font-bold text-porsche-600">{patient.stsScore.toFixed(1)}</div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-2xl font-bold text-titanium-900">{metric.value.toFixed(1)}%</div>
 <div className="text-sm text-titanium-600">vs {metric.target.toFixed(1)}% target</div>
 </div>
 ...
 <span className="font-semibold text-chrome-600">{avgLOS.toFixed(1)} days</span>
 </div>
 </div>
 </div>
 );
 ...
 <div key={index} className="p-6 border rounded-lg bg-gradient-to-br from-chrome-50 to-chrome-100 shadow-sm">
 ...
 <div className="flex justify-between">
 <span className="text-titanium-600">Avg LOS:</span>
 <span className="font-semibold text-chrome-600">{site.avgLOS.toFixed(1)} days</span>
 </div>
 <div className="flex justify-between">
 ...
 .map((site, index) => (
 <div key={index} className="p-4 bg-white border border-titanium-200 rounded-lg shadow-sm">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${
 index === 0 ? 'bg-yellow-500' : 
 index === 1 ? 'bg-gray-400' : 
 index === 2 ? 'bg-amber-600' : 'bg-titanium-400'
 }`}>
 {index + 1}
 </div>
 <div>
 ...
 <div className="text-center">
 <div className="text-lg font-bold text-chrome-600">{site.avgLOS.toFixed(1)}d</div>
