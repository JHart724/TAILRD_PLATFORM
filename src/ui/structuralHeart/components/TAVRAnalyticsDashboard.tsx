...
const TAVRAnalyticsDashboard: React.FC = () => {
 ...
 switch (outcome) {
 case 'Success': return 'text-teal-700';
 ...
 className={`px-4 py-2 rounded-lg flex items-center gap-2 ${
 activeView === 'risk-analysis' ? 'bg-porsche-500 text-white' : 'bg-titanium-100 text-titanium-700'
 }`}
 >
 ...
 className={`px-4 py-2 rounded-lg flex items-center gap-2 ${
 activeView === 'outcomes' ? 'bg-porsche-500 text-white' : 'bg-titanium-100 text-titanium-700'
 }`}
 >
 ...
 className={`px-4 py-2 rounded-lg flex items-center gap-2 ${
 activeView === 'geography' ? 'bg-porsche-500 text-white' : 'bg-titanium-100 text-titanium-700'
 }`}
 >
 ...
 {/* Filters */}
 <div className="flex items-center gap-4 mt-4 p-4 bg-titanium-50 rounded-lg">
 ...
 className="px-3 py-1 border border-titanium-300 rounded text-sm"
 >
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-teal-700 font-medium">Success Rate</div>
 <div className="text-2xl font-bold text-teal-700">{toFixed(tavrMetrics[0]?.value, 1)}%</div>
 </div>
 <div className={`flex items-center text-sm ${tavrMetrics[0]?.trend > 0 ? 'text-teal-700' : 'text-red-600'}`}>
 ...
 <div className={`flex items-center text-sm ${tavrMetrics[1]?.trend < 0 ? 'text-teal-700' : 'text-red-600'}`}>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-chrome-700 font-medium">Avg Length of Stay</div>
 <div className="text-2xl font-bold text-chrome-800">{toFixed(tavrMetrics[2]?.value, 1)} days</div>
 </div>
 <Clock className="w-6 h-6 text-chrome-600" />
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-arterial-700 font-medium">Risk-Adjusted Score</div>
 <div className="text-2xl font-bold text-arterial-800">{toFixed(tavrMetrics[3]?.value, 1)}</div>
 </div>
 <Award className="w-6 h-6 text-arterial-600" />
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-sm text-gray-500 font-medium">Procedures MTD</div>
 <div className="text-2xl font-bold text-gray-500">{Math.round(tavrMetrics[4]?.value || 0)}</div>
 </div>
 ...
 <div key={patient.id} className="p-4 bg-white border border-titanium-200 rounded-xl shadow-sm hover:shadow-md transition-shadow">
 <div className="flex items-center justify-between">
 ...
 <div className="text-sm text-titanium-600">Age {patient.age} • {patient.riskCategory} Risk • {patient.valveType}</div>
 </div>
 </div>
 
 <div className="flex items-center gap-6">
 <div className="text-center">
 <div className="text-lg font-bold text-porsche-600">{toFixed(patient.stsScore, 1)}</div>
 <div className="text-xs text-titanium-600">STS Score</div>
 </div>
 <div className="text-center">
 <div className="text-lg font-bold text-arterial-600">{toFixed(patient.euroScore, 1)}</div>
 <div className="text-xs text-titanium-600">EuroSCORE</div>
 </div>
 <div className="text-center">
 <div className="text-sm text-titanium-600">{patient.approach}</div>
 <div className="text-xs text-titanium-500">Approach</div>
 </div>
 <div className="text-center">
 <div className={`text-lg font-bold ${getOutcomeColor(patient.outcome)}`}>{patient.outcome}</div>
 <div className="text-xs text-titanium-600">Outcome</div>
 </div>
 {patient.los > 0 && (
 <div className="text-center">
 <div className="text-lg font-bold text-chrome-600">{patient.los}d</div>
 <div className="text-xs text-titanium-600">LOS</div>
 </div>
 )}
 </div>
 </div>
 ...
 <h4 className="font-semibold text-gray-500">Quality & Safety Alerts</h4>
 </div>
 <div className="space-y-2 text-sm">
 <div className="text-teal-700">✓ 30-day mortality below national benchmark (2.1% vs 3.0%)</div>
 <div className="text-teal-700">✓ Average LOS improved by 0.8 days this month</div>
 <div className="text-gray-500">⚠ Patient P005 (Helen Thompson) had extended LOS - review for optimization</div>
 <div className="text-gray-500">⚠ Stroke rate slightly elevated - monitor next 5 procedures closely</div>
 </div>
 </div>
 </div>
 )}
 ...
 const percentage = toFixed(count / patients.length * 100, 1);
 return (
 <div key={risk} className="p-4 border rounded-lg bg-white shadow-sm">
 <div className={`text-2xl font-bold text-center mb-2 ${
 risk === 'Low' ? 'text-teal-700' :
 risk === 'Intermediate' ? 'text-gray-500' :
 risk === 'High' ? 'text-gray-500' : 'text-red-600'
 }`}>
 {count}
 </div>
 <div className="text-sm text-center text-titanium-600">{risk} Risk</div>
 <div className="text-lg font-bold text-center mt-2 text-porsche-600">
 {percentage}%
 </div>
 <div className="text-xs text-center text-titanium-500">of patients</div>
 </div>
 );
 })}
 </div>
 ...
 <div key={patient.id} className="flex items-center p-3 bg-white border rounded-lg">
 ...
 <div className="text-center">
 <div className="font-bold">{toFixed(patient.stsScore, 1)}</div>
 <div className="text-xs text-titanium-600">STS</div>
 </div>
 <div className="text-center">
 <div className="font-bold">{toFixed(patient.euroScore, 1)}</div>
 <div className="text-xs text-titanium-600">Euro</div>
 </div>
 ...
 return (
 <div key={valve} className="p-4 border rounded-lg bg-gradient-to-br from-chrome-50 to-chrome-100">
 <div className="text-lg font-bold text-chrome-800 mb-2">{valve.split(' ')[0]}</div>
 <div className="space-y-2">
 <div className="text-sm">
 <span className="text-titanium-600">Procedures: </span>
 <span className="font-semibold">{valvePatients.length}</span>
 </div>
 <div className="text-sm">
 <span className="text-titanium-600">Success Rate: </span>
 <span className="font-semibold text-teal-700">{toFixed(successRate, 1)}%</span>
 </div>
 <div className="text-sm">
 <span className="text-titanium-600">Avg Risk Score: </span>
 <span className="font-semibold">
 {valvePatients.length > 0 ? 
 toFixed(valvePatients.reduce((sum, p) => sum + p.stsScore, 0) / valvePatients.length, 1) : 'N/A'}
 </span>
 </div>
 </div>
 </div>
 ...
 <div key={metric.measure} className="p-4 border rounded-lg bg-white shadow-sm">
 ...
 metric.category === 'Morbidity' ? 'bg-amber-50 text-amber-600' :
 ...
 <div className="flex items-center justify-between">
 <div>
 <div className="text-2xl font-bold text-titanium-900">{toFixed(metric.value, 1)}%</div>
 <div className="text-sm text-titanium-600">vs {toFixed(metric.target, 1)}% target</div>
 </div>
 <div className={`flex items-center text-sm ${
 (metric.category === 'Mortality' || metric.category === 'Morbidity') ?
 (metric.trend < 0 ? 'text-teal-700' : 'text-red-600') :
 (metric.trend > 0 ? 'text-teal-700' : 'text-red-600')
 }`}>
 ...
 {toFixed(Math.abs(metric.trend), 1)}%
 </div>
 </div>
 ...
 metric.value <= metric.target ? 'bg-titanium-300' : 'bg-red-500'
 }`}
 ...
 return (
 <div key={approach} className="p-4 border rounded-lg bg-gradient-to-br from-arterial-50 to-arterial-100">
 <div className="text-lg font-bold text-arterial-800 mb-2">{approach}</div>
 <div className="space-y-2">
 <div className="text-sm">
 <span className="text-titanium-600">Procedures: </span>
 ...
 <span className="font-semibold text-chrome-600">{toFixed(avgLOS, 1)} days</span>
 </div>
 </div>
 </div>
 );
 ...
 <div className="space-y-6">
 <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
 <MapPin className="w-5 h-5 text-porsche-600" />
 ...
 {siteData.map((site) => (
 <div key={site.siteId} className="p-6 border rounded-lg bg-gradient-to-br from-chrome-50 to-chrome-100 shadow-sm">
 <div className="flex items-center justify-between mb-4">
 <h4 className="text-lg font-bold text-chrome-800">{site.siteName}</h4>
 <div className="text-sm text-chrome-600">ID: {site.siteId}</div>
 </div>
 ...
 <div className="flex justify-between">
 <span className="text-titanium-600">Success Rate:</span>
 <span className="font-semibold text-teal-700">{toFixed(site.successRate, 1)}%</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">30-Day Mortality:</span>
 <span className="font-semibold text-red-600">{toFixed(site.mortality30Day, 1)}%</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">Avg LOS:</span>
 <span className="font-semibold text-chrome-600">{toFixed(site.avgLOS, 1)} days</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">Risk-Adjusted Score:</span>
 <span className="font-semibold text-arterial-600">{toFixed(site.riskAdjustedScore, 1)}</span>
 </div>
 </div>
 
 {/* Performance indicator */}
 <div className="mt-4 pt-3 border-t border-chrome-200">
 <div className="flex items-center gap-2">
 <Stethoscope className="w-4 h-4 text-chrome-600" />
 ...
 .map((site, siteIndex) => (
 <div key={site.siteId} className="p-4 bg-white border border-titanium-200 rounded-lg shadow-sm">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${
 siteIndex === 0 ? 'bg-chrome-50' :
 siteIndex === 1 ? 'bg-gray-400' :
 siteIndex === 2 ? 'bg-chrome-50' : 'bg-titanium-400'
 }`}>
 {siteIndex + 1}
 </div>
 <div>
 <div className="font-semibold text-titanium-900">{site.siteName}</div>
 <div className="text-sm text-titanium-600">{site.procedures} procedures</div>
 </div>
 </div>
 
 <div className="flex items-center gap-6">
 <div className="text-center">
 <div className="text-lg font-bold text-arterial-600">{toFixed(site.riskAdjustedScore, 1)}</div>
 <div className="text-xs text-titanium-600">Risk-Adjusted</div>
 </div>
 <div className="text-center">
 <div className="text-lg font-bold text-teal-700">{toFixed(site.successRate, 1)}%</div>
 <div className="text-xs text-titanium-600">Success Rate</div>
 </div>
 <div className="text-center">
 <div className="text-lg font-bold text-red-600">{toFixed(site.mortality30Day, 1)}%</div>
 <div className="text-xs text-titanium-600">30d Mortality</div>
 </div>
 <div className="text-center">
 <div className="text-lg font-bold text-chrome-600">{toFixed(site.avgLOS, 1)}d</div>
 <div className="text-xs text-titanium-600">Avg LOS</div>
 </div>
 </div>
 </div>
 </div>
