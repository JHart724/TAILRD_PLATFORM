...
const SHProcedureFunnel: React.FC<SHProcedureFunnelProps> = ({ data }) => {
 ...
 <span className="font-bold text-titanium-900">{procedure.referred} ({referralRate.toFixed(0)}%)</span>
 </div>
 <div className="w-full bg-titanium-100 rounded-full h-2">
 ...
 <span className="font-bold text-titanium-900">{procedure.completed} ({completionRate.toFixed(0)}%)</span>
 </div>
 <div className="w-full bg-titanium-100 rounded-full h-2">
