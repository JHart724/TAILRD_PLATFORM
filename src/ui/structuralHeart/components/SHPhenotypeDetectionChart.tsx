...
const SHPhenotypeDetection: React.FC = () => {
  const phenotypes: SHPhenotypeData[] = [
 {
 ...
 <div>
 <h3 className="text-lg font-semibold text-titanium-900">Beyond-Valve Therapy Phenotype Detection</h3>
 <p className="text-sm text-titanium-600 mt-1">12 Targetable Phenotypes in Valve Disease Population</p>
 </div>
 ...
 <div>
 <h4 className="font-semibold text-titanium-900">{phenotype.name}</h4>
 ...
 <div className="text-lg font-bold text-titanium-900">{phenotype.detected}</div>
 </div>
 <div>
 ...
 <div className="text-lg font-bold text-chrome-800">{phenotype.actionable}</div>
 </div>
 </div>
 ...
 ${toFixed(phenotype.actionable * phenotype.avgCostPerPatient / 1000, 0)}K
 </span>
 </div>
 </div>
 );
...
export default SHPhenotypeDetection;