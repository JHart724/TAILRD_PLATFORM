...
const SHClinicalGapDetectionDashboard: React.FC<SHClinicalGapDetectionDashboardProps> = ({ categoryFilter }) => {
  ...
  useEffect(() => {
    let cancelled = false;
    fetchModuleGapsFromApi('structural-heart').then(gaps => {
  ...
  const activeGaps: SHClinicalGap[] = dataSource === 'api' && apiGaps
    ? apiGaps.map(g => ({
        ...g,
      ...
      <div className="metal-card bg-white border border-titanium-200 rounded-2xl p-6">
        ...
        {!categoryFilter && (
          <div className="text-sm text-titanium-600 mb-4 flex items-center gap-3">
            <span>Guideline-based detection of evidence-based structural heart therapy gaps and growth opportunities.</span>
