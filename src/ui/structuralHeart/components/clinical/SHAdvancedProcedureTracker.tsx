...
const SHAdvancedProcedureTracker: React.FC = () => {
 ...
 procedure.currentUtilization < 30 ? 'bg-deep-amber-500' :
 procedure.currentUtilization < 50 ? 'bg-deep-blue-500' : 'bg-deep-green-500'
 }`}
 ...
 <div className="text-xs text-medical-green-600">{procedure.citation}</div>
 </div>
 <div className="text-right">
 <div className="text-lg font-bold text-medical-green-700">
 ${procedure.revenueGap >= 1000000 ? `${(procedure.revenueGap / 1000000).toFixed(1)}M` : `${(procedure.revenueGap / 1000).toFixed(0)}K`}
 </div>
 </div>
 </div>
 ...
 <div className="text-xs text-medical-green-600">Valve program expansion</div>
 </div>
