...
const SHAdvancedProcedureTracker: React.FC = () => {
 ...
 procedure.currentUtilization < 30 ? 'bg-[#4A7FA5]' :
 procedure.currentUtilization < 50 ? 'bg-deep-blue-500' : 'bg-[#2C4A60]'
 }`}
 ...
 <div className="font-bold text-[#2C4A60]">{procedure.utilizedPatients}</div>
 ...
 <div className="text-xs text-[#2C4A60]">{procedure.citation}</div>
 </div>
 ...
 <div className="text-xs text-[#2C4A60]">Valve program expansion</div>
 </div>
