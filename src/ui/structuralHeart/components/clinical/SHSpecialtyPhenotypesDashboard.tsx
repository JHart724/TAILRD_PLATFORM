...
const SPECIALTY_PHENOTYPES: PhenotypeData[] = [
 ...
 prevalence: '13-20% of valve disease >65',
 utilization: '<10%',
 ...
 prevalence: '~50% of valve disease patients',
 utilization: '~5-10%',
 ...
 prevalence: '0.1-0.3% in U.S. valve disease',
 utilization: '<10%',
 triggers: ['Dilated CM + Latin American origin', 'RBBB', 'apical aneurysm'],
 interventions: ['Serologic testing', 'anti-trypanosomal therapy', 'rhythm monitoring'],
 revenue: '$3,000-$7,000',
 ...
 prevalence: '~0.1-0.2% of valve disease',
 utilization: '<10%',
 ...
 prevalence: '~5-10% of new valve dysfunction',
 utilization: '~50%',
 triggers: ['Persistent AF with RVR', 'PVC burden >10%', 'frequent SVT'],
 interventions: ['Rhythm intervention', 'rhythm control may normalize valve function'],
 ...
 triggers: ['Valve dysfunction onset late pregnancy to 5 months postpartum'],
 interventions: ['Valve therapy', 'bromocriptine in Europe', 'close OB follow-up'],
 ...
 utilization: '~20-30%',
 triggers: ['History of anthracyclines/trastuzumab', 'new diseaseStage decline'],
 interventions: ['Cardio-oncology referral', 'valve therapy initiation', 'diseaseStage surveillance'],
 ...
 prevalence: '~1-3% of valve disease patients',
 utilization: 'Unknown',
 triggers: ['New valve dysfunction in patients with SLE', 'RA', 'systemic sclerosis'],
...
const SHSpecialtyPhenotypesDashboard: React.FC = () => {
 ...
 case 'moderate': return 'text-chrome-500 bg-crimson-50 border-crimson-200';
 ...
 <div>
 <h2 className="text-3xl font-bold text-titanium-900 font-sf">Beyond Valve Therapy: Specialty Phenotypes</h2>
 <p className="text-titanium-600">Advanced valve disease phenotype identification and revenue optimization</p>
 </div>
 </div>
 ...
 <div className="text-2xl font-bold text-chrome-500 font-sf">{totalEligible - totalIdentified}</div>
 <div className="text-sm text-chrome-500">Unidentified Patients</div>
 </div>
 ...
 {/* Revenue Impact */}
 <div className="flex items-center justify-between p-3 bg-chrome-50 border border-titanium-300 rounded-lg">
 <div>
 ...
 >
 <Activity className="w-6 h-6 text-chrome-500 mx-auto mb-2" />
 <div className="text-sm font-semibold text-crimson-700">Protocol Builder</div>
 <div className="text-xs text-chrome-500">Create screening workflows</div>
 </button>
 </div>
 </div>
 </div>
...
export default SHSpecialtyPhenotypesDashboard;