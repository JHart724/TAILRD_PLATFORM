...
const SHSpecialtyPhenotypesDashboard: React.FC = () => {
 ...
 <span key={index} className="px-2 py-1 bg-porsche-100 text-porsche-700 text-xs rounded">
 {trigger}
 </span>
 ))}
 ...
 <li key={idx} className="text-sm text-titanium-700 flex items-start gap-2">
 ...
 <div key={idx} className="flex items-center justify-between p-2 bg-white rounded border border-porsche-100">
