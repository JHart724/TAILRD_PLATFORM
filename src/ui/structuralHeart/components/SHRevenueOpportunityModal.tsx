...
interface SHRevenueOpportunityModalProps {
  opportunities: Opportunity[];
  onClose: () => void;
  onViewDetails?: () => void;
}

const SHRevenueOpportunityModal: React.FC<SHRevenueOpportunityModalProps> = ({
  opportunities,
  onClose,
  onViewDetails
}) => {
 ...
 <span className="font-semibold text-medical-green-600 whitespace-nowrap">${(item.revenue / 1000).toFixed(0)}K</span>
 </div>
 </div>
 ))}
 </div>
...
export default SHRevenueOpportunityModal;