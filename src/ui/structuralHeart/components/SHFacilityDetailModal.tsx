...
interface SHFacilityDetailModalProps {
  facilityName: string;
  location: string;
  totalRevenue: number;
  patientCount: number;
...
const SHFacilityDetailModal: React.FC<SHFacilityDetailModalProps> = ({
  facilityName,
  location,
  totalRevenue,
  patientCount,
 ...
 <th className="pb-3 font-medium text-right">Valve Therapy Rate</th>
 ...
 provider.valveTherapyRate >= 80 ? 'text-emerald-600' : 
 provider.valveTherapyRate >= 70 ? 'text-chrome-600' : 
 provider.valveTherapyRate >= 60 ? 'text-amber-600' : 'text-red-600'
 }`}>
...
export default SHFacilityDetailModal;