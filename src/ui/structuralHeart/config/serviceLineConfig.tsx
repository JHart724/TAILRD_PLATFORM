...
import { Users, Share, Activity, Award, Calculator, Heart, Target, Grid3X3, Shield, BarChart3, FileText, Network, AlertTriangle, ChevronDown, ChevronUp, Zap, TrendingUp } from 'lucide-react';
...
const StructuralHeartAnalytics: React.FC = () => (
 ...
 <div className="text-sm text-teal-700">+22.7% vs last quarter</div>
 </div>
 <div className="metal-card p-6">
 ...
 <div className="text-sm text-teal-700">+45.2% vs last quarter</div>
 </div>
 <div className="metal-card p-6">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Moderate AS — Surveillance Due</p>
          <p className="text-3xl font-bold text-gray-500">{totalModerateAS}</p>
          <p className="text-xs text-titanium-500 mt-1">Echo overdue — risk of undetected progression to severe AS</p>
        </div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Post-TAVR Echo Overdue</p>
          <p className="text-3xl font-bold text-gray-500">{totalPostTavr}</p>
      ...
      {moderateASGap && (
        <div className="metal-card bg-white border border-titanium-300 rounded-2xl p-6">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-xs bg-amber-50 text-amber-600 px-2 py-0.5 rounded-full font-medium">SURVEILLANCE</span>
              ...
              <p className="text-xs font-semibold text-gray-500 mt-2">Action: {moderateASGap.cta}</p>
            </div>
          </div>
          {moderateASGap.subcategories && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
              {moderateASGap.subcategories.map((sub, i) => (
                <div
                  key={i}
                  className={`rounded-lg px-4 py-3 border ${i === 0 ? 'bg-red-50 border-red-200' : 'bg-chrome-50 border-titanium-300'}`}
                >
          ...
          <div className="space-y-2">
            {moderateASGap.patients.map(p => renderPatient(p, 'border-titanium-300', 'bg-chrome-50'))}
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-xs bg-amber-50 text-amber-600 px-2 py-0.5 rounded-full font-medium">QUALITY GAP</span>
              ...
              <p className="text-xs font-semibold text-gray-500 mt-2">Action: {postTavrGap.cta}</p>
            </div>
          </div>
          <div className="space-y-2">
            {postTavrGap.patients.map(p => renderPatient(p, 'border-titanium-300', 'bg-chrome-50'))}
      ...
      {/*
        ...
        "15 months to clear pipeline", "5 months with TAILRD protocol", and "Revenue Acceleration
        $4.8M in 12 months" behind a "Forward-looking" chip. The first two are a PRODUCT EFFICACY claim -
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-medical-red-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Total Procedures</p><p className="text-3xl font-bold text-titanium-900">1,910</p><p className="text-xs text-teal-700 mt-1">+16.2% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Overall Technical Success</p><p className="text-3xl font-bold text-teal-700">97.2%</p><p className="text-xs text-titanium-500 mt-1">Across all structural procedures</p></div>
        <div className="metal-card p-5 border-l-4 border-l-blue-500"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">TAVR Transfemoral Rate</p><p className="text-3xl font-bold text-blue-700">91.7%</p><p className="text-xs text-teal-700 mt-1">+2.4% vs last quarter</p></div>
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Avg TAVR LOS</p><p className="text-3xl font-bold text-gray-500">2.1d</p><p className="text-xs text-teal-700 mt-1">-0.3d vs last quarter</p></div>
      </div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {procedures.map((p, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">{p.stroke}</span></td>
...
const StructuralOutcomesAnalytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Overall 30d Mortality</p><p className="text-3xl font-bold text-teal-700">1.8%</p><p className="text-xs text-titanium-500 mt-1">STS benchmark 2.4%</p></div>
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Mod/Severe PVL Rate</p><p className="text-3xl font-bold text-gray-500">1.3%</p><p className="text-xs text-teal-700 mt-1">-0.2% vs last quarter</p></div>
            ...
            <tbody className="divide-y divide-titanium-100">
              {tavr.map((t, i) => (
                <tr key={i} className="hover:bg-titanium-50">
                  ...
                  <td className="px-4 py-3"><span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-amber-50 text-amber-600">{t.stroke}</span></td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-titanium-50 border border-titanium-200 rounded-xl p-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-white rounded-lg p-2"><p className="text-titanium-500">Low Risk</p><p className="font-semibold text-teal-700">&lt;2%</p></div>
            <div className="bg-white rounded-lg p-2"><p className="text-titanium-500">Intermediate</p><p className="font-semibold text-gray-500">2–10%</p></div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#2C4A60]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Avg Procedural Success</p><p className="text-3xl font-bold text-teal-700">97.4%</p><p className="text-xs text-titanium-500 mt-1">Across TAVR and MitraClip</p></div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="metal-card p-5 border-l-4 border-l-[#6B7280]"><p className="text-xs font-semibold text-titanium-600 uppercase tracking-wide mb-1">Moderate Alerts</p><p className="text-3xl font-bold text-gray-500">165</p><p className="text-xs text-titanium-500 mt-1">Protocol review required</p></div>
