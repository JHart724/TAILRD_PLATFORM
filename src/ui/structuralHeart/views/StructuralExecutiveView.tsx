...
const StructuralExecutiveView: React.FC = () => {
 ...
 <div className="text-2xl font-bold text-medical-green-800">${((drg.avgReimbursement || drg.reimbursement) / 1000).toFixed(0)}K</div>
 </div>
 </div>
 ...
 {(drg.netMargin || drg.margin || 0).toFixed(1)}% margin
 </div>
 </div>
 );
 })}
