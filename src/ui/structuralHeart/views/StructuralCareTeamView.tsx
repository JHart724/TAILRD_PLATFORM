...
const ClinicalToolsPanel: React.FC = () => {
 ...
 <Stethoscope className="w-6 h-6 text-medical-purple-600" />
 ...
 ? 'bg-medical-purple-600 text-white shadow-lg'
...
const StructuralCareTeamView: React.FC = () => {
 ...
 <tr key={index} className="border-b border-titanium-100 hover:bg-medical-purple-50/50">
