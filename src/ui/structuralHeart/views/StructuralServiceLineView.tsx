...
const StructuralServiceLineView: React.FC = () => {
 ...
 <div key={item.metric} className={`p-6 rounded-xl border ${item.met ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
 ...
 <div className="metal-card bg-white border border-titanium-200 rounded-2xl p-8">
 <h3 className="text-2xl font-bold text-titanium-900 mb-6 flex items-center gap-3">
 <FileText className="w-8 h-8 text-arterial-600" />
 ...
 : 'bg-arterial-50 text-arterial-600 border-arterial-200 hover:bg-arterial-100'
 }`}>
 ...
 <button key={format} onClick={() => { setExportingFormat(format); setTimeout(() => setExportingFormat(null), 2000); }} className={`px-3 py-2 rounded-lg text-sm font-medium border transition-colors ${
 ...
 <div className="space-y-2 text-sm">
 <div className="flex justify-between">
 <span className="text-arterial-800">Weekly Heart Team Summary</span>
 <span className="text-arterial-600">Every Friday 6:00 AM</span>
 </div>
 <div className="flex justify-between">
 <span className="text-arterial-800">Monthly TAVR Dashboard</span>
 <span className="text-arterial-600">1st of month</span>
 </div>
 <div className="flex justify-between">
 <span className="text-arterial-800">Quarterly TVT Submission</span>
