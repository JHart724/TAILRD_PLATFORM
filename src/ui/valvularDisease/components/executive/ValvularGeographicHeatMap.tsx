...
const ValvularGeographicHeatMap: React.FC = () => {
 ...
 Severity: {selectedData.severityScore.toFixed(1)}
 </div>
 </div>
 ...
 Severity: {zipData.sort((a, b) => b.severityScore - a.severityScore)[0].severityScore.toFixed(1)}
 </div>
 </div>
