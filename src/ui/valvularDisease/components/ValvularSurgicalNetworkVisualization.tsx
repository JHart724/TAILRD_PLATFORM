...
const ValvularSurgicalNetworkVisualization: React.FC = () => {
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.heartTeamUtilization * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{metrics.surgicalVsTranscatheterRate.toFixed(1)}:1</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.postOpSurveillanceCompliance * 100).toFixed(0)}%</div>
 ...
 <div>
 <div className="text-lg font-bold text-titanium-900">{(metrics.riskAssessmentAccuracy * 100).toFixed(0)}%</div>
 ...
 width="700"
 height="520"
 className="border border-titanium-100 rounded-lg bg-gradient-to-br from-purple-50 to-white"
 >
 {/* Render connections */}
 ...
 <div className="text-lg font-bold text-amber-600">{(selectedNode.complicationRate * 100).toFixed(1)}%</div>
