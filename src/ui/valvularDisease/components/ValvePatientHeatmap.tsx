...
const ValvePatientHeatmap: React.FC = () => {
 ...
 <div>
 <h3 className="text-2xl font-bold text-titanium-900 flex items-center gap-2">
 <Heart className="w-6 h-6 text-red-500" />
 Valve Disease Patient Heatmap
 </h3>
 <p className="text-titanium-600">Interactive risk assessment and surgical decision support for valvular disease patients</p>
 </div>
 
 <div className="flex items-center gap-4">
 <div className="flex items-center gap-2">
 <Activity className="w-4 h-4 text-titanium-600" />
 <select 
 ...
 <span className="font-medium text-titanium-700">Legend:</span>
 {filterBy === 'severity' && (
 ...
 <div className="flex items-center gap-2">
 <div className="w-4 h-4 bg-chrome-400 rounded"></div>
 ...
 <div className="flex items-center gap-2">
 <div className="w-4 h-4 bg-gold-400 rounded"></div>
 ...
 <div className="flex items-center gap-2">
 <div className="w-4 h-4 bg-chrome-500 rounded"></div>
 ...
 <div className="bg-chrome-50 border border-chrome-200 p-4 rounded-lg">
 <div className="flex items-center gap-2 text-chrome-800">
 <Heart className="w-5 h-5" />
 <span className="font-semibold">Ross Candidates</span>
 </div>
 <div className="mt-2 text-chrome-700">
 <div className="text-2xl font-bold">
 ...
 <div className="bg-titanium-900 text-white text-xs rounded-lg p-3 whitespace-nowrap shadow-lg max-w-xs">
 ...
 {/* Summary Stats */}
 <div className="mt-6 grid grid-cols-2 md:grid-cols-6 gap-4 pt-6 border-t border-titanium-200">
 <div className="text-center p-3 bg-titanium-50 rounded-lg">
 <div className="text-xl font-bold text-titanium-900">{sortedData.length}</div>
 ...
 <div className="text-xl font-bold text-chrome-600">
 {sortedData.filter(p => p.rossProcedureCandidate).length}
 </div>
