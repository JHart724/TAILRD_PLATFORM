...
const ValveSpecialtyPhenotypesDashboard: React.FC = () => {
  ...
  return (
	...
	<span key={intervention} className="px-2 py-1 bg-green-50 text-green-600 text-xs rounded">{intervention}</span>
	))}
	</div>
	</div>
	</div>
	...
	<button className="p-4 border-2 border-teal-700 rounded-lg hover:bg-titanium-300 transition-colors"
	...
	<button className="p-4 border-2 border-titanium-300 rounded-lg hover:bg-chrome-50 transition-colors"
