...
const AdvancedValveProcedureTracker: React.FC = () => {
 ...
 case 'emerging': return 'text-amber-600 bg-amber-50 border-titanium-300';
 ...
 proc.currentUtilization < 30 ? 'bg-chrome-50' :
 proc.currentUtilization < 50 ? 'bg-porsche-500' : 'bg-titanium-300'
 }`}
 ...
 <div className="font-bold text-teal-700">{proc.utilizedPatients}</div>
 ...
 <div className="text-lg font-bold text-teal-700">$3.26M</div>
 <div className="text-xs text-teal-700">MitraClip/TEER program expansion</div>
 </div>
 ...
 <div className="text-lg font-bold text-gray-500">{totalEligible - totalUtilized}</div>
 <div className="text-xs text-gray-500">Total underutilized patients</div>
 </div>
 </div>
 </div>
 </div>
