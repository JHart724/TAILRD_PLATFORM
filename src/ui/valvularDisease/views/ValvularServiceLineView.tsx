...
const ValvularServiceLineView: React.FC = () => {
 ...
 { stage: 'Completed', patients: 76, rate: '92.7%', bgColor: 'bg-purple-50', borderColor: 'border-purple-200', textColor: 'text-purple-600' }
 ].map((item, index) => (
 ...
 <div key={index} className={`p-6 rounded-xl ${item.bgColor} border ${item.borderColor}`}>
 ...
 <div key={index} className="flex justify-between p-3 bg-porsche-50 rounded-lg">
 ...
 <div key={index} className="bg-porsche-50 p-4 rounded-xl text-center">
 ...
 <div key={index} className={`p-6 rounded-xl ${item.met ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'} border`}>
 ...
 <div key={index} className="flex justify-between p-3 bg-chrome-50 rounded-lg">
 <span className="text-titanium-900">{item.metric}</span>
 ...
 <div key={index} className="flex items-center justify-between p-3 bg-porsche-50 rounded-lg">
 ...
 Valvular Disease Reports
 </h3>
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
 <div className="space-y-4">
 <h4 className="font-semibold text-titanium-900 mb-2">Available Reports</h4>
 {[
 { name: 'Monthly Surgical Volume Report', frequency: 'Monthly', lastRun: 'Feb 28, 2026' },
 { name: 'STS Quality Report', frequency: 'Quarterly', lastRun: 'Jan 15, 2026' },
 { name: 'Repair vs Replace Analysis', frequency: 'Quarterly', lastRun: 'Jan 15, 2026' },
 { name: 'Echo Surveillance Compliance', frequency: 'Monthly', lastRun: 'Feb 28, 2026' },
 { name: 'Annual Program Report', frequency: 'Annual', lastRun: 'Jan 1, 2026' }
 ].map((report, index) => (
 ...
 : 'bg-porsche-50 text-porsche-600 border-porsche-200 hover:bg-porsche-100'
 }`}>
