...
const ValvularPatients: React.FC = () => (
 ...
 <tr key={index} className="border-b border-titanium-100 hover:bg-titanium-50">
...
const ValvularWorkflow: React.FC = () => (
 ...
 <div key={index} className="flex items-center justify-between p-3 bg-titanium-50 rounded-lg">
...
const ValvularClinicalCollaboration: React.FC = () => (
 ...
 <div key={index} className="p-4 bg-titanium-50 rounded-lg border border-titanium-200">
 <div className="mb-2">
