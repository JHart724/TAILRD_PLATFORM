...
const RCCDIView: React.FC = () => {
 ...
 <div className="metal-card p-6 border-l-4 border-l-porsche-400 bg-porsche-50/50">
 ...
 <div className="text-sm text-titanium-600">Active Alerts</div>
 </div>
 <div className="ml-4 p-3 rounded-xl bg-gradient-to-br from-white via-porsche-50/60 to-white border border-titanium-200 shadow-lg">
 <AlertTriangle className="w-6 h-6 text-porsche-600 drop-shadow-sm" />
 </div>
 </div>
 <div className="flex items-center gap-2 text-sm font-semibold text-porsche-600">
 <TrendingUp className="w-4 h-4" />
 <span>18%</span>
 <span className="text-titanium-500 font-normal ml-1">of total admissions</span>
 </div>
 </div>
 ...
 <div className="metal-card p-6 border-l-4 border-l-medical-purple-400 bg-medical-purple-50/50">
 <div className="flex items-start justify-between mb-3">
 <div className="flex-1">
 <div className="text-sm font-semibold text-titanium-600 uppercase tracking-wider mb-2">
 CMI Impact
 ...
 <div className="ml-4 p-3 rounded-xl bg-gradient-to-br from-white via-medical-purple-50/60 to-white border border-titanium-200 shadow-lg">
 ...
 <div className="px-6 py-4 border-b border-titanium-200 bg-gradient-to-r from-titanium-50 to-medical-red-50/40">
 <div className="flex items-center justify-between">
 <div>
 <h3 className="text-lg font-semibold text-titanium-900 mb-2">High Priority CDI Alerts</h3>
 <p className="text-sm text-titanium-600">Documentation opportunities requiring immediate attention</p>
 </div>
 ...
 <div key={index} className="p-6 hover:bg-titanium-50 transition-colors">
 ...
 <div className="flex-1">
 <div className="font-semibold text-titanium-900 mb-1">
 ...
 <div className="text-sm text-porsche-600 mt-1">
 ...
 <div>
 <div className="text-sm font-semibold text-titanium-700 mb-2">Current Diagnoses</div>
 <div className="space-y-1">
 {alert.currentDiagnoses.map((diagnosis, diagIndex) => (
 <div key={diagIndex} className="text-sm text-titanium-600 bg-titanium-100 px-3 py-1 rounded">
 {diagnosis}
 </div>
 ))}
 </div>
 ...
 <div className="bg-titanium-50 rounded-lg p-4">
 <div className="text-sm font-semibold text-titanium-700 mb-3">Clinical Impact Analysis</div>
 <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
 <div>
 <div className="text-titanium-600">Severity Change</div>
 ...
 <div>
 <div className="text-titanium-600">Mortality Risk</div>
 <div className="font-semibold text-titanium-900">
 ...
 <div>
 <div className="text-titanium-600">CMI Impact</div>
 <div className="font-semibold text-porsche-700">
 ...
 <h3 className="text-lg font-semibold text-titanium-900 mb-2">CDI Performance by Service Line</h3>
 <p className="text-sm text-titanium-600">Documentation improvement opportunities by specialty</p>
 </div>
 ...
 <div className="flex items-center justify-between p-4 bg-gradient-to-r from-porsche-50 to-porsche-100 rounded-lg border border-porsche-200">
 <div>
 <div className="font-semibold text-porsche-900">Endocrine</div>
 <div className="text-sm text-porsche-700">12 opportunities • $18K potential</div>
 </div>
 <div className="text-right">
 <div className="text-2xl font-bold text-porsche-800">18%</div>
 <div className="text-xs text-porsche-600">of total opportunities</div>
 </div>
 </div>

 <div className="flex items-center justify-between p-4 bg-gradient-to-r from-titanium-50 to-titanium-100 rounded-lg border border-titanium-200">
 <div>
 <div className="font-semibold text-titanium-900">Other</div>
 <div className="text-sm text-titanium-700">14 opportunities • $24K potential</div>
 </div>
 <div className="text-right">
 <div className="text-2xl font-bold text-titanium-800">21%</div>
 <div className="text-xs text-titanium-600">of total opportunities</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="flex items-center justify-between mb-3">
 <div className="font-semibold text-porsche-900">CMI Improvement</div>
 <TrendingUp className="w-5 h-5 text-porsche-600" />
 </div>
 <div className="text-2xl font-bold text-porsche-800 mb-2">+0.23</div>
 ...
 <div className="mt-6 bg-titanium-50 rounded-lg p-4">
 <div className="text-sm font-semibold text-titanium-700 mb-3">Key Success Metrics</div>
 <div className="space-y-2 text-sm">
 <div className="flex justify-between">
 <span className="text-titanium-600">Average Response Time</span>
 <span className="font-semibold text-titanium-900">18.3 hours</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">Provider Acceptance Rate</span>
 <span className="font-semibold text-titanium-900">87.3%</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">Appeal Success Rate</span>
 <span className="font-semibold text-titanium-900">92.1%</span>
 </div>
 <div className="flex justify-between">
 <span className="text-titanium-600">Recurring Issues</span>
