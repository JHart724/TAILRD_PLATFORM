  ...
  const tabGroups: TabGroup[] = [
    {
      ...
      tabs: [
        ...
        { id: 'heatmap', label: 'Risk Heatmap', icon: Grid3X3, description: 'Interactive risk visualization matrix' },
    ...
    },
    {
      ...
      tabs: [
        { id: 'gap-detection', label: 'Gap Detection', icon: Search, description: 'Guideline-based clinical gap detection' },
      ],
    },
    {
    ...
    },
    {
      ...
      tabs: [
        ...
        { id: 'cross-referral', label: 'Cross-Referral', icon: Heart, description: 'Cross-specialty referral pathways and coordination' },
      ],
    },
    {
