...
import { Target, Grid3X3, Stethoscope, BarChart3, Activity, Search, Heart, Network, Users, FileText, Shield, ChevronDown, ChevronUp, Zap, AlertTriangle, Info, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      {/*
        ...
        "16 months to clear pipeline", "5 months with TAILRD protocol", and "Revenue Acceleration
        $6.0M in 12 months" behind a "Forward-looking" chip. The first two are a PRODUCT EFFICACY claim -
