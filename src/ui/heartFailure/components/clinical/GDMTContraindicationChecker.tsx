...
const GDMTContraindicationChecker: React.FC<{ patientData?: PatientContext }> = ({ patientData: ctx }) => {
  // Demo patient defaults — a 68 y/o male with moderate CKD and COPD on GDMT workup
  const demoDefaults: PatientData = {
 systolicBP: ctx?.systolicBP ?? 128,
 diastolicBP: ctx?.diastolicBP ?? 78,
 heartRate: ctx?.heartRate ?? 72,
 potassium: ctx?.potassium ?? 4.2,
 ...
 <div>
 <h2 className="text-2xl font-bold text-titanium-900 font-sf">GDMT Contraindication Checker</h2>
 <p className="text-titanium-600">Evidence-based safety screening for heart failure therapy</p>
 </div>
 </div>

 <div className="mb-6 p-3 bg-chrome-50 border border-chrome-200 rounded-lg flex items-center justify-between">
 ...
 <h3 className="font-semibold text-porsche-800 mb-3">Vital Signs & Labs</h3>
 <div className="space-y-3">
 <div className="grid grid-cols-2 gap-3">
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">SBP (mmHg)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">DBP (mmHg)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">HR (bpm)</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">Age</label>
 <input
 type="number"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">K+ (mEq/L)</label>
 <input
 type="number"
 step="0.1"
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-1">eGFR</label>
 <input
 type="number"
