...
const PatientWorklistEnhanced: React.FC = () => {
 ...
 if (debouncedSearch) {
   ...
   const searchable = [
     ...
     patient.nyhaClass, ...patient.gdmtGaps
   ].join(' ').toLowerCase();
 ...
 <span className="text-2xl font-bold text-titanium-900">{patient.lvef}%</span>
 </div>
 <div className="text-xs text-titanium-600">LVEF</div>
 </div>
 <div className="text-center p-3 bg-white rounded-lg border border-titanium-200">
 ...
 <div className="text-center p-3 bg-white rounded-lg border border-titanium-200">
 <div className="text-2xl font-bold text-titanium-900">{patient.gdmtGaps.length}</div>
 <div className="text-xs text-titanium-600">GDMT Gaps</div>
 </div>
 <div className="text-center p-3 bg-white rounded-lg border border-titanium-200">
 ...
 <div className="mb-4">
 <div className="text-sm font-semibold text-titanium-700 mb-2">GDMT Gaps:</div>
