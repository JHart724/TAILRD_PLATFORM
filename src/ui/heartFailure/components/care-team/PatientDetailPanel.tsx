...
const PatientDetailPanel: React.FC<PatientDetailPanelProps> = ({ patient, onClose }) => {
 ...
 <div className="text-2xl font-bold text-[#6B7280] mb-2">{patient.gdmtGaps.length}</div>
 ...
 patient.fullChart.gdmt.overallScore >= 80 ? 'bg-[#C8D4DC]' :
 patient.fullChart.gdmt.overallScore >= 60 ? 'bg-[#F0F5FA]' : 'bg-red-500'
 }`}
