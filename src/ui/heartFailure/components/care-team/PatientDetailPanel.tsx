...
const PatientDetailPanel: React.FC<PatientDetailPanelProps> = ({ patient, onClose }) => {
 ...
 <div className="text-xl font-bold text-arterial-600 mb-2">NYHA {patient.nyhaClass}</div>
 <p className="text-sm text-gray-600">Functional Class</p>
 </div>
 <div className="bg-chrome-50 rounded-lg p-4 text-center">
 <div className="text-2xl font-bold text-gray-500 mb-2">{patient.gdmtGaps.length}</div>
 ...
 patient.fullChart.gdmt.overallScore >= 80 ? 'bg-titanium-300' :
 patient.fullChart.gdmt.overallScore >= 60 ? 'bg-chrome-50' : 'bg-red-500'
 }`}
 ...
 <span className="font-medium text-chrome-800">Eligible for Device Therapy</span>
 </div>
