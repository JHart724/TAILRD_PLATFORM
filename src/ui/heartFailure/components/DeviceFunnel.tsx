...
const DeviceFunnel: React.FC<DeviceFunnelProps> = ({ data }) => {
 ...
 <span className="font-bold text-titanium-900">{device.referred} ({referralRate.toFixed(0)}%)</span>
 </div>
 <div className="w-full bg-titanium-100 rounded-full h-2">
 ...
 <span className="font-bold text-titanium-900">{device.completed} ({completionRate.toFixed(0)}%)</span>
 </div>
 <div className="w-full bg-titanium-100 rounded-full h-2">
