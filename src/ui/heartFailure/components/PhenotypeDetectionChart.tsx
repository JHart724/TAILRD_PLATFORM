...
const PhenotypeDetection: React.FC = () => {
 ...
 <div>
 <h3 className="text-lg font-semibold text-titanium-900">Beyond-GDMT Phenotype Detection</h3>
 <p className="text-sm text-titanium-600 mt-1">12 Targetable Phenotypes in HF Population</p>
 </div>
