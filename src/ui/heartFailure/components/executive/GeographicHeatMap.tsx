...
const GeographicHeatMap: React.FC = () => {
 ...
 Risk: {toFixed(selectedData.riskScore, 1)}
 </div>
 </div>
 ...
 <div className="p-3 bg-white rounded-lg">
 <div className="text-xs text-titanium-600 mb-1">Readmit Rate</div>
 ...
 Risk Score: {toFixed(zipData.sort((a, b) => b.riskScore - a.riskScore)[0].riskScore, 1)}
 </div>
 </div>
 ...
 <div>
 <div className="text-xs text-titanium-600 mb-1">Total Patients</div>
