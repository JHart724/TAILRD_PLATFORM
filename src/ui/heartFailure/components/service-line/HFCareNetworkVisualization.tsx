...
const HFCareNetworkVisualization: React.FC = () => {
 ...
 <Pill className={`w-6 h-6 ${metrics.gdmtOptimizationRate >= 0.75 ? 'text-teal-700' : 'text-red-600'}`} />
 <div>
 ...
 <div className={`p-3 rounded-lg ${selectedNode.gdmtOptimizationRate >= 0.8 ? 'bg-titanium-300' : 'bg-chrome-50'}`}>
 <div className={`text-lg font-bold ${selectedNode.gdmtOptimizationRate >= 0.8 ? 'text-teal-700' : 'text-gray-500'}`}>
 {toFixed(selectedNode.gdmtOptimizationRate * 100, 0)}%
 </div>
 <div className={`text-xs ${selectedNode.gdmtOptimizationRate >= 0.8 ? 'text-teal-700' : 'text-gray-500'}`}>
 GDMT Optimized
 </div>
 </div>
 )}
 ...
 <span className={`font-bold ${metrics.gdmtOptimizationRate >= 0.75 ? 'text-teal-700' : 'text-red-600'}`}>
