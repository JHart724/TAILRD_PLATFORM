...
const GDMTByPhysicianTable: React.FC<GDMTByPhysicianTableProps> = ({ data }) => {
 ...
 <th className="px-6 py-4 text-center text-xs font-bold text-titanium-700 uppercase tracking-wider">Target BB</th>
 <th className="px-6 py-4 text-center text-xs font-bold text-titanium-700 uppercase tracking-wider">SGLT2i</th>
 <th className="px-6 py-4 text-center text-xs font-bold text-titanium-700 uppercase tracking-wider">ARNi</th>
 <th className="px-6 py-4 text-center text-xs font-bold text-titanium-700 uppercase tracking-wider">MRA</th>
 </tr>
 </thead>
