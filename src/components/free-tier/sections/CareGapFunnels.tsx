        ...
        {funnels.map((funnel, funnelIndex) => {
          ...
          return (
            <div key={funnelIndex}>
                      ...
                      {isStageExpanded && stageDetail && (
                        <div className="w-full bg-white border border-chrome-200 rounded-lg p-2.5 text-xs space-y-1.5 mt-1">
                          ...
                          <div>
                            ...
                            <span className="text-teal-700 font-data font-semibold">{FUNNEL_VALUES[funnelIndex]}</span>
                          </div>
              ...
              {/* Dollar opportunity */}
              <div className="mt-2 bg-chrome-50 border border-titanium-300 rounded-lg px-2 py-1.5 text-center">
                <div className="text-[10px] text-teal-700 font-body">Closing gap =</div>
                <div className="text-xs font-data font-bold text-teal-700">{FUNNEL_VALUES[funnelIndex]}</div>
              </div>
            </div>
          );
        })}
