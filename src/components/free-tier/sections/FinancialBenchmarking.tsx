...
const FinancialBenchmarking: React.FC<FinancialBenchmarkingProps> = ({
  ...
  const getMarginColor = (margin: number): string => {
    if (margin >= 15) return 'text-teal-700';
    if (margin >= 8) return 'text-gray-500';
        ...
        <div className="bg-chrome-50 rounded-xl p-4">
          ...
          <div className="space-y-2.5">
            {[
              ...
              { label: 'Medicaid', pct: 22, color: 'bg-chrome-50' },
              { label: 'Commercial', pct: 24, color: 'bg-chrome-50' },
              ...
              >
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="text-center">
                    ...
                    <div className="font-data text-lg font-bold text-teal-700">
                      {opp.targetMargin}%
                    </div>
                  </div>
                </div>
                <div className="mt-2 bg-chrome-50 rounded-lg px-3 py-1.5 text-center">
                  <span className="text-sm font-data font-semibold text-teal-700">
