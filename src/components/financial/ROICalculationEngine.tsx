...
const ROICalculationEngine: React.FC = () => {
 ...
 <div>
 <h2 className="text-3xl font-bold text-titanium-900 mb-2">ROI Calculation Engine</h2>
 <p className="text-titanium-600">Comprehensive financial impact modeling for GDMT optimization initiatives</p>
 </div>
 ...
 : 'bg-titanium-300 text-white hover:bg-titanium-300'
 } transition-colors`}
 >
 ...
 className="px-4 py-2 bg-porsche-500 text-white rounded-lg hover:bg-porsche-600 transition-colors flex items-center gap-2"
 >
 ...
 <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-teal-700">
 <div className="flex items-center gap-3 mb-2">
 <DollarSign className="w-8 h-8 text-teal-700" />
 <div>
 <div className="text-sm text-teal-700 font-medium">Net ROI</div>
 <div className="text-3xl font-bold text-teal-700">{toFixed(calculateROI.roiPercentage, 0)}%</div>
 </div>
 </div>
 ...
 <div className="text-3xl font-bold text-chrome-800">${toFixed(calculateROI.netBenefit / 1000000, 1)}M</div>
 </div>
 </div>
 ...
 <div className="text-3xl font-bold text-arterial-800">{toFixed(calculateROI.paybackPeriod, 1)} yr</div>
 </div>
 </div>
 ...
 <div className="text-3xl font-bold text-gray-500">${toFixed(calculateROI.annualSavings / 1000000, 1)}M</div>
 </div>
 </div>
 ...
 <div className="bg-white p-6 rounded-xl border border-titanium-200">
 <h3 className="text-xl font-bold text-titanium-900 mb-4">Scenario Parameters</h3>
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Patient Volume</label>
 <input 
 type="number" 
 value={patientVolume}
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Current GDMT Rate (%)</label>
 <input 
 type="number" 
 step="0.1"
 value={gdmtAdherence}
 ...
 <div>
 <label className="block text-sm font-medium text-titanium-700 mb-2">Target GDMT Rate (%)</label>
 <input 
 type="number" 
 step="0.1"
 ...
 <div className="bg-white p-6 rounded-xl border border-titanium-200">
 <h3 className="text-xl font-bold text-titanium-900 mb-4">Annual Cost Savings</h3>
 
 <div className="space-y-3">
 {costSavings.map((saving) => (
 <div key={saving.description} className="flex items-center justify-between p-3 bg-titanium-50 rounded-lg">
 <div className="flex-1">
 <div className="font-medium text-titanium-900 text-sm">{saving.description}</div>
 <div className="text-xs text-titanium-600">
 {toFixed(saving.probability * 100, 0)}% confidence • {saving.category}
 </div>
 </div>
 ...
 {/* Investment Costs */}
 <div className="bg-white p-6 rounded-xl border border-titanium-200">
 <h3 className="text-xl font-bold text-titanium-900 mb-4">Investment Costs</h3>
 
 <div className="space-y-3">
 {investmentCosts.map((cost) => (
 <div key={cost.description} className="flex items-center justify-between p-3 bg-titanium-50 rounded-lg">
 <div className="flex-1">
 <div className="font-medium text-titanium-900 text-sm">{cost.description}</div>
 <div className="text-xs text-titanium-600 capitalize">
 ...
 ${toFixed(calculateROI.annualCosts / 1000, 0)}K
 </span>
 </div>
 </div>
 </div>
 ...
 {/* ROI Metrics */}
 <div className="bg-white p-6 rounded-xl border border-titanium-200">
 <h3 className="text-xl font-bold text-titanium-900 mb-4">Expected Clinical & Operational Improvements</h3>
 
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
 {roiMetrics.map((metric) => (
 <div key={metric.category} className="p-4 border border-titanium-200 rounded-lg">
 ...
 <div className="text-lg font-bold text-titanium-700">{metric.baseline}</div>
 ...
 <div className="text-center">
 <div className="text-lg font-bold text-porsche-600">{metric.improved}</div>
 ...
 <div className="flex-1">
 <h3 className="text-xl font-bold text-titanium-900 mb-2">Investment Recommendation</h3>
 ...
 <div className="text-lg font-bold text-chrome-600">Low-Medium</div>
 </div>
 <div>
 <div className="text-sm text-titanium-600">Implementation Priority</div>
