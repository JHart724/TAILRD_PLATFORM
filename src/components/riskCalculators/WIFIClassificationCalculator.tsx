...
const WIFIClassificationCalculator: React.FC<WIFIClassificationProps> = ({
 ...
 switch (stage) {
 case 1: return 'text-[#2C4A60]';
 case 2: return 'text-[#6B7280]';
 case 3: return 'text-[#6B7280]';
 ...
 if (risk === 'Very Low') return 'text-[#2C4A60]';
 if (risk === 'Low') return 'text-[#6B7280]';
 if (risk === 'Moderate') return 'text-[#6B7280]';
 if (risk === 'High') return 'text-red-600';
 return 'text-gray-600';
  };

  const getBenefitColor = (benefit: string): string => {
 if (benefit === 'Low') return 'text-[#6B7280]';
 ...
 <div className="flex items-center justify-between p-3 bg-chrome-50 rounded-lg border border-chrome-200">
 <div>
 <span className="font-medium text-chrome-900">Wound (W)</span>
 <div className="text-xs text-chrome-700">Grade {woundGrade}</div>
 </div>
 <div className="text-sm text-chrome-800">{gradeBreakdown.wound}</div>
 </div>
 ...
 <div className="flex items-center justify-between p-3 bg-arterial-50 rounded-lg border border-arterial-200">
 <div>
 <span className="font-medium text-arterial-900">foot Infection (fI)</span>
 <div className="text-xs text-arterial-700">Grade {footInfectionGrade}</div>
 </div>
 <div className="text-sm text-arterial-800">{gradeBreakdown.footInfection}</div>
 </div>
 </div>
