...
const CHA2DS2VAScCalculator: React.FC = () => {
 ...
 className="w-full px-4 py-3 border border-titanium-300 rounded-xl focus:ring-2 focus:ring-medical-purple-500 focus:border-medical-purple-500"
 min="0"
 max="120"
 />
 </div>
 ...
 className="w-5 h-5 text-medical-purple-600 border-titanium-300 rounded focus:ring-medical-purple-500"
 />
