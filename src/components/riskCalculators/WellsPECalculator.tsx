...
const WellsPECalculator: React.FC = () => {
 ...
 <div>
 <div className="font-medium text-[#6B7280] mb-1">Moderate Probability (4-6 points)</div>
 ...
 <span className="font-semibold text-[#6B7280]">~30% PE prevalence</span>
 </div>
 ...
 <div className="p-3 bg-[#C8D4DC] rounded">
 ...
 <div className="font-medium text-[#6B7280]">Moderate Probability</div>
