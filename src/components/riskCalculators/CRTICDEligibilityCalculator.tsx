...
const CRTICDEligibilityCalculator: React.FC<CRTICDEligibilityProps> = ({
 ...
 if (recommendation.includes('CRT-D')) return 'text-arterial-600';
 if (recommendation.includes('CRT-P')) return 'text-chrome-600';
 if (recommendation.includes('ICD')) return 'text-red-600';
 return 'text-gray-600';
  };

  const getClassColor = (classRec: string): string => {
 if (classRec === 'Class I') return 'text-teal-700';
 if (classRec === 'Class IIa') return 'text-chrome-600';
 if (classRec === 'Class IIb') return 'text-amber-600';
 return 'text-gray-600';
  };
 ...
 <div className="text-center">
 <div className={`text-2xl font-bold ${crtEligible ? 'text-chrome-600' : 'text-gray-400'} mb-1`}>
 {crtEligible ? '✓' : '✗'}
 </div>
 ...
 <div className="text-center">
 <div className={`text-2xl font-bold ${crtdEligible ? 'text-arterial-600' : 'text-gray-400'} mb-1`}>
 {crtdEligible ? '✓' : '✗'}
 </div>
