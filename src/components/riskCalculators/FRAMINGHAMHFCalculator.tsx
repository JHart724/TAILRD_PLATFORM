...
const FRAMINGHAMHFCalculator: React.FC = () => {
 ...
 <span className="font-semibold text-green-600">Standard prevention</span>
 </div>
 <div className="flex justify-between p-2 bg-chrome-50 rounded">
 <span>Intermediate Risk (5-15%)</span>
 <span className="font-semibold text-amber-600">Enhanced prevention</span>
 </div>
