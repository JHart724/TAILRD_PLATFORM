...
const PatientRiskHeatmap: React.FC = () => {
 ...
 return ['bg-red-400', 'bg-chrome-400', 'bg-green-400', 'bg-purple-400', 'bg-amber-400'][providerIndex] || 'bg-gray-400';
 ...
 <div className="flex-1 bg-purple-500 relative group">
 <span className="absolute inset-0 flex items-center justify-center text-[10px] text-white font-medium opacity-0 group-hover:opacity-100 transition-opacity">80+</span>
 </div>
 </div>
 <div className="flex justify-between text-[10px] text-titanium-500 mt-0.5">
 ...
 <div className="text-lg font-semibold text-titanium-900">{selectedPatient.creatinine.toFixed(1)} mg/dL</div>
 </div>
 <div className="bg-white border border-titanium-200 rounded-lg p-3">
 <div className="text-sm text-titanium-600">Potassium</div>
 <div className="text-lg font-semibold text-titanium-900">{selectedPatient.potassium.toFixed(1)} mEq/L</div>
 </div>
 <div className="bg-white border border-titanium-200 rounded-lg p-3">
 ...
 <span key={idx} className="px-3 py-1 bg-porsche-100 text-porsche-700 text-sm rounded-full border border-porsche-200">
 {condition}
 </span>
 ))}
 </div>
 ...
 <div key={idx} className="bg-white border border-titanium-200 rounded-lg p-3 flex items-start gap-3">
