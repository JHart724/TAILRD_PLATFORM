...
const CareTeamNetworkGraph: React.FC = () => {
 ...
 <div>
 <h3 className="text-2xl font-bold text-titanium-900">Care Team Network Analysis</h3>
 <p className="text-titanium-600">Interactive visualization of provider relationships and patient flow patterns</p>
 </div>
 ...
 <div className="flex items-center gap-2">
 <div className="w-3 h-0.5 bg-chrome-500"></div>
 ...
 <div>
 <div className="text-sm font-medium text-titanium-700 mb-2">Connected to:</div>
 ...
 <Stethoscope className="w-8 h-8 text-chrome-600" />
 <div>
 <div className="text-2xl font-bold text-titanium-900">{nodes.filter(n => n.type === 'provider').length}</div>
 <div className="text-sm text-titanium-600">Active Providers</div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="text-2xl font-bold text-titanium-900">{connections.reduce((sum, c) => sum + c.patientFlow, 0)}</div>
 <div className="text-sm text-titanium-600">Total Patient Flow</div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="text-2xl font-bold text-titanium-900">{connections.length}</div>
 <div className="text-sm text-titanium-600">Active Connections</div>
 </div>
 </div>
 </div>
 </div>
