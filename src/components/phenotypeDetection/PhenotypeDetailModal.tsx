...
const PhenotypeDetailModal: React.FC<PhenotypeDetailModalProps> = ({
 ...
 <div key={categoryIndex} className="bg-white border border-titanium-200 rounded-xl p-4">
 <h4 className="font-semibold text-titanium-900 mb-3">{category.category}</h4>
 <div className="space-y-3">
 {category.criteria.map((criterion, criterionIndex) => (
 <div key={criterionIndex} className="flex items-start justify-between p-3 bg-titanium-50 rounded-lg">
 ...
 return (
 <div key={index} className="flex items-start gap-3 p-3 bg-white border border-titanium-200 rounded-lg">
 ...
 return (
 <div key={index} className="p-3 bg-white border border-titanium-200 rounded-lg">
 ...
 <div key={index} className="p-2 bg-titanium-100 rounded text-sm text-titanium-700">
 {related}
 </div>
 ))}
 </div>
