...
interface PredictiveMetricsBannerProps {
  ...
  demoData?: boolean;
  /** White-card treatment (HF Exec batch 2): white box surfaces + titanium borders, color
      kept only as solid icon/value accents. Opt-in so other modules render unchanged. */
  cleanSurface?: boolean;
}

const PredictiveMetricsBanner: React.FC<PredictiveMetricsBannerProps> = ({ data, demoData = false, cleanSurface = false }) => {
  ...
  const inlineBoxClass = `border rounded-xl p-4${cleanSurface ? ' bg-white border-titanium-200' : ''}`;

  return (
    <div className="metal-card relative z-10 mb-6">
      <div className={`px-6 py-4 border-b border-titanium-200${cleanSurface ? ' bg-white/80' : ' bg-gradient-to-r from-slate-50/50 to-white'}`}>
      ...
      <div className="p-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          <div className={cleanSurface ? 'bg-white border border-titanium-200 rounded-xl p-4' : 'bg-red-50/70 border border-red-100 rounded-xl p-4'}>
          ...
          <div className={cleanSurface ? 'bg-white border border-titanium-200 rounded-xl p-4' : 'bg-chrome-50/70 border border-titanium-300 rounded-xl p-4'}>
            <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className={cleanSurface ? 'bg-white border border-titanium-200 rounded-xl p-4' : 'bg-red-50/70 border border-[#F5D0D6] rounded-xl p-4'}>
            <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className={inlineBoxClass} style={boxStyle({ background: '#EEF8FA', borderColor: '#A8D8E4' })}>
            <div className="flex items-center gap-1.5 mb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className={inlineBoxClass} style={boxStyle({ background: '#F0F5FA', borderColor: '#C8D4DC' })}>
            <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className={inlineBoxClass} style={boxStyle({ background: '#EFF4F8', borderColor: '#B8C9D9' })}>
            <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className={inlineBoxClass} style={boxStyle({ background: '#FAF6E8', borderColor: '#D4B85C' })}>
            <div className="flex items-center gap-1.5 mb-1">
