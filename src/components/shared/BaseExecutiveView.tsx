...
const BaseExecutiveView: React.FC<BaseExecutiveViewProps> = ({ config }) => {
 ...
 <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-chrome-400 to-cyan-400/10 rounded-full blur-2xl animate-float" />
 ...
 <div key={index} className="bg-gradient-to-r from-white to-emerald-50 rounded-xl p-4 border border-titanium-200 shadow-lg hover:shadow-xl transition-all duration-300">
 ...
 <h4 className="font-semibold text-titanium-900 mb-4">{moduleName} Case Mix Index (CMI) Analysis</h4>
