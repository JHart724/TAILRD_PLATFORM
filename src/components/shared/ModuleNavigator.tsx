...
const ModuleNavigator: React.FC<ModuleNavigatorProps> = ({
 ...
 'medical-purple': {
 bg: isActive ? 'bg-medical-purple-500' : 'bg-medical-purple-50 hover:bg-medical-purple-100',
 text: isActive ? 'text-white' : 'text-medical-purple-700',
 border: 'border-medical-purple-200',
 badge: 'bg-medical-purple-500 text-white'
 },
 'medical-teal': {
 ...
 <div className="font-semibold text-titanium-900">${(module.revenueOpportunity / 1000000).toFixed(1)}M</div>
 </div>
 <div>
 ...
 <span className="font-medium text-titanium-900">
 ${(mockModuleData[currentModule as keyof typeof mockModuleData].revenueOpportunity / 1000000).toFixed(1)}M
 </span>
