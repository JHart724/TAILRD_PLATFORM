...
const SharedROIWaterfall: React.FC<SharedROIWaterfallProps> = ({
 ...
 <div className="text-3xl font-bold text-[#2C4A60]">{formatMoney(realizedRevenue)}</div>
 ...
 <div className="text-xs text-titanium-400 mt-1">{toFixed(percentage, 1)}% of total</div>
 </div>
 );
 })}
 </div>
