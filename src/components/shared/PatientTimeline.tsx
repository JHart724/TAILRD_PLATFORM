...
const eventTypeConfig = {
 ...
 textColor: 'text-medical-green-700'
  ...
  procedure: {
 icon: Activity,
 color: 'bg-medical-purple-500',
 bgColor: 'bg-medical-purple-50',
 textColor: 'text-medical-purple-700'
  },
  imaging: {
 icon: Image,
...
const moduleColors = {
  ...
  structural: 'border-l-medical-purple-400',
...
const PatientTimeline: React.FC<PatientTimelineProps> = ({ patientId, className = '' }) => {
 ...
 <div key={i} className="p-3 bg-white rounded-lg border border-titanium-200">
 ...
 <li key={i} className="text-sm text-titanium-700 flex items-start gap-2">
