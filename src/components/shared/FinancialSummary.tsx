...
const FinancialSummary: React.FC<FinancialSummaryProps> = ({
 ...
 <div key={index} className="bg-white p-3 rounded border border-chrome-200">
 ...
 {drg.avgLengthOfStay.toFixed(1)} days
 </td>
 ...
 <div className="text-xl font-bold text-chrome-800">
 {(data.drgDetails.reduce((sum, drg) => sum + (drg.avgLengthOfStay * drg.volume), 0) / 
 data.drgDetails.reduce((sum, drg) => sum + drg.volume, 0)).toFixed(1)} days
 </div>
 </div>
 <div>
