...
export class ErrorBoundary extends Component<Props, State> {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-red-50 via-amber-50/30 to-yellow-50 p-6 flex items-center justify-center">
 ...
 <h1 className="text-2xl font-bold text-titanium-900 mb-2">
 ...
 className="flex items-center justify-center gap-2 px-4 py-3 bg-porsche-600 text-white rounded-xl hover:bg-porsche-700 transition-colors"
 >
 ...
 className="flex items-center justify-center gap-2 px-4 py-3 bg-titanium-600 text-white rounded-xl hover:bg-titanium-700 transition-colors"
 >
 <RefreshCw className="w-4 h-4" />
 Reload Page
 </button>
 ...
 className="flex items-center justify-center gap-2 px-4 py-3 bg-crimson-600 text-white rounded-xl hover:bg-crimson-700 transition-colors"
 >
 ...
 {/* Support Information */}
 <div className="bg-chrome-50 rounded-xl p-4 border border-chrome-200">
 <div className="flex items-start gap-3">
 <Phone className="w-5 h-5 text-chrome-600 mt-0.5" />
 <div>
 <div className="font-semibold text-chrome-900 mb-1">Need Immediate Help?</div>
 <div className="text-sm text-chrome-700">
 Contact IT Support: <span className="font-mono">ext. 4357</span>
 </div>
 <div className="text-xs text-chrome-600 mt-1">
