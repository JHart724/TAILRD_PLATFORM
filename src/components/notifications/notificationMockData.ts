...
export const MOCK_NOTIFICATIONS: CareGapNotification[] = [
  ...
  },
  {
    ...
    message: '14 transthoracic echocardiography reports received from Redox integration. 3 flagged for clinical review: 2 severe AS, 1 severe MR.',
    ...
    stages: [
      {
        ...
        status: 'completed',
        timestamp: daysAgo(3),
        description: 'Echocardiography report processed via Redox integration. CQL rule STRUCTURAL_AS_SEVERITY_SCREEN triggered.',
      ...
      },
      {
        ...
        detail: 'Auto-referral creates order in EHR via Redox, assigns Structural Heart coordinator, and notifies valve clinic. Physician can still intervene before deadline.',
  ...
  // ── RESOLVED CASE: AS referral accepted quickly ──
  {
    ...
    stages: [
      ...
      },
      {
        ...
        detail: 'Referral order created in EHR via Redox. Patient education materials sent.',
  ...
  // ── HF CASE: GDMT optimization in progress ──
  {
    ...
    stages: [
      ...
      },
      {
        ...
        stage: 'Resolution',
        status: 'pending',
        description: 'Gap closes when ARNI and SGLT2i appear on medication list via Redox medication update.',
        actor: 'Pending',
      },
    ],
  },
