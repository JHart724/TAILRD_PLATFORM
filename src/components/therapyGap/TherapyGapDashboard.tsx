...
const TherapyGapDashboard: React.FC = () => {
 ...
 gap.patientCount,
 gap.gapsClosed,
 ((gap.gapsClosed / gap.patientCount) * 100).toFixed(1),
 ...
 <p className="text-lg font-bold">${(gap.estimatedRevenue / 1000).toFixed(0)}K</p>
 <p className="text-xs opacity-90">
 {((gap.gapsClosed / gap.patientCount) * 100).toFixed(1)}% closed
 </p>
 </div>
 </div>
 );
 ...
 {gap.gapsClosed}/{gap.patientCount} closed ({closureRate.toFixed(1)}%)
 </span>
 <span className="text-titanium-800 font-medium">
 ${(gap.estimatedRevenue / 1000).toFixed(0)}K
 </span>
 </div>
 ...
 <span className="text-xs text-titanium-500">{totalMetrics.closureRate.toFixed(1)}%</span>
 </div>
 <div className="text-2xl font-bold text-titanium-800 mb-1">
 {totalMetrics.closureRate.toFixed(1)}%
 </div>
 ...
 {((item.closed / item.gaps) * 100).toFixed(1)}%
 </span>
 </div>
 </td>
 <td className="p-3 font-medium text-titanium-800">
 ...
 <td className="p-3 text-titanium-700">{item.percentage.toFixed(1)}%</td>
 </tr>
 ))}
 </tbody>
 </table>
