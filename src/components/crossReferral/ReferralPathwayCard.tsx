...
const ReferralPathwayCard: React.FC<ReferralPathwayCardProps> = ({
 ...
 <div key={lab.name} className="bg-titanium-50 p-2 rounded-lg text-sm">
 ...
 <div key={med} className="text-sm text-titanium-700 bg-titanium-50 p-2 rounded">
 {med}
 </div>
 ))}
 </div>
 ...
 <span key={allergy} className="px-2 py-1 bg-medical-red-100 text-medical-red-700 text-xs rounded-full">
 {allergy}
 </span>
 ))}
 </div>
 ...
 <div key={vital.name} className="bg-titanium-50 p-2 rounded-lg text-sm text-center">
