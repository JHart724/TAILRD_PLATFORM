...
export const HFGeographicHeatMap: React.FC = () => {
 ...
 <div className="h-96 w-full rounded-lg overflow-hidden border border-gray-300 bg-gradient-to-br from-chrome-50 to-indigo-100">
 ...
 <div className="bg-chrome-50 rounded-lg p-4 border border-chrome-200">
 <div className="flex items-center mb-2">
 <Users className="w-5 h-5 text-chrome-600 mr-2" />
 <span className="text-sm font-medium text-chrome-800">Total Patients</span>
 </div>
 <div className="text-2xl font-bold text-chrome-900">{selectedZIP.patients}</div>
 </div>
