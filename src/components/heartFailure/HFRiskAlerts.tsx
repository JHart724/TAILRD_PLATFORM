...
const HFRiskAlerts: React.FC = () => {
 ...
 case 'warning': return 'border-titanium-300 bg-amber-50 text-amber-600';
 case 'opportunity': return 'border-teal-700 bg-green-50 text-green-600';
 ...
 <div key={patient.mrn} className="flex justify-between text-sm">
