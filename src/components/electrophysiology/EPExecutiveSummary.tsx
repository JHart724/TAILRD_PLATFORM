...
export const EPExecutiveSummary: React.FC = () => {
 ...
 case 'purple': return 'bg-purple-500 text-white border-purple-200';
 ...
 if (id === 'revenue-opportunity') return `$${value.toFixed(1)}M`;
 ...
 type="monotone" 
 dataKey="value" 
 stroke={selectedKPI.color === 'blue' ? '#3b82f6' : selectedKPI.color === 'green' ? '#10b981' : selectedKPI.color === 'purple' ? '#8b5cf6' : '#ef4444'}
 strokeWidth={3}
 dot={{ fill: selectedKPI.color === 'blue' ? '#3b82f6' : selectedKPI.color === 'green' ? '#10b981' : selectedKPI.color === 'purple' ? '#8b5cf6' : '#ef4444', strokeWidth: 2, r: 5 }}
 activeDot={{ r: 7 }}
 />
 </LineChart>
 </ResponsiveContainer>
