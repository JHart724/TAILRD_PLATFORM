...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // ── Tailwind default scale overrides → Porsche Metallic palette ──────
        // Every text-red-600, bg-blue-50, text-green-500 etc. auto-maps below.

        // RED → Carmona Red Metallic
        red:    { 50:'#FDF2F3', 100:'#F5D0D6', 200:'#E8A1AD', 300:'#D4707F', 400:'#B84455', 500:'#9B2438', 600:'#7A1A2E', 700:'#5C1022', 800:'#3E0A17', 900:'#20050C', 950:'#100306' },
        rose:   { 50:'#FDF2F3', 100:'#F5D0D6', 200:'#E8A1AD', 300:'#D4707F', 400:'#B84455', 500:'#9B2438', 600:'#7A1A2E', 700:'#5C1022', 800:'#3E0A17', 900:'#20050C', 950:'#100306' },
        pink:   { 50:'#FDF2F3', 100:'#F5D0D6', 200:'#E8A1AD', 300:'#D4707F', 400:'#B84455', 500:'#9B2438', 600:'#7A1A2E', 700:'#5C1022', 800:'#3E0A17', 900:'#20050C', 950:'#100306' },
        fuchsia:{ 50:'#FDF2F3', 100:'#F5D0D6', 200:'#E8A1AD', 300:'#D4707F', 400:'#B84455', 500:'#9B2438', 600:'#7A1A2E', 700:'#5C1022', 800:'#3E0A17', 900:'#20050C', 950:'#100306' },

        // BLUE / SKY / INDIGO / VIOLET / PURPLE → Chrome Blue Metallic
        blue:   { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#5A8AB0', 600:'#3D6F94', 700:'#2A5578', 800:'#1A3B5C', 900:'#0D2640', 950:'#061525' },
        sky:    { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#5A8AB0', 600:'#3D6F94', 700:'#2A5578', 800:'#1A3B5C', 900:'#0D2640', 950:'#061525' },
        indigo: { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#5A8AB0', 600:'#3D6F94', 700:'#2A5578', 800:'#1A3B5C', 900:'#0D2640', 950:'#061525' },
        violet: { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#5A8AB0', 600:'#3D6F94', 700:'#2A5578', 800:'#1A3B5C', 900:'#0D2640', 950:'#061525' },
        purple: { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#5A8AB0', 600:'#3D6F94', 700:'#2A5578', 800:'#1A3B5C', 900:'#0D2640', 950:'#061525' },

        // TEAL / CYAN → Chrome Blue mid (muted metallic, not neon)
        teal: { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#4A6880', 600:'#3E6275', 700:'#2C4A60', 800:'#1E3347', 900:'#0D2640', 950:'#061525' },
        cyan: { 50:'#F0F5FA', 100:'#D4E4F0', 200:'#B8C9D9', 300:'#A8C5DD', 400:'#7BA3C4', 500:'#6B8EA8', 600:'#4A6880', 700:'#3E6275', 800:'#2C4A60', 900:'#1E3347', 950:'#061525' },

        // GREEN / EMERALD / LIME → British Racing Green (not neon)
        green:   { 50:'#F0F7F4', 100:'#D8EDE6', 200:'#B0D9C6', 300:'#88C5A8', 400:'#5EAF8A', 500:'#3D9470', 600:'#2D6147', 700:'#1E4530', 800:'#122D1E', 900:'#0A1C12', 950:'#05100A' },
        emerald: { 50:'#F0F7F4', 100:'#D8EDE6', 200:'#B0D9C6', 300:'#88C5A8', 400:'#5EAF8A', 500:'#3D9470', 600:'#2D6147', 700:'#1E4530', 800:'#122D1E', 900:'#0A1C12', 950:'#05100A' },
        lime:    { 50:'#F0F7F4', 100:'#D8EDE6', 200:'#B0D9C6', 300:'#88C5A8', 400:'#5EAF8A', 500:'#3D9470', 600:'#2D6147', 700:'#1E4530', 800:'#122D1E', 900:'#0A1C12', 950:'#05100A' },

        // AMBER / YELLOW / ORANGE → Metallic Gold (not safety-vest yellow)
        amber:  { 50:'#FAF6E8', 100:'#F4ECC0', 200:'#EAD68A', 300:'#D9B95A', 400:'#C4982A', 500:'#C4982A', 600:'#8B6914', 700:'#6B4A1A', 800:'#4A3210', 900:'#3A2C08', 950:'#1E1604' },
        yellow: { 50:'#FAF6E8', 100:'#F4ECC0', 200:'#EAD68A', 300:'#D9B95A', 400:'#D4B85C', 500:'#C4982A', 600:'#8B6914', 700:'#6B4A1A', 800:'#4A3210', 900:'#3A2C08', 950:'#1E1604' },
        orange: { 50:'#FAF6E8', 100:'#F4ECC0', 200:'#EAD68A', 300:'#D9B95A', 400:'#C4982A', 500:'#C4982A', 600:'#8B6914', 700:'#6B4A1A', 800:'#4A3210', 900:'#3A2C08', 950:'#1E1604' },
