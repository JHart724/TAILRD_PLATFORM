...
const GAP_011: GapValueSet = { gapId: 'GAP-011', gapName: 'Ivabradine Candidacy', module: 'HF', diagnosisCodes: ['I50.22', 'I50.23'], exclusionCodes: [], procedureCodes: [], medicationCodes: ['1649380'], labCodes: ['8867-4', '18010-0'], labThresholds: [{ loincCode: '8867-4', operator: '>=', value: 70, unit: 'bpm' }, { loincCode: '18010-0', operator: '<=', value: 35, unit: '%' }], deviceCodes: [] };
