  ...
  for (let i = 1; i <= 10; i++) {
    const patient = await prisma.patient.create({
      data: {
        ...
        firstName: `Patient${i}`,
        lastName: `Demo`,
        dateOfBirth: new Date(1950 + Math.floor(Math.random() * 50), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1).toISOString(),
  ...
  for (let i = 1; i <= 5; i++) {
    const patient = await prisma.patient.create({
      data: {
        ...
        firstName: `Patient${i}`,
        lastName: `Community`,
        dateOfBirth: new Date(1955 + Math.floor(Math.random() * 45), Math.floor(Math.random() * 12), Math.floor(Math.random() * 28) + 1).toISOString(),
